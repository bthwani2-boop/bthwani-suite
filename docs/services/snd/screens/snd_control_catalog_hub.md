# Screen Contract - snd_control_catalog_hub

1. Screen Identity: SCR_2
2. Purpose: control-panel catalog governance for snd.
3. Actor: ops|catalog
4. Surface: control-panel
5. Canonical Route: /catalog/snd
...
16. Dependent Operations: snd_sync_catalog
17. Required UI-Kit Pieces: state shells and admin cards.
18. Local vs Shared Ownership: shared ui-kit primitives.
19. Files To Create / Files To Touch: packages/surfaces/src/snd/snd_control_catalog_hub.tsx
20. Acceptance Gate: gate_a_b_c_passed
21. Deferred Items: W08/W09.
22. Notes from donor extraction: services/snd/governance/SND_CONTROL_PANEL_SECTION_MAP.csv
