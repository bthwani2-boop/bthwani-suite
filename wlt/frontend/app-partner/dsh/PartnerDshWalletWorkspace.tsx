...
export type PartnerDshWalletTransaction = {
  id: string;
  title: string;
  subtitle: string;
  amountLabel: string;
  amountTone?: PartnerDshTransactionTone;
  statusLabel?: string;
  statusTone?: PartnerDshTransactionTone;
  timeLabel: string;
  icon: React.ComponentProps<typeof Icon>['name'];
  hasDetails?: boolean;
};

export type PartnerDshWalletWorkspaceProps = {
  state?: PartnerDshWalletWorkspaceState;
...
export function PartnerDshWalletWorkspace({
  state = 'ready',
...
}: PartnerDshWalletWorkspaceProps) {
  const { direction } = useDirection();
  ...
  const visibleTransactions = state === 'no-transactions' ? [] : transactions;
