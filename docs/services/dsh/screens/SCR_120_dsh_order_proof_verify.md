# Screen Contract: dsh_order_proof_verify

1. Screen Identity: dsh_order_proof_verify
2. Purpose: execute primary user task for dsh_order_proof_verify within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_order_proof_verify
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_order_proof_verify.tsx
