...
Status: TEMPLATE
Owner root: packages/surfaces/src/service-owned/wlt
...
|---|---|
| Service | WLT |
| Canonical owner root | packages/surfaces/src/service-owned/wlt |
| Current truth file | packages/surfaces/src/service-owned/wlt/SERVICE_BLUEPRINT.md |
...
| Full service closure | NOT CLOSED | Template only. |
...
| Guard | Requirement |
|---|---|
| Canonical file | packages/surfaces/src/service-owned/wlt/SERVICE_BLUEPRINT.md |
