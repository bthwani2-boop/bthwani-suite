# Screen Contract: dsh_operations_dsh_zone-set

1. Screen Identity: dsh_operations_dsh_zone-set
2. Purpose: execute primary user task for dsh_operations_dsh_zone-set within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /operations/dsh/zone-set
6. Entry Points: /operations/dsh/zone-set entry
...
16. Dependent Operations: dsh_operations_dsh_zone_set
...
22. Notes from donor extraction: apps/web/control-panel/app/operations/dsh/zone-set/page.tsx
