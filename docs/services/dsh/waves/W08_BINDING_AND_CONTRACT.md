...
1. Wave Identity: W08_BINDING_AND_CONTRACT
2. Wave Goal: Deliver scoped bundle for W08_BINDING_AND_CONTRACT with gate-based progression.
3. Why This Wave Exists: isolate risk and enforce ordered execution by queue.
4. Included Screen Bundles: none
5. Included Operation Families: binding_contract_closure
