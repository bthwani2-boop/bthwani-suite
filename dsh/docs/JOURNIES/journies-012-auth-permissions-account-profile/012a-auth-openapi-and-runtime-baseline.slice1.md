<!--
Canonical human-review path: dsh/docs/journies-012-auth-permissions-account-profile/012a-auth-openapi-and-runtime-baseline.slice1.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-012-auth-permissions-account-profile-dependency/DSH-SLICE-012A-auth-openapi-and-runtime-baseline.md
...
- Slice file: `dsh/docs/journies-012-auth-permissions-account-profile/012a-auth-openapi-and-runtime-baseline.slice1.md`
...
# DSH-SLICE-012A — Auth OpenAPI and Runtime Baseline
...
| Field | Value |
|---|---|
| Slice ID | `DSH-SLICE-012A` |
| Parent Journey | `J-012 — Auth, Permissions, Account/Profile Dependency` |
| Journey Type | `foundation` |
| Business Outcome | contract and runtime align |
| Primary Actor | `developer` |
| Primary Surface / Area | `auth.openapi.yaml + auth-service` |
...
1. يبدأ الممثل الأساسي `developer` من السطح `auth.openapi.yaml + auth-service`.
2. الهدف العملي: contract and runtime align.
...
|---|---|---|---|
| `auth.openapi.yaml + auth-service` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-012A-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-012 — Auth, Permissions, Account/Profile Dependency
- Slice: DSH-SLICE-012A — Auth OpenAPI and Runtime Baseline
- Primary actor: developer
- Primary surface/area: auth.openapi.yaml + auth-service
- Business outcome: contract and runtime align
- SESSION_ID: DSH-SLICE-012A_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-012A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-012A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-012A_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
