...
export const DSH_ASSISTED_ORDER_PREVIEW: readonly DshAssistedOrderPreview[] = [
  {
    ...
    wltReadOnlyHandoff: {
      ...
      settlementVisibility: 'Partner settlement remains WLT-owned; DSH displays status only.',
      readOnly: true,
  ...
  },
  {
    ...
    wltReadOnlyHandoff: {
      paymentVisibility: 'Payment review remains WLT-owned after verification completes.',
      refundVisibility: 'Refund visibility only; execution remains WLT-owned.',
      settlementVisibility: 'Settlement context is read-only and controlled by WLT.',
      readOnly: true,
      mutationForbidden: true,
      calculationTruthOwner: 'WLT',
      routeHint: '/finance?workspace=refunds&orderId=ORD-1184',
...
export const DSH_ORDER_RESCUE_PREVIEW: readonly DshOrderRescueCase[] = [
  {
    ...
    wltImpactVisibility: {
      paymentVisibility: 'لقطة الدفع للعرض فقط من WLT.',
      refundVisibility: 'تنفيذ الاسترداد مملوك لـ WLT؛ DSH يعرض الحالة فقط.',
      settlementVisibility: 'التسوية والصرف مملوكان لـ WLT؛ DSH يعرض الحالة فقط.',
      readOnly: true,
      mutationForbidden: true,
      calculationTruthOwner: 'WLT',
      routeHint: '/finance?workspace=refunds&orderId=ORD-1102',
  ...
  },
  {
    ...
    wltImpactVisibility: {
      paymentVisibility: 'حالة الدفع للعرض فقط من WLT.',
      refundVisibility: 'تنفيذ الاسترداد والتراجع مملوك لـ WLT؛ DSH يعرض الحالة فقط.',
      settlementVisibility: 'تعديل التسوية مملوك لـ WLT؛ DSH يعرض الحالة فقط.',
      readOnly: true,
      mutationForbidden: true,
      calculationTruthOwner: 'WLT',
      routeHint: '/finance?workspace=refunds&orderId=ORD-1184',
...
// -----------------------------------------------------------------------------
// Client App Surface initial/tracking orders preview
// Authority: app-client DshClientSurface.
// -----------------------------------------------------------------------------
export const dshClientInitialOrdersFixture = [
  {
    id: 'dsh-10021',
    title: 'مطعم حدة المركزي',
    orderNumber: '10021',
    subtitle: 'من حدة إلى باب اليمن',
    statusLabel: getDshClientStateMeta('tracking_active').label,
    meta: 'الوصول المتوقع خلال 18 دقيقة',
    clientState: 'tracking_active' as DshClientState,
    fulfillmentMode: 'bthwani_delivery' as const,
  ...
  },
  {
    ...
    statusLabel: getDshClientStateMeta('delivered').label,
    meta: 'اليوم 03:10 م',
    clientState: 'delivered' as DshClientState,
    fulfillmentMode: 'partner_delivery' as const,
  ...
  },
  {
    ...
    statusLabel: getDshClientStateMeta('cancelled').label,
    meta: 'تم الإلغاء مع توضيح سبب الحالة',
    clientState: 'cancelled' as DshClientState,
  ...
  },
  {
    ...
    statusLabel: getDshClientStateMeta('failed').label,
    meta: 'توجد حاجة إلى مسار تعافٍ أو دعم واضح',
    clientState: 'failed' as DshClientState,
    fulfillmentMode: 'bthwani_delivery' as const,
  ...
  },
  {
    ...
    statusLabel: getDshClientStateMeta('refund_pending').label,
    meta: 'الاسترداد ما يزال قيد المعالجة',
    clientState: 'refund_pending' as DshClientState,
    fulfillmentMode: 'partner_delivery' as const,
  ...
  },
  {
    ...
    statusLabel: getDshClientStateMeta('refunded').label,
    meta: 'تم تثبيت الأثر المالي النهائي للطلب',
    clientState: 'refunded' as DshClientState,
    fulfillmentMode: 'pickup' as const,
  ...
  },
  {
    ...
    statusLabel: getDshClientStateMeta('support_required').label,
    meta: 'هذه الحالة تحتاج متابعة دعم واضحة',
    clientState: 'support_required' as DshClientState,
    fulfillmentMode: 'partner_delivery' as const,
  ...
  },
  {
    ...
    statusLabel: getDshClientStateMeta('wallet_credit_visible').label,
    meta: 'يوجد رصيد ظاهر للعميل داخل المحفظة',
    clientState: 'wallet_credit_visible' as DshClientState,
    fulfillmentMode: 'bthwani_delivery' as const,
  ...
  },
  {
    ...
    statusLabel: getDshClientStateMeta('wallet_refund_visible').label,
    meta: 'تظهر معلومة الاسترداد المالي ضمن المسار',
    clientState: 'wallet_refund_visible' as DshClientState,
    fulfillmentMode: 'pickup' as const,
...
export const dshClientInitialCreateOrderValuesFixture = {
  fulfillmentMode: 'bthwani_delivery' as const,
  pickupAddress: 'رياض بارك، البوابة 2',
  dropoffAddress: 'العليا، طريق الملك فهد',
  contactName: 'أحمد',
