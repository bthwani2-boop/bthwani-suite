...
} from '../../shared/view-models/control-panel/platform/platform-audit-state';

export type { AuditEvent } from '../../shared/view-models/control-panel/platform/platform-audit-state';
export {
  usePlatformAuditStateHook,
  PlatformAuditContext,
