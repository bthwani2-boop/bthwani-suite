<!--
Canonical human-review path: dsh/docs/journies-005-delivery-execution-captain/005d-location-tracking-and-client-visibility.slice4.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-005-delivery-execution-and-captain-operations/DSH-SLICE-005D-location-tracking-and-client-visibility.md
...
- Slice file: `dsh/docs/journies-005-delivery-execution-captain/005d-location-tracking-and-client-visibility.slice4.md`
...
# DSH-SLICE-005D — Location Tracking and Client Visibility
...
| Business Outcome | client sees scoped location updates without heavy polling |
| Primary Actor | `captain/client` |
| Primary Surface / Area | `app-captain + app-client` |
...
1. يبدأ الممثل الأساسي `captain/client` من السطح `app-captain + app-client`.
2. الهدف العملي: client sees scoped location updates without heavy polling.
...
|---|---|---|---|
| `app-captain + app-client` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-005D-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-005 — Delivery Execution and Captain Operations
- Slice: DSH-SLICE-005D — Location Tracking and Client Visibility
- Primary actor: captain/client
- Primary surface/area: app-captain + app-client
- Business outcome: client sees scoped location updates without heavy polling
- SESSION_ID: DSH-SLICE-005D_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-005D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-005D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-005D_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
