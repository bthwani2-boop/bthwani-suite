# Screen Contract: dsh_proxy_request_approve

1. Screen Identity: dsh_proxy_request_approve
2. Purpose: execute primary user task for dsh_proxy_request_approve within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_proxy_request_approve
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_proxy_request_approve.tsx
