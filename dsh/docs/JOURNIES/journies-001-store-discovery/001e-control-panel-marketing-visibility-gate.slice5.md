<!--
Canonical human-review path: dsh/docs/journies-001-store-discovery/001e-control-panel-marketing-visibility-gate.slice5.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-001-store-discovery-and-visibility/DSH-SLICE-001E-control-panel-marketing-visibility-gate.md
...
- Slice file: `dsh/docs/journies-001-store-discovery/001e-control-panel-marketing-visibility-gate.slice5.md`
...
# DSH-SLICE-001E — Control Panel Marketing Visibility Gate
...
| Business Outcome | operator active/inactive affects exposure |
...
1. يبدأ الممثل الأساسي `operator` من السطح `control-panel + app-client`.
2. الهدف العملي: operator active/inactive affects exposure.
...
- Parent Journey: J-001 — Store Discovery and Visibility
- Slice: DSH-SLICE-001E — Control Panel Marketing Visibility Gate
- Primary actor: operator
- Primary surface/area: control-panel + app-client
- Business outcome: operator active/inactive affects exposure
- SESSION_ID: DSH-SLICE-001E_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-001E_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-001E_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-001E_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
