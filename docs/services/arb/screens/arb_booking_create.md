...
16. Dependent Operations: arb_booking_create
...
19. Files To Create / Files To Touch: packages/surfaces/src/arb/arb_booking_create.tsx
20. Acceptance Gate: gate_a_b_c_passed
21. Deferred Items: W08 binding and W09 runtime proof-only closure.
22. Notes from donor extraction: services/arb/governance/operations/arb_booking_create/OP_SCREENS_MAP.csv
