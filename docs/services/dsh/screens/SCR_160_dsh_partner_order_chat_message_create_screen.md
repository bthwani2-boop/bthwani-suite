# Screen Contract: dsh_partner_order_chat_message_create_screen

1. Screen Identity: dsh_partner_order_chat_message_create_screen
2. Purpose: execute primary user task for dsh_partner_order_chat_message_create_screen within dsh.
3. Actor: shared
4. Surface: shared
5. Canonical Route: no_route_component
6. Entry Points: no_route_component entry
7. Exit Points: next route by CTA
8. Primary CTA: execute_create
...
16. Dependent Operations: dsh_partner_order_chat_message_create_screen
...
22. Notes from donor extraction: packages/surfaces/src/dsh/mobile/dsh/DshPartnerOrderChatMessageCreateScreen.tsx
