...
description: BThwani-guarded Next.js cache components advisory skill. Does not change runtime behavior without explicit scope.
---

# Next Cache Components - BThwani Safe Advisory Skill
