# Screen Contract: dsh_partner_intake_start

1. Screen Identity: dsh_partner_intake_start
2. Purpose: execute primary user task for dsh_partner_intake_start within dsh.
3. Actor: partner
...
16. Dependent Operations: dsh_partner_intake_start
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-partner/mobile/auto_dsh_partner_intake_start.tsx
