# Screen Contract: dsh_booking_create

1. Screen Identity: dsh_booking_create
2. Purpose: execute primary user task for dsh_booking_create within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_booking_create
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_booking_create.tsx
