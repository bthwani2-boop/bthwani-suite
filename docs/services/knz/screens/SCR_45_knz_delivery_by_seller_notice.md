# Screen Contract: knz_delivery_by_seller_notice

1. Screen Identity: knz_delivery_by_seller_notice
2. Purpose: execute primary user task for knz_delivery_by_seller_notice within knz.
3. Actor: customer
...
16. Dependent Operations: knz_listing_create|knz_listing_report|knz_listings_list
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/components/KnzDeliveryBySellerNotice.tsx
