# Screen Contract: knz_my_listings

1. Screen Identity: knz_my_listings
2. Purpose: execute primary user task for knz_my_listings within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_my_listings.tsx
