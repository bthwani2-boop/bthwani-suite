# Screen Contract: dsh_operations_dsh_sheinproxy_[id]_offer

1. Screen Identity: dsh_operations_dsh_sheinproxy_[id]_offer
2. Purpose: execute primary user task for dsh_operations_dsh_sheinproxy_[id]_offer within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /operations/dsh/sheinproxy/[id]/offer
6. Entry Points: /operations/dsh/sheinproxy/[id]/offer entry
...
16. Dependent Operations: dsh_operations_dsh_sheinproxy_id_offer
...
22. Notes from donor extraction: apps/web/control-panel/app/operations/dsh/sheinproxy/[id]/offer/page.tsx
