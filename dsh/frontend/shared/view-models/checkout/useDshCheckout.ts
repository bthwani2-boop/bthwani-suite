...
import { getDshCheckoutRuntimeClient } from '../../runtime/ui-only-runtime-clients';
import type { DshCheckoutAuthContext, DshCheckoutClient } from '../../api/dsh-checkout-client';
import type { DshOrderItemInput } from '../../api/dsh-order-lifecycle-client';
import { resolveDshDiscoveryStoresRuntimeConfig } from '../../adapters/client/dsh-discovery-stores-runtime-config';
import { parseCartItemPrice } from '../../adapters/client/store-formatting';
import {
