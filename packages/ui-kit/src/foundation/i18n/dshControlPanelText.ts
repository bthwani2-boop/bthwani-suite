...
const enDshControlPanelText = {
  ...
  hub: {
    ...
    heroDescriptionZoneSet: 'Guard the delivery scope with clearer operational boundaries.',
    heroDescriptionSheinProxy: 'A mediation lane for the DSH proxy workload.',
    ...
    workbenches: {
      ...
      sheinProxy: {
        label: 'Shein Proxy',
        description: 'A mediation lane for the DSH proxy workload.',
  ...
  sheinProxy: {
    pageEyebrow: 'DSH / operations / sheinproxy',
    pageTitle: 'Shein Proxy',
    pageDescription: 'A compact queue for proxy requests, pricing review, and next-step decisions without a hidden execution promise.',
    unavailableDescription: 'The route stays explicit even when requests are paused or not ready.',
    heroEyebrow: 'Proxy queue',
    heroTitle: 'Shein proxy requests',
    heroDescription: 'This surface keeps proxy requests readable and points to the next operational step without pretending to mutate state.',
    stateLoadingTitle: 'Preparing the proxy queue',
    stateLoadingDescription: 'The route is live, and the request list appears once the current data slice loads.',
    stateEmptyTitle: 'No proxy requests right now',
    stateEmptyDescription: 'The queue is ready, but there are no active proxy requests to review at the moment.',
    stateOfflineTitle: 'Connection unavailable',
    stateOfflineDescription: 'The proxy queue returns when connectivity is restored while the path remains explicit.',
    stateDisabledTitle: 'The proxy queue is not enabled yet',
    stateDisabledDescription: 'This surface is visually ready, but deeper proxy actions are deferred to a later slice.',
    stateErrorTitle: 'Unable to load the proxy queue',
    stateErrorDescription: 'You can return to the hub or retry from the same path.',
    signals: {
    ...
    tableTitle: 'Proxy requests',
    tableDescription: 'Each row shows the request, its pricing state, and the next action candidate.',
    allRequestsLabel: 'All requests',
    tableEmptyTitle: 'No requests match this filter',
    tableEmptyDescription: 'Try another queue slice or return to the full list.',
    selectedTitle: 'Selected request',
    selectedDescription: 'A compact breakdown of the currently focused request.',
    requestLabel: 'Request',
    customerLabel: 'Customer',
    productLabel: 'Product',
    quantityLabel: 'Quantity',
