# Screen Contract: dsh_chat_send

1. Screen Identity: dsh_chat_send
2. Purpose: execute primary user task for dsh_chat_send within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_captain_chat_send|dsh_chat_send|dsh_partner_chat_send
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_chat_send.tsx
