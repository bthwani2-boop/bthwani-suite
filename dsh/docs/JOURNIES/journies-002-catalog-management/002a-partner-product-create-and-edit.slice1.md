<!--
Canonical human-review path: dsh/docs/journies-002-catalog-management/002a-partner-product-create-and-edit.slice1.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-002-deep-catalog-management/DSH-SLICE-002A-partner-product-create-and-edit.md
...
- Slice file: `dsh/docs/journies-002-catalog-management/002a-partner-product-create-and-edit.slice1.md`
...
# DSH-SLICE-002A — Partner Product Create and Edit
...
| Business Outcome | create/edit products with SKU/barcode/category/facet |
| Primary Actor | `partner` |
| Primary Surface / Area | `app-partner + backend/OpenAPI` |
...
1. يبدأ الممثل الأساسي `partner` من السطح `app-partner + backend/OpenAPI`.
2. الهدف العملي: create/edit products with SKU/barcode/category/facet.
...
|---|---|---|---|
| `app-partner + backend/OpenAPI` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
- Parent Journey: J-002 — Deep Catalog Management
- Slice: DSH-SLICE-002A — Partner Product Create and Edit
- Primary actor: partner
- Primary surface/area: app-partner + backend/OpenAPI
- Business outcome: create/edit products with SKU/barcode/category/facet
- SESSION_ID: DSH-SLICE-002A_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-002A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-002A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-002A_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
