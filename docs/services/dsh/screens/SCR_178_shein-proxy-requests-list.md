# Screen Contract: shein-proxy-requests-list

1. Screen Identity: shein-proxy-requests-list
2. Purpose: execute primary user task for shein-proxy-requests-list within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_shein_proxy_requests_list
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/shein-proxy/shein-proxy-requests-list.tsx
