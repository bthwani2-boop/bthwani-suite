# Screen Contract: dsh_delivery_close

1. Screen Identity: dsh_delivery_close
2. Purpose: execute primary user task for dsh_delivery_close within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_delivery_close
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_delivery_close.tsx
