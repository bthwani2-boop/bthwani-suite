...
description: Read-only advisory guidance for Node.js/NestJS decisions in BThwani. Does not change runtime, dependencies, or backend code.
---

# Nodejs Best Practices - BThwani Safe Advisory Skill
