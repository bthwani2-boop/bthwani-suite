<!--
Canonical human-review path: dsh/docs/journies-004-order-lifecycle-support-refund/004a-client-order-tracking-and-status-timeline.slice1.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-004-order-lifecycle-support-cancellation-refund/DSH-SLICE-004A-client-order-tracking-and-status-timeline.md
...
- Slice file: `dsh/docs/journies-004-order-lifecycle-support-refund/004a-client-order-tracking-and-status-timeline.slice1.md`
...
# DSH-SLICE-004A — Client Order Tracking and Status Timeline
...
| Business Outcome | client sees status timeline and ETA with no polling overload |
| Primary Actor | `client` |
| Primary Surface / Area | `app-client + backend` |
...
1. يبدأ الممثل الأساسي `client` من السطح `app-client + backend`.
2. الهدف العملي: client sees status timeline and ETA with no polling overload.
...
|---|---|---|---|
| `app-client + backend` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-004A-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-004 — Order Lifecycle, Support, Cancellation, Refund
- Slice: DSH-SLICE-004A — Client Order Tracking and Status Timeline
- Primary actor: client
- Primary surface/area: app-client + backend
- Business outcome: client sees status timeline and ETA with no polling overload
- SESSION_ID: DSH-SLICE-004A_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-004A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-004A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-004A_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
