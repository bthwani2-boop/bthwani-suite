# Screen Contract: dsh_store_get

1. Screen Identity: dsh_store_get
2. Purpose: execute primary user task for dsh_store_get within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_partner_store_get|dsh_store_get
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_store_get.tsx
