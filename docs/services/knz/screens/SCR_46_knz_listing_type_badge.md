# Screen Contract: knz_listing_type_badge

1. Screen Identity: knz_listing_type_badge
2. Purpose: execute primary user task for knz_listing_type_badge within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/components/KnzListingTypeBadge.tsx
