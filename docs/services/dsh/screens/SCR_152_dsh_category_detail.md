# Screen Contract: dsh_category_detail

1. Screen Identity: dsh_category_detail
2. Purpose: execute primary user task for dsh_category_detail within dsh.
3. Actor: shared
4. Surface: shared
5. Canonical Route: no_route_component
6. Entry Points: no_route_component entry
7. Exit Points: next route by CTA
8. Primary CTA: open_category
...
16. Dependent Operations: dsh_category_detail
...
22. Notes from donor extraction: packages/surfaces/src/dsh/DshCategoryDetail.tsx
