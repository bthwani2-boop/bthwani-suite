...
Status: TEMPLATE
Owner root: packages/surfaces/src/service-owned/arb
Purpose: Single canonical living control file for the ARB service.
...
|---|---|
| Service | ARB |
| Canonical owner root | packages/surfaces/src/service-owned/arb |
| Current truth file | packages/surfaces/src/service-owned/arb/SERVICE_BLUEPRINT.md |
...
| Guard | Requirement |
|---|---|
| Canonical file | packages/surfaces/src/service-owned/arb/SERVICE_BLUEPRINT.md |
