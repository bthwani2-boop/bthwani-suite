...
language: ar
title: رحلة 13 — Control Panel Surface Sweep
---

# رحلة 13 — مسح Control Panel بالكامل

## الهدف

Control Panel لا يملك business truth. كل section يجب أن يكون UI shell يقرأ من shared topic.
...
- local API clients.
- local finance logic.
- local duplicated read models.
- build passing only in dev.

## بوابة الرحلة

`pnpm --dir control-panel/runtime build` إلزامي، وليس اختياريًا.
