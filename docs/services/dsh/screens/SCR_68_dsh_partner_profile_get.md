# Screen Contract: dsh_partner_profile_get

1. Screen Identity: dsh_partner_profile_get
2. Purpose: execute primary user task for dsh_partner_profile_get within dsh.
3. Actor: partner
...
16. Dependent Operations: dsh_partner_profile_get
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-partner/mobile/auto_dsh_partner_profile_get.tsx
