...
New canonical human-review folder: dsh/docs/journies-005-delivery-execution-captain/
...
# J-005 — Delivery Execution and Captain Operations
...
|---|---|
| Journey ID | `J-005` |
| Name | Delivery Execution and Captain Operations |
| Type | `business` |
| Primary Actors | captain, partner, client, operator, WLT |
| Control Panel / Domain Owner | operations + finance read-only |
| WLT Boundary | WLT owns payout effects; DSH displays read-only or emits events only |
| Planning Status | `DEFERRED_UNTIL_J004_AND_J009_RUNTIME_CLOSE` |
| Business Outcome | Captain receives, accepts, picks up, navigates, submits proof, delivers/fails/returns, while all related surfaces reflect the same truth. |
...
|---|---|---|---|---|---|---|
| `DSH-SLICE-005A` | Dispatch and Assignment | operator/captain | control-panel + app-captain + backend | operator/system assigns captain | `slices/j-005-delivery-execution-and-captain-operations/DSH-SLICE-005A-dispatch-and-assignment.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-005B` | Captain Accept Decline and Availability | captain | app-captain + backend | captain accepts/declines with availability guard | `slices/j-005-delivery-execution-and-captain-operations/DSH-SLICE-005B-captain-accept-decline-and-availability.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-005C` | Pickup Confirmation and Partner Handoff | captain/partner | app-captain + app-partner | pickup proof and partner ready state align | `slices/j-005-delivery-execution-and-captain-operations/DSH-SLICE-005C-pickup-confirmation-and-partner-handoff.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-005D` | Location Tracking and Client Visibility | captain/client | app-captain + app-client | client sees scoped location updates without heavy polling | `slices/j-005-delivery-execution-and-captain-operations/DSH-SLICE-005D-location-tracking-and-client-visibility.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-005E` | Proof of Delivery and Delivery Close | captain/client/operator | app-captain + app-client + control-panel | POD closes order and updates timeline | `slices/j-005-delivery-execution-and-captain-operations/DSH-SLICE-005E-proof-of-delivery-and-delivery-close.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-005F` | Failed Delivery Return and Exception Handling | captain/operator/partner | app-captain + control-panel + app-partner | failure/return path is auditable | `slices/j-005-delivery-execution-and-captain-operations/DSH-SLICE-005F-failed-delivery-return-and-exception-handling.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-005G` | Payout Read-Only Bridge | operator/WLT | control-panel + WLT | display payout effects without local DSH payout mutation | `slices/j-005-delivery-execution-and-captain-operations/DSH-SLICE-005G-payout-read-only-bridge.md` | NOT_CLOSED_BY_THIS_FILE |
