# Screen Contract: dsh_operations_dsh_sheinproxy_[id]_estimate

1. Screen Identity: dsh_operations_dsh_sheinproxy_[id]_estimate
2. Purpose: execute primary user task for dsh_operations_dsh_sheinproxy_[id]_estimate within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /operations/dsh/sheinproxy/[id]/estimate
6. Entry Points: /operations/dsh/sheinproxy/[id]/estimate entry
...
16. Dependent Operations: dsh_operations_dsh_sheinproxy_id_estimate
...
22. Notes from donor extraction: apps/web/control-panel/app/operations/dsh/sheinproxy/[id]/estimate/page.tsx
