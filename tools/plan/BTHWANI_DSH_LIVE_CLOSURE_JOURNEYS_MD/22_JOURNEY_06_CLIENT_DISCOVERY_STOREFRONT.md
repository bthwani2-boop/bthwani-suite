...
language: ar
title: رحلة 06 — Client Discovery/Storefront
---

# رحلة 06 — ظهور المتجر وتفاصيله في تطبيق العميل

## الهدف

تجربة العميل من discovery إلى store details اعتمادًا على backend/live data.

## مالك المنطق

- discovery visibility: `dsh/frontend/shared/discovery`.
- store cards/details: `dsh/frontend/shared/stores`.
- marketing placements: `dsh/frontend/shared/marketing`.
- UI render فقط في `app-client`.

## ممنوع

- store list محلية في app-client.
- fallback stores عند فشل API.
- navigation bridge يعيد تصدير أسماء تسبب barrel conflicts.
