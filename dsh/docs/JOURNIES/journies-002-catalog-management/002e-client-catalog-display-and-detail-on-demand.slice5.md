<!--
Canonical human-review path: dsh/docs/journies-002-catalog-management/002e-client-catalog-display-and-detail-on-demand.slice5.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-002-deep-catalog-management/DSH-SLICE-002E-client-catalog-display-and-detail-on-demand.md
...
- Slice file: `dsh/docs/journies-002-catalog-management/002e-client-catalog-display-and-detail-on-demand.slice5.md`
- Slice order inside journey: `5` of `6`
...
# DSH-SLICE-002E — Client Catalog Display and Detail-on-Demand
...
| Business Outcome | browse lean summaries and fetch details on demand |
| Primary Actor | `client` |
| Primary Surface / Area | `app-client + typed client` |
...
1. يبدأ الممثل الأساسي `client` من السطح `app-client + typed client`.
2. الهدف العملي: browse lean summaries and fetch details on demand.
...
|---|---|---|---|
| `app-client + typed client` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-002E-01 | StoreItemsScreen.tsx + StoreMenuItemCard.tsx + StoreScreen.tsx exist with loading/empty/error/unavailable states and clientVisibilityStatus filter. On-demand detail via useStoreDerivedItems hook. dsh-discovery-stores-client.ts typed transport present. No WLT mutation. | CODE_EXISTS_VERIFIED | app-client | None — visual screenshot evidence required for PASS | NEEDS_VISUAL_EVIDENCE |
| GAP-002E-02 | CODE_VERIFICATION_RUN 2026-06-12: tsc --noEmit = PASS (0 errors). go test ./... = PASS. ListProducts/GetProduct with LEFT JOIN overrides confirmed. Evidence: tools/registry/runs/J-002-20260612-182200/tsc-noemit.txt + go-test.txt | CODE_VERIFIED_TSC_GOTEST | app-client + backend | None — code gate passed | NEEDS_VISUAL_EVIDENCE |
...
- Parent Journey: J-002 — Deep Catalog Management
- Slice: DSH-SLICE-002E — Client Catalog Display and Detail-on-Demand
- Primary actor: client
- Primary surface/area: app-client + typed client
- Business outcome: browse lean summaries and fetch details on demand
- SESSION_ID: DSH-SLICE-002E_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-002E_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-002E_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-002E_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
