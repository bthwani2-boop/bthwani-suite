...
type FieldStoresHomeScreenProps = {
...
export function FieldStoresHomeScreen({ stores, onOpenStore, onOpenAccount, onCreateStore }: FieldStoresHomeScreenProps) {
...
export default FieldStoresHomeScreen;