# Screen Contract: knz_categories_list

1. Screen Identity: knz_categories_list
2. Purpose: execute primary user task for knz_categories_list within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_categories_list.tsx
