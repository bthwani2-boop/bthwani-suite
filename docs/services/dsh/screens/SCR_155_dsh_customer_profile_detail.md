# Screen Contract: dsh_customer_profile_detail

1. Screen Identity: dsh_customer_profile_detail
2. Purpose: execute primary user task for dsh_customer_profile_detail within dsh.
3. Actor: shared
4. Surface: shared
...
16. Dependent Operations: dsh_customer_profile_detail
...
22. Notes from donor extraction: packages/surfaces/src/dsh/DshCustomerProfileDetail.tsx
