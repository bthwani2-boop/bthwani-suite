...
| `VR-L2-008` | `control-panel` | `ops.dsh.catalog.approvals.quality` | `dsh/frontend/control-panel/catalogs/ControlPanelDshCatalogScreen.tsx` | `/catalogs?tab=approvals&subTab=quality` | `LIST_2_DISABLED_PREVIEW` | `P2` | `needs screenshot (Required for Slice 001)` |
| `VR-L2-009` | `control-panel` | `ops.dsh.catalog.approvals.pricing` | `dsh/frontend/control-panel/catalogs/ControlPanelDshCatalogScreen.tsx` | `/catalogs?tab=approvals&subTab=pricing` | `LIST_2_DISABLED_PREVIEW` | `P2` | `needs screenshot (Required for Slice 001)` |
