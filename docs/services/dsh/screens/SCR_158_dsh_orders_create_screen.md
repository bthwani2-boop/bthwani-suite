# Screen Contract: dsh_orders_create_screen

1. Screen Identity: dsh_orders_create_screen
2. Purpose: execute primary user task for dsh_orders_create_screen within dsh.
3. Actor: shared
4. Surface: shared
...
16. Dependent Operations: dsh_orders_create_screen
...
22. Notes from donor extraction: packages/surfaces/src/dsh/mobile/dsh/DshOrdersCreateScreen.tsx
