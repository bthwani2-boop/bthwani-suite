# Screen Contract: dsh_categories_list_shared

1. Screen Identity: dsh_categories_list_shared
2. Purpose: execute primary user task for dsh_categories_list_shared within dsh.
3. Actor: shared
4. Surface: shared
...
22. Notes from donor extraction: packages/surfaces/src/dsh/DshCategoriesList.tsx
