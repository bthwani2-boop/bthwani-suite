# Screen Contract: dsh_cart_item_add_screen

1. Screen Identity: dsh_cart_item_add_screen
2. Purpose: execute primary user task for dsh_cart_item_add_screen within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_cart_item_add|dsh_cart_item_add_screen
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/DshCartItemAddScreen.tsx
