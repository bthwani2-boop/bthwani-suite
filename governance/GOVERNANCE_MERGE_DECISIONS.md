...
Record every meaningful governance merge/adoption/replacement decision.
...
Source file(s):
Target file:
Action: ADOPTED / MERGED / REPLACED / REJECTED / DEFERRED
Reason:
Conflict review:
Evidence:
Rollback:
...
| Decision ID | Source | Target | Action | Reason |
|---|---|---|---|---|
| GOV-PKG-20260430-001 | Project governance standards + current governance root | `governance/` canonical package | ADOPTED | Establish unified governance folder with clear policy separation |
