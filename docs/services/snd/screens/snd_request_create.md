# Screen Contract - snd_request_create

1. Screen Identity: SCR_4
2. Purpose: create SND request.
3. Actor: client
4. Surface: app-client
5. Canonical Route: /snd/requests/create
6. Entry Points: snd hub and requests list.
7. Exit Points: request list.
8. Primary CTA: submit_create
9. Secondary Actions: retry, back.
10. Required Data: create payload.
...
16. Dependent Operations: snd_request_create
17. Required UI-Kit Pieces: form controls, state shells.
18. Local vs Shared Ownership: shared ui-kit primitives.
19. Files To Create / Files To Touch: packages/surfaces/src/snd/snd_request_create.tsx
