# Screen Contract: dsh_store_items_list_shared

1. Screen Identity: dsh_store_items_list_shared
2. Purpose: execute primary user task for dsh_store_items_list_shared within dsh.
3. Actor: shared
4. Surface: shared
...
16. Dependent Operations: dsh_store_items_list
...
22. Notes from donor extraction: packages/surfaces/src/dsh/components/DshStoreItemsList.tsx
