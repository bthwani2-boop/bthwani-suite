...
import type { DshPartnerSettlementSummary } from '../data/partnerFinancePreviewData';
...
export function PartnerSettlementSummaryPanel({ items = defaultSettlements }: DshPartnerSettlementSummaryPanelProps) {
  return (
...
export { PartnerSettlementSummaryPanel as DshPartnerSettlementSummaryPanel };

export default PartnerSettlementSummaryPanel;
