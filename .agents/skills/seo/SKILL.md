---
name: seo
description: BThwani-guarded SEO advisory skill. Does not change routes, metadata, content, or runtime without explicit scope.
---

# Seo - BThwani Safe Advisory Skill
