---
name: nx-import
description: Read-only advisory review for Nx import and migration risk. Does not import, merge, or move repositories.
---

# Nx Import - BThwani Safe Advisory Skill
