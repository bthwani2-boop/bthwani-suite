# Screen Contract: dsh_stores_list

1. Screen Identity: dsh_stores_list
2. Purpose: execute primary user task for dsh_stores_list within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_stores_list
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_stores_list.tsx
