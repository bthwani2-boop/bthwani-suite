...
1. Wave Identity: W00_FOUNDATION
2. Wave Goal: Deliver scoped bundle for W00_FOUNDATION with gate-based progression.
3. Why This Wave Exists: isolate risk and enforce ordered execution by queue.
4. Included Screen Bundles: none
5. Included Operation Families: foundation_governance
