# Screen Contract: knz_listings_search

1. Screen Identity: knz_listings_search
2. Purpose: execute primary user task for knz_listings_search within knz.
3. Actor: customer
...
8. Primary CTA: open_search_view
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_listings_search.tsx
