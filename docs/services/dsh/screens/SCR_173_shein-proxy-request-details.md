# Screen Contract: shein-proxy-request-details

1. Screen Identity: shein-proxy-request-details
2. Purpose: execute primary user task for shein-proxy-request-details within dsh.
3. Actor: ops|admin
...
8. Primary CTA: open_details_view
...
16. Dependent Operations: dsh_shein_proxy_request_details
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/shein-proxy/shein-proxy-request-details.tsx
