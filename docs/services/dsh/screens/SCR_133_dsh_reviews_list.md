# Screen Contract: dsh_reviews_list

1. Screen Identity: dsh_reviews_list
2. Purpose: execute primary user task for dsh_reviews_list within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_reviews_list
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_reviews_list.tsx
