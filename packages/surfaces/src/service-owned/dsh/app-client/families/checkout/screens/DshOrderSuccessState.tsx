...
import { BthBox, BthStateView, BthButton } from '@bthwani/ui-kit';
...
export function DshOrderSuccessState({
  ...
  return (
    <BthBox gap={3}>
      <BthStateView stateId="success" title="Order submitted" description={message} />
      <BthButton label={nextLabel} onPress={onNext} />
    </BthBox>
  );
}

export default DshOrderSuccessState;
