...
export function PartnerWalletPreview({ onBack, onOpenExpandedWallet }: DshPartnerWalletPreviewProps) {
  return (
...
export { PartnerWalletPreview as DshPartnerWalletPreview };

export default PartnerWalletPreview;
