...
```text
مصدر الحقيقة: live code + dsh/frontend/control-panel/shared/dshCrossSurfaceClosureMap.ts + tools/registry/runs
dsh/docs: execution guide فقط — لا تُستخدم وحدها لإثبات جاهزية عند وجود drift
branch_policy: current checked-out branch فقط
READINESS_DECISION: STILL_UNPROVEN / FIX_REQUIRED حتى يثبت العكس من gates
```
