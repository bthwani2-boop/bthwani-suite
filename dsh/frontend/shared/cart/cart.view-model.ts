// Canonical location: dsh/frontend/shared/cart/cart.view-model.ts
// Authority: dsh/frontend/shared/cart — cart state view-model.
...
import type { CreateOrderValues, DshRoute } from '../checkout/dsh-client-binding.contracts';
import {
