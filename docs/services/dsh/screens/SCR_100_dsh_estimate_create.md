# Screen Contract: dsh_estimate_create

1. Screen Identity: dsh_estimate_create
2. Purpose: execute primary user task for dsh_estimate_create within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_estimate_create
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_estimate_create.tsx
