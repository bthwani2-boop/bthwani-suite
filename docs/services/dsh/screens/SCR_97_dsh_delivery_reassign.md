# Screen Contract: dsh_delivery_reassign

1. Screen Identity: dsh_delivery_reassign
2. Purpose: execute primary user task for dsh_delivery_reassign within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_delivery_reassign|dsh_delivery_reassign_request
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_delivery_reassign.tsx
