<!--
Canonical human-review path: dsh/docs/journies-012-auth-permissions-account-profile/012d-control-panel-operator-rbac.slice4.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-012-auth-permissions-account-profile-dependency/DSH-SLICE-012D-control-panel-operator-rbac.md
...
- Slice file: `dsh/docs/journies-012-auth-permissions-account-profile/012d-control-panel-operator-rbac.slice4.md`
...
# DSH-SLICE-012D — Control Panel Operator RBAC
...
2. الهدف العملي: operator roles gate actions/screens.
...
|---|---|---|---|---|---|
| GAP-012D-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-012 — Auth, Permissions, Account/Profile Dependency
- Slice: DSH-SLICE-012D — Control Panel Operator RBAC
- Primary actor: operator
- Primary surface/area: control-panel + backend
- Business outcome: operator roles gate actions/screens
- SESSION_ID: DSH-SLICE-012D_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-012D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-012D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-012D_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
