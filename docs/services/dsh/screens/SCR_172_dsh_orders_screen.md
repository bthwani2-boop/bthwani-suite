# Screen Contract: dsh_orders_screen

1. Screen Identity: dsh_orders_screen
2. Purpose: execute primary user task for dsh_orders_screen within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_control_panel_dsh_orders_screen
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/control_panelDshOrdersScreen.tsx
