# Screen Contract: dsh_field_store_activation_request

1. Screen Identity: dsh_field_store_activation_request
2. Purpose: execute primary user task for dsh_field_store_activation_request within dsh.
3. Actor: field
4. Surface: app-field
...
16. Dependent Operations: dsh_field_store_activation_request
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-field/mobile/auto_dsh_field_store_activation_request.tsx
