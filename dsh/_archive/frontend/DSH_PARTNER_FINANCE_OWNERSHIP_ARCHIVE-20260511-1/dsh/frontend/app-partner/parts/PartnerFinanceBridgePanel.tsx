...
import type { DshPartnerFinanceBridgeState } from '../data/partnerFinancePreviewData';
...
export function PartnerFinanceBridgePanel({ state = defaultFinanceState }: DshPartnerFinanceBridgePanelProps) {
  return (
...
export { PartnerFinanceBridgePanel as DshPartnerFinanceBridgePanel };

export default PartnerFinanceBridgePanel;
