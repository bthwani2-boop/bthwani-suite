---
name: accessibility
description: BThwani-guarded accessibility review for UI. Advisory only with RTL, ui-kit, and visual evidence requirements.
---

# Accessibility - BThwani Safe Advisory Skill
