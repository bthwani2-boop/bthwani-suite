# Screen Contract: knz_ratings_list

1. Screen Identity: knz_ratings_list
2. Purpose: execute primary user task for knz_ratings_list within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/components/KnzRatingsList.tsx
