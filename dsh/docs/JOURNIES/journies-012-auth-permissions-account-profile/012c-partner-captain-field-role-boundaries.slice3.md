<!--
Canonical human-review path: dsh/docs/journies-012-auth-permissions-account-profile/012c-partner-captain-field-role-boundaries.slice3.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-012-auth-permissions-account-profile-dependency/DSH-SLICE-012C-partner-captain-field-role-boundaries.md
...
- Journey folder: `dsh/docs/journies-012-auth-permissions-account-profile/`
- Slice file: `dsh/docs/journies-012-auth-permissions-account-profile/012c-partner-captain-field-role-boundaries.slice3.md`
...
# DSH-SLICE-012C — Partner Captain Field Role Boundaries
...
| Field | Value |
|---|---|
| Slice ID | `DSH-SLICE-012C` |
| Parent Journey | `J-012 — Auth, Permissions, Account/Profile Dependency` |
| Journey Type | `foundation` |
| Business Outcome | role access prevents cross-surface leakage |
| Primary Actor | `partner/captain/field` |
| Primary Surface / Area | `mobile apps + backend` |
| Control Panel Owner | `auth/service boundary` |
...
1. يبدأ الممثل الأساسي `partner/captain/field` من السطح `mobile apps + backend`.
2. الهدف العملي: role access prevents cross-surface leakage.
...
|---|---|---|---|
| `mobile apps + backend` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
- التصنيف الحالي: `auth only for financial authorization`.
...
|---|---|---|---|---|---|
| GAP-012C-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-012 — Auth, Permissions, Account/Profile Dependency
- Slice: DSH-SLICE-012C — Partner Captain Field Role Boundaries
- Primary actor: partner/captain/field
- Primary surface/area: mobile apps + backend
- Business outcome: role access prevents cross-surface leakage
- SESSION_ID: DSH-SLICE-012C_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-012C_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-012C_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-012C_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
