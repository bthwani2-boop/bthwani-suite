...
| DSH-RUN-002 | customer shopping | dsh/frontend/app-client | app-client | fixture/preview TBD | NO | device/simulator runtime + screenshots | N/A | RUNTIME_UNPROVEN | map app-client flow |
