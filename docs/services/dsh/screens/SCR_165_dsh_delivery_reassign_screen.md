# Screen Contract: dsh_delivery_reassign_screen

1. Screen Identity: dsh_delivery_reassign_screen
2. Purpose: execute primary user task for dsh_delivery_reassign_screen within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_delivery_reassign_screen
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/DshDeliveryReassignScreen.tsx
