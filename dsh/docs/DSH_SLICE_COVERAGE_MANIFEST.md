...
| J-006 | Field Readiness | Business | field, operator, partner | operations | none | **DEFERRED_WITH_REASON** — deferred pending onboarding API design and field readiness verification; ready for local smoke testing |
