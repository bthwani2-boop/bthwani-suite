# Screen Contract: knz_policy_disclaimer

1. Screen Identity: knz_policy_disclaimer
2. Purpose: execute primary user task for knz_policy_disclaimer within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/components/KnzPolicyDisclaimer.tsx
