...
export function ProductEditScreen({
  ...
  const approvalTone = getDshProductApprovalStatusTone(approvalStatus);
        ...
        {mode === 'edit' ? (
          <Box style={{ flexDirection: resolveRowDirection(direction), gap: spacing[2], flexWrap: 'wrap' }}>
            ...
            {savedRecord ? (
              ...
              <Chip label={`معرف المنتج: ${productId}`} tone="default" />
            ) : null}
          </Box>
        ) : null}
          ...
          <Box style={{ flexDirection: resolveRowDirection(direction), flexWrap: 'wrap', gap: 6 }}>
            {([
              ...
              <Chip
                ...
                tone={step === approvalStatus ? getDshProductApprovalStatusTone(step) : 'default'}
