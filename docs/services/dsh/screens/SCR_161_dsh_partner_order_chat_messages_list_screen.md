# Screen Contract: dsh_partner_order_chat_messages_list_screen

1. Screen Identity: dsh_partner_order_chat_messages_list_screen
2. Purpose: execute primary user task for dsh_partner_order_chat_messages_list_screen within dsh.
3. Actor: shared
4. Surface: shared
5. Canonical Route: no_route_component
6. Entry Points: no_route_component entry
7. Exit Points: next route by CTA
8. Primary CTA: open_list_view
...
16. Dependent Operations: dsh_partner_order_chat_messages_list_screen
...
22. Notes from donor extraction: packages/surfaces/src/dsh/mobile/dsh/DshPartnerOrderChatMessagesListScreen.tsx
