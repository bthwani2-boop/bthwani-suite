# Screen Contract: dsh_cart_init

1. Screen Identity: dsh_cart_init
2. Purpose: execute primary user task for dsh_cart_init within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_cart_init
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_cart_init.tsx
