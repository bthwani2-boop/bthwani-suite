# Screen Contract: dsh_operations_dsh_sheinproxy

1. Screen Identity: dsh_operations_dsh_sheinproxy
2. Purpose: execute primary user task for dsh_operations_dsh_sheinproxy within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /operations/dsh/sheinproxy
6. Entry Points: /operations/dsh/sheinproxy entry
...
16. Dependent Operations: dsh_operations_dsh_sheinproxy
...
22. Notes from donor extraction: apps/web/control-panel/app/operations/dsh/sheinproxy/page.tsx
