...
description: Read-only advisory review for Node.js/NestJS backend patterns in BThwani. Does not build backend services.
---

# Nodejs Backend Patterns - BThwani Safe Advisory Skill
