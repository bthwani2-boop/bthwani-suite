<!--
Canonical human-review path: dsh/docs/journies-005-delivery-execution-captain/005f-failed-delivery-return-and-exception-handling.slice6.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-005-delivery-execution-and-captain-operations/DSH-SLICE-005F-failed-delivery-return-and-exception-handling.md
...
- Journey folder: `dsh/docs/journies-005-delivery-execution-captain/`
- Slice file: `dsh/docs/journies-005-delivery-execution-captain/005f-failed-delivery-return-and-exception-handling.slice6.md`
...
# DSH-SLICE-005F — Failed Delivery Return and Exception Handling
...
| Parent Journey | `J-005 — Delivery Execution and Captain Operations` |
| Journey Type | `business` |
| Business Outcome | failure/return path is auditable |
| Primary Actor | `captain/operator/partner` |
| Primary Surface / Area | `app-captain + control-panel + app-partner` |
| Control Panel Owner | `operations + finance read-only` |
...
1. يبدأ الممثل الأساسي `captain/operator/partner` من السطح `app-captain + control-panel + app-partner`.
2. الهدف العملي: failure/return path is auditable.
...
|---|---|---|---|
| `app-captain + control-panel + app-partner` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
- التصنيف الحالي: `WLT owns payout effects; DSH displays read-only or emits events only`.
...
|---|---|---|---|---|---|
| GAP-005F-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-005 — Delivery Execution and Captain Operations
- Slice: DSH-SLICE-005F — Failed Delivery Return and Exception Handling
- Primary actor: captain/operator/partner
- Primary surface/area: app-captain + control-panel + app-partner
- Business outcome: failure/return path is auditable
- SESSION_ID: DSH-SLICE-005F_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-005F_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-005F_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-005F_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
