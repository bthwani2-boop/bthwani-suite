...
| Gate 10 Evidence Lock | evidence pack and decision record | evidence folder exists at `tools/registry/runs/DSH_VISUAL_SWEEP-20260524-034147`; full guard results still pending | `DEFERRED_WITH_REASON` |
...
Capture the remaining required visual states for `VR-L1-001`, `VR-L1-023`, and `VR-L1-005`, then run the remaining guards before any OpenAPI, binding, or runtime work.
