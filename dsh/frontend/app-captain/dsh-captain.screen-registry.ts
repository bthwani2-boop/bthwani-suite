...
export const dshCaptainScreenRegistry = [
  ...
  },
  {
    ...
    screenId: 'captain.dsh.orders.map',
    routeId: 'dsh-captain-map',
    surfaceId: 'app-captain',
    ownerKind: 'service',
    ownerId: 'dsh',
    serviceId: 'dsh',
    ownerPath: 'dsh/frontend/app-captain/screens/DshCaptainMapScreen.tsx',
    componentName: 'DshCaptainMapScreen',
    screenKind: 'FLOW_STEP',
    flowId: 'captain.dsh.orders',
    requiredStates: ['loading', 'success', 'error'],
    requiredPermissions: ['location'],
    analytics: { screenView: 'captain_dsh_orders_map_view' },
