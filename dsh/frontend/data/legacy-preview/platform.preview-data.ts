import type { AppearanceRecord, ProviderRecord, ServiceRecord, DshPlatformVarRecord, DshPlatformProviderControlRecord, DshPlatformScopeLayer, DshPlatformPolicyScenario, DshPlatformAuditEntry } from '../../shared/dsh-cp-platform.contract';
...
export const PREVIEW_APPEARANCE_RECORDS: readonly AppearanceRecord[] = [
  {
    ...
    currentValue: 'BThwani 2026 Core',
    proposedValue: 'BThwani 2026 Core',
  ...
  },
  {
    ...
    scope: 'App',
    risk: 'medium',
    currentValue: 'Standard Tokens',
    proposedValue: 'Client App Context',
  ...
  },
  {
    ...
    scope: 'Platform',
    risk: 'visual-identity',
    currentValue: 'Global Tokens',
    proposedValue: 'High Contrast Operations Dashboard',
...
export const DSH_PLATFORM_OPERATIONAL_VARS: readonly DshPlatformVarRecord[] = [
  {
    ...
    scope: 'Global',
    risk: 'financial',
    currentValue: '10,000 ريال',
    proposedValue: '15,000 ريال',
  ...
  },
  {
    ...
    scope: 'Global',
    risk: 'low',
    currentValue: '90 ثانية',
    proposedValue: '60 ثانية',
  ...
  },
  {
    ...
    scope: 'Global',
    risk: 'high',
    currentValue: 'كل أحد 10:00 ص',
    proposedValue: 'يومياً 10:00 ص',
...
export const DSH_PLATFORM_WLT_FINANCIAL_BRIDGE_VARS: readonly DshPlatformVarRecord[] = [
  {
    ...
    scope: 'City',
    risk: 'financial',
    currentValue: '2,200 ريال — معاينة عرض فقط',
    proposedValue: '2,500 ريال — محاكاة موسم الذروة',
  ...
  },
  {
    ...
    scope: 'Category',
    risk: 'financial',
    currentValue: '12% لفئة الإلكترونيات',
    proposedValue: '13% لفئة الإلكترونيات عالية الهامش',
  ...
  },
  {
    ...
    scope: 'Region',
    risk: 'financial',
    currentValue: '150,000 ريال — ضمان إقليمي',
    proposedValue: '175,000 ريال — للمناطق عالية المخاطر',
  ...
  },
  {
    ...
    scope: 'Global',
    risk: 'financial',
    currentValue: '8,000 ريال — الحد الآلي العالمي',
    proposedValue: '5,000 ريال — مسار تجريبي أكثر تحفظًا',
  ...
  },
  {
    ...
    scope: 'Service',
    risk: 'financial',
    currentValue: 'T+7 — مرجع تسوية الخدمة',
    proposedValue: 'T+5 — لشركاء الخدمة عالية الجدارة',
  ...
  },
  {
    ...
    scope: 'Service',
    risk: 'financial',
    currentValue: 'غير محدد — NOT_RUNTIME_BOUND',
    proposedValue: 'T+3 عند اعتماد عقد WLT',
...
export const DSH_PLATFORM_PROVIDER_CONTROL_VARS: readonly DshPlatformProviderControlRecord[] = [
  {
    ...
    scope: 'City',
    risk: 'high',
    currentValue: 'priority=P1 · mode=active-passive',
    proposedValue: 'priority=P0 · mode=weighted-active',
  ...
  },
  {
    ...
    scope: 'Global',
    risk: 'medium',
    currentValue: 'guarded mode مع escalation يدوي',
    proposedValue: 'guarded mode + auto-fallback بعد محاولتين',
...
// Design system identity vars — preview/reference policy only, no free hex/font/mutations.
export const DSH_PLATFORM_DESIGN_POLICY_VARS: readonly DshPlatformVarRecord[] = [
  {
    id: 'ui-appearance-mode',
    key: 'VAR_UI_APPEARANCE_MODE',
    label: 'وضع مظهر الواجهة (Appearance Mode)',
    owner: 'DSH',
    status: 'disabled-by-policy',
    scope: 'Global',
    risk: 'low',
    currentValue: 'lightPremium',
    proposedValue: undefined,
    effectSummary: 'التحم في سمة المظهر العامة للمنصة: الوضع المضيء الفاخر أو الداكن الشفاف.',
    auditRollbackHint: 'الرجوع إلى lightPremium هو الخيار الآمن عند حدوث مشاكل في التباين.',
    precedenceNote: 'سياسة مظهر مركزية تغطي جميع التطبيقات.',
    affectedSurfaces: ['تطبيق العميل', 'تطبيق الشريك', 'تطبيق الكابتن', 'لوحة التحكم'],
    auditRequired: false,
    mutationAllowed: false,
  },
  {
    id: 'ui-font-profile',
    key: 'VAR_UI_FONT_PROFILE',
    label: 'ملف الخطوط واللغة العربية (Font Profile)',
    owner: 'DSH',
    status: 'disabled-by-policy',
    scope: 'Global',
    risk: 'low',
    currentValue: 'arabic-system',
    proposedValue: undefined,
    effectSummary: 'تحديد طاقم الخطوط المفضلة للنصوص العربية واللاتينية (النظام الافتراضي، الممتاز، أو عالي المقروئية).',
    auditRollbackHint: 'الرجوع لخطوط النظام لتجنب مشاكل التحميل.',
    precedenceNote: 'تنطبق سياسة الخطوط على النصوص المركزية فقط.',
    affectedSurfaces: ['جميع الأسطح'],
    auditRequired: false,
    mutationAllowed: false,
  },
  {
    id: 'ui-density-profile',
    key: 'VAR_UI_DENSITY_PROFILE',
    label: 'مستوى كثافة العناصر (Density Profile)',
    owner: 'DSH',
    status: 'disabled-by-policy',
    scope: 'Global',
    risk: 'low',
    ...
    proposedValue: undefined,
    effectSummary: 'التحكم في الفراغات الداخلية والهوامش والارتفاعات عبر المنصة (مدمج، مريح، أو واسع).',
    auditRollbackHint: 'الرجوع لـ comfortable لمنع تداخل العناصر.',
    precedenceNote: 'تتأثر بها الهوامش والأبعاد الأساسية.',
    affectedSurfaces: ['تطبيق العميل', 'تطبيق الشريك', 'تطبيق الكابتن'],
    auditRequired: false,
    mutationAllowed: false,
  },
  {
    id: 'ui-radius-profile',
    key: 'VAR_UI_RADIUS_PROFILE',
    label: 'زوايا وأركان المكونات (Radius Profile)',
    owner: 'DSH',
    status: 'disabled-by-policy',
    scope: 'Global',
    risk: 'low',
    ...
    proposedValue: undefined,
    effectSummary: 'تحديد انحناء زوايا البطاقات والأزرار والحقول (ناعم، متوازن، أو حاد).',
    auditRollbackHint: 'العودة لـ balanced.',
    precedenceNote: 'تؤثر على انحناء الحواف الموحد.',
    affectedSurfaces: ['جميع المكونات المرئية'],
    auditRequired: false,
    mutationAllowed: false,
  },
  {
    id: 'ui-motion-profile',
    key: 'VAR_UI_MOTION_PROFILE',
    label: 'ملف الحركة والتأثيرات الانتقالية (Motion Profile)',
    owner: 'DSH',
    status: 'disabled-by-policy',
    scope: 'Global',
    risk: 'low',
    ...
    proposedValue: undefined,
    effectSummary: 'ضبط سرعة وسلوك الرسوم المتحركة والتأثيرات الانتقالية لتوفير الطاقة وتقليل تشتيت المشغلين.',
    auditRollbackHint: 'العودة لسرعة standard.',
    precedenceNote: 'تؤثر على سرعة Transitions.',
    affectedSurfaces: ['جميع شاشات التفاعل'],
    auditRequired: false,
    mutationAllowed: false,
  },
  {
    id: 'ui-marketing-emphasis',
    key: 'VAR_UI_MARKETING_EMPHASIS',
    label: 'أسلوب إبراز الحملات والتسويق (Marketing Emphasis)',
    owner: 'DSH',
    status: 'disabled-by-policy',
    scope: 'Global',
    risk: 'low',
    currentValue: 'calm',
    proposedValue: undefined,
    effectSummary: 'درجة إبراز البنرات الإعلانية والعروض الترويجية في الصفحة الرئيسية (هادئ، فاخر، أو حملة مكثفة).',
    auditRollbackHint: 'الرجوع لـ calm.',
    precedenceNote: 'تتحكم في كثافة الألوان البارزة.',
    affectedSurfaces: ['تطبيق العميل', 'صفحة المتجر'],
    auditRequired: false,
    mutationAllowed: false,
  },
  {
    id: 'ui-control-panel-density',
    key: 'VAR_UI_CONTROL_PANEL_DENSITY',
    label: 'كثافة لوحة التحكم للعمليات (Control Panel Density)',
    owner: 'DSH',
    status: 'disabled-by-policy',
    scope: 'Global',
    risk: 'low',
    ...
    proposedValue: undefined,
    effectSummary: 'مستوى كثافة الجداول والصفوف والقوائم في لوحة تحكم العمليات (مدمج جداً أو متوازن).',
    auditRollbackHint: 'الرجوع لـ compact لزيادة كمية البيانات المعروضة في الشاشة الواحدة.',
    precedenceNote: 'خاص بصفحات العمليات الكثيفة فقط.',
    affectedSurfaces: ['لوحة العمليات', 'لوحة الإسناد'],
    auditRequired: false,
    mutationAllowed: false,
  },
];
...
export const DSH_PLATFORM_POLICY_SCENARIOS: readonly DshPlatformPolicyScenario[] = [
  {
...
export function selectDshControlPanelPlatformPreview() {
  return {
    ...
    designVars: DSH_PLATFORM_DESIGN_POLICY_VARS,
