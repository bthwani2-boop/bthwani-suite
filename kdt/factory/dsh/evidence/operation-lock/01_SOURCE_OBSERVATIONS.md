...
## Confirmed Operation-Level Observations

- donor operation catalog confirms concrete customer checkout, partner handling, captain execution, field support, proxy-request, and internal ops actions inside DSH
...
- the target operation lock uses canonical operation families rather than importing donor endpoints one by one
- the target lifecycle remains intentionally constrained to evidence-confirmed visible states only
- money movement remains outside DSH ownership and belongs to `WLT`
