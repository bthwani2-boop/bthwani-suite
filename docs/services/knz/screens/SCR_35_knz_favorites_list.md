# Screen Contract: knz_favorites_list

1. Screen Identity: knz_favorites_list
2. Purpose: execute primary user task for knz_favorites_list within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_favorites_list.tsx
