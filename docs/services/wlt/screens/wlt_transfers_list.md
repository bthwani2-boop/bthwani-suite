# Screen Contract - wlt_transfers_list

1. Screen Identity: SCR_26
2. Purpose: list transfer history and statuses.
3. Actor: client
4. Surface: app-client
5. Canonical Route: /wlt/transfers
6. Entry Points: transfer creation and wallet navigation.
7. Exit Points: transfer detail and support flow.
8. Primary CTA: open_view
9. Secondary Actions: retry, back, support_action.
10. Required Data: transfer list, status filters, pagination cursor.
...
14. Validation Rules: entitlement and filter constraints.
15. Empty / Error / Loading / Offline / Disabled States: mandatory.
16. Dependent Operations: wlt_transfers_list
...
19. Files To Create / Files To Touch: packages/surfaces/src/wlt/wlt_transfers_list.tsx
