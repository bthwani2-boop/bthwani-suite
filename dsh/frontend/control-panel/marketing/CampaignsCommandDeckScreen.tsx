    ...
    switch (editorTab) {
      ...
      case 'impact': {
        const mockContext = {
          ...
          activeOffers: [],
          activeSubscriptions: [],
          activeEntitlements: draft.linkedLoyaltyBenefitId ? [{ id: 'mock', type: 'loyalty-reward', referenceId: draft.linkedLoyaltyBenefitId, status: 'active', source: 'loyalty', benefitLabel: 'ميزة ولاء مرتبطة' } satisfies Entitlement] : [],
