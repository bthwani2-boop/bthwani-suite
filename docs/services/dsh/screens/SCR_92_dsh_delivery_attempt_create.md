# Screen Contract: dsh_delivery_attempt_create

1. Screen Identity: dsh_delivery_attempt_create
2. Purpose: execute primary user task for dsh_delivery_attempt_create within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_delivery_attempt_create
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_delivery_attempt_create.tsx
