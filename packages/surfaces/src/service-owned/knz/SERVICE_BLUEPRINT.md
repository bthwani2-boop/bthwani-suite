...
Status: TEMPLATE
Owner root: packages/surfaces/src/service-owned/knz
Purpose: Single canonical living control file for the KNZ service.
...
|---|---|
| Service | KNZ |
| Canonical owner root | packages/surfaces/src/service-owned/knz |
| Current truth file | packages/surfaces/src/service-owned/knz/SERVICE_BLUEPRINT.md |
...
| Guard | Requirement |
|---|---|
| Canonical file | packages/surfaces/src/service-owned/knz/SERVICE_BLUEPRINT.md |
