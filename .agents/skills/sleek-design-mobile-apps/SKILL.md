...
description: BThwani-guarded mobile design advisory skill. Does not implement screens outside approved ui-kit boundaries.
---

# Sleek Design Mobile Apps - BThwani Safe Advisory Skill
