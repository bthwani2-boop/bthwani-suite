# W03_CONTROL_PANEL_CORE

1. Wave Identity: W03_CONTROL_PANEL_CORE
2. Wave Goal: Deliver scoped bundle for W03_CONTROL_PANEL_CORE with gate-based progression.
3. Why This Wave Exists: isolate risk and enforce ordered execution by queue.
4. Included Screen Bundles: knz_service-catalog_services_knz
5. Included Operation Families: control_core_governance
