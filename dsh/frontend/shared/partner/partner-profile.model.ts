...
import type { DshPartnerRoute, PartnerHubSection } from './partner.types';

export type { PartnerRuntimeProfile } from './partner.types';
export { buildPartnerProfileFromScope } from './partner.adapters';
