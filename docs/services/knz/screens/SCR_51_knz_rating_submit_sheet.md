# Screen Contract: knz_rating_submit_sheet

1. Screen Identity: knz_rating_submit_sheet
2. Purpose: execute primary user task for knz_rating_submit_sheet within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/components/KnzRatingSubmitSheet.tsx
