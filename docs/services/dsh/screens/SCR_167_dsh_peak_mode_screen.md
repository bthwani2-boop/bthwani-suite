# Screen Contract: dsh_peak_mode_screen

1. Screen Identity: dsh_peak_mode_screen
2. Purpose: execute primary user task for dsh_peak_mode_screen within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_peak_mode_screen
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/DshPeakModeScreen.tsx
