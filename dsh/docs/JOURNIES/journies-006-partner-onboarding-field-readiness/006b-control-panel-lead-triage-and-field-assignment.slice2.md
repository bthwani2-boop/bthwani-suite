<!--
Canonical human-review path: dsh/docs/journies-006-partner-onboarding-field-readiness/006b-control-panel-lead-triage-and-field-assignment.slice2.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-006-partner-onboarding-and-field-readiness/DSH-SLICE-006B-control-panel-lead-triage-and-field-assignment.md
...
- Slice file: `dsh/docs/journies-006-partner-onboarding-field-readiness/006b-control-panel-lead-triage-and-field-assignment.slice2.md`
...
# DSH-SLICE-006B — Control Panel Lead Triage and Field Assignment
...
| Business Outcome | operator reviews lead and assigns field visit |
| Primary Actor | `operator` |
| Primary Surface / Area | `control-panel + app-field` |
...
1. يبدأ الممثل الأساسي `operator` من السطح `control-panel + app-field`.
2. الهدف العملي: operator reviews lead and assigns field visit.
...
|---|---|---|---|
| `control-panel + app-field` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-006B-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-006 — Partner Onboarding and Field Readiness
- Slice: DSH-SLICE-006B — Control Panel Lead Triage and Field Assignment
- Primary actor: operator
- Primary surface/area: control-panel + app-field
- Business outcome: operator reviews lead and assigns field visit
- SESSION_ID: DSH-SLICE-006B_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-006B_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-006B_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-006B_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
