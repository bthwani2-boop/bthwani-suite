    ...
    <BthMobileScrollView padding={4} gap={3}>
      ...
      <BthSurface tone="raised" gap={3}>
        ...
        <BthTextField
          ...
          placeholder="Optional note for preparation"
          hint="Use short, practical guidance only."
        />
      </BthSurface>
      ...
      <BthSurface tone="inset" gap={3}>
        <BthSectionHeader
          title="Action"
          subtitle="Primary CTA performs the add, secondary actions remain recovery-safe."
        />
        <BthBox gap={2}>
