# Screen Contract: dsh_partner_subscription

1. Screen Identity: dsh_partner_subscription
2. Purpose: execute primary user task for dsh_partner_subscription within dsh.
3. Actor: partner
...
8. Primary CTA: open_subscription
...
16. Dependent Operations: dsh_partner_subscription|dsh_partner_subscription_analytics_get|dsh_partner_subscription_get|dsh_partner_subscription_upgrade_post
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-partner/mobile/auto_dsh_partner_subscription.tsx
