---
name: bthwani-codebase-onboarding
description: Read-only repo orientation skill for bthwani-suite. Explains structure and facts from inspected files only.
---

# BThwani Codebase Onboarding - BThwani Safe Skill
...
- Inspect repository structure and explain only what is evidenced by files or commands.
- Trace ownership, folders, branches, and architecture boundaries.
- Mark unknowns as TBD or UNPROVEN.
- Produce concise onboarding notes with paths and evidence.

## Forbidden Use

- Do not modify files.
- Do not infer undocumented architecture as fact.
- Do not classify anything as closed without evidence.
- Do not run generators, installers, migrations, or write-capable tools.
