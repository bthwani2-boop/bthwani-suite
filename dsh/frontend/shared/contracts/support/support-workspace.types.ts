// Canonical location: dsh/frontend/shared/contracts/support/support-workspace.types.ts
// Authority: dsh/frontend/shared — moved from control-panel/support/support.types.ts
