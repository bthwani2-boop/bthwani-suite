// Auto-generated screen for wlt_hold_release
...
interface auto_wlt_hold_releaseProps {
  onNavigate?: (screen: string) => void;
  navigation?: { navigate: (screen: string) => void };
}

export const auto_wlt_hold_release: React.FC<auto_wlt_hold_releaseProps> = () => {
      ...
      <ScreenWrapper state="content">
        <View style={styles.container}>
          <Text style={[styles.title, textAlignStart]}>
            {t('surfaces.إطلاق_الحجز')}
          </Text>
          <Text style={[styles.subtitle, textAlignStart]}>
            {t('surfaces.إطلاق_المبلغ_المحجوز')}
          </Text>
          <TouchableOpacity style={styles.primaryButton}>
            <Text style={styles.primaryButtonText}>{t('surfaces.إطلاق')}</Text>
          </TouchableOpacity>
        </View>
      </ScreenWrapper>
    );
  ...
  return (
    <ScreenWrapper
      ...
      screenName="auto_wlt_hold_release"
      operationName="wlt_hold_release"
    />
  );
};
...
export default auto_wlt_hold_release;
