# Screen Contract: knz_listings_list_screen

1. Screen Identity: knz_listings_list_screen
2. Purpose: execute primary user task for knz_listings_list_screen within knz.
3. Actor: ops|admin
...
16. Dependent Operations: knz_listings_list
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/knz/KnzListingsListScreen.tsx
