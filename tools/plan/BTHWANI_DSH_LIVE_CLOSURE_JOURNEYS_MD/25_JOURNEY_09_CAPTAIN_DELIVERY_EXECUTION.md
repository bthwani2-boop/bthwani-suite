...
language: ar
title: رحلة 09 — Captain Delivery Execution
---

# رحلة 09 — تنفيذ التوصيل عبر الكابتن

## الهدف

قبول المهمة، الاستلام، الموقع، التسليم، proof of delivery.

## مالك المنطق

- captain lifecycle: `dsh/frontend/shared/captain`.
- delivery lifecycle: `dsh/frontend/shared/delivery`.
- UI فقط في app-captain.

## ممنوع

- captain local state machine.
- delivery next action داخل app-captain.
- fake location/proof كنجاح runtime.
