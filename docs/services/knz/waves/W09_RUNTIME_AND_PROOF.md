...
1. Wave Identity: W09_RUNTIME_AND_PROOF
2. Wave Goal: Deliver scoped bundle for W09_RUNTIME_AND_PROOF with gate-based progression.
3. Why This Wave Exists: isolate risk and enforce ordered execution by queue.
4. Included Screen Bundles: none
5. Included Operation Families: runtime_proof_closure
