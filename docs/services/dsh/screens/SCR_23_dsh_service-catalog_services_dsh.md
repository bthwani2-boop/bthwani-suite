# Screen Contract: dsh_service-catalog_services_dsh

1. Screen Identity: dsh_service-catalog_services_dsh
2. Purpose: execute primary user task for dsh_service-catalog_services_dsh within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /service-catalog/services/dsh
6. Entry Points: /service-catalog/services/dsh entry
...
16. Dependent Operations: dsh_service_catalog_services_dsh
...
22. Notes from donor extraction: apps/web/control-panel/app/service-catalog/services/dsh/page.tsx
