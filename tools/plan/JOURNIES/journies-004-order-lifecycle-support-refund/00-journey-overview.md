...
New canonical human-review folder: dsh/docs/journies-004-order-lifecycle-support-refund/
...
# J-004 — Order Lifecycle, Support, Cancellation, Refund
...
|---|---|
| Journey ID | `J-004` |
| Name | Order Lifecycle, Support, Cancellation, Refund |
| Type | `business` |
| Primary Actors | client, partner, captain, operator, WLT |
| Control Panel / Domain Owner | operations + finance |
| WLT Boundary | WLT owns refunds and financial reversal |
| Planning Status | `DEFERRED_UNTIL_J003_E2E_CLOSES` |
| Business Outcome | Every order state transition, support event, cancellation, refund request, and audit trail is visible in the correct surface and financially owned by WLT. |
...
|---|---|---|---|---|---|---|
| `DSH-SLICE-004A` | Client Order Tracking and Status Timeline | client | app-client + backend | client sees status timeline and ETA with no polling overload | `slices/j-004-order-lifecycle-support-cancellation-refund/DSH-SLICE-004A-client-order-tracking-and-status-timeline.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-004B` | Partner Prepare and Handoff Lifecycle | partner | app-partner + backend | partner accepts/prepares/ready-for-pickup states | `slices/j-004-order-lifecycle-support-cancellation-refund/DSH-SLICE-004B-partner-prepare-and-handoff-lifecycle.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-004C` | Control Panel Support Case and Exception Queue | operator | control-panel | operator triages exceptions and support SLA | `slices/j-004-order-lifecycle-support-cancellation-refund/DSH-SLICE-004C-control-panel-support-case-and-exception-queue.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-004D` | Cancellation Rules and State Guards | client/operator/partner | all surfaces + backend | valid/invalid cancellation by state and role | `slices/j-004-order-lifecycle-support-cancellation-refund/DSH-SLICE-004D-cancellation-rules-and-state-guards.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-004E` | Refund Request Bridge to WLT | client/operator/WLT | WLT + control-panel | refund is requested/authorized through WLT only | `slices/j-004-order-lifecycle-support-cancellation-refund/DSH-SLICE-004E-refund-request-bridge-to-wlt.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-004F` | Audit Trail and Customer/Partner/Captain Notes | operator | backend + control-panel | public/internal notes and audit logs are separated | `slices/j-004-order-lifecycle-support-cancellation-refund/DSH-SLICE-004F-audit-trail-and-customer-partner-captain-notes.md` | NOT_CLOSED_BY_THIS_FILE |
