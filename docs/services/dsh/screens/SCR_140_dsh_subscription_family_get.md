# Screen Contract: dsh_subscription_family_get

1. Screen Identity: dsh_subscription_family_get
2. Purpose: execute primary user task for dsh_subscription_family_get within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_subscription_family_get
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_subscription_family_get.tsx
