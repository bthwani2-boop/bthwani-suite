...
export const LIVE_ORDERS_PREVIEW = {
  ...
  orders: [
    { id: 'LO-1024', title: 'Order LO-1024', status: 'Ready for assignment', ownerSurface: 'dispatch-assignment', blocker: 'Captain not yet confirmed', evidence: 'Customer promised ETD 14:30', primaryActionLabel: 'Open detail', secondaryActionLabel: 'Open chat', evidenceActionLabel: 'View evidence', tone: 'warning' },
    { id: 'LO-1077', title: 'Order LO-1077', status: 'Needs proof review', ownerSurface: 'audit-support-sla', blocker: 'Photo proof still pending', evidence: 'Support note attached', primaryActionLabel: 'Open detail', secondaryActionLabel: 'Open chat', evidenceActionLabel: 'View evidence', tone: 'danger' },
    { id: 'LO-1099', title: 'Order LO-1099', status: 'Captain en route', ownerSurface: 'captain-operations', blocker: 'Dropoff window tightening', evidence: 'Route last updated 3m ago', primaryActionLabel: 'Open detail', secondaryActionLabel: 'Open chat', evidenceActionLabel: 'View evidence', tone: 'best' },
  ] as const,
  detail: [
...
export const DISPATCH_ASSIGNMENT_PREVIEW = {
  ...
  assignments: [
    { id: 'DA-2001', title: 'Assignment DA-2001', status: 'Awaiting captain', ownerSurface: 'dispatch-assignment', blocker: 'No captain accepted yet', evidence: 'Coverage window 18 min', primaryActionLabel: 'Assign captain', secondaryActionLabel: 'Reassign', evidenceActionLabel: 'View coverage', tone: 'warning' },
    { id: 'DA-2002', title: 'Assignment DA-2002', status: 'Needs reassign', ownerSurface: 'dispatch-assignment', blocker: 'First captain declined', evidence: 'Fallback captain available', primaryActionLabel: 'Assign captain', secondaryActionLabel: 'Reassign', evidenceActionLabel: 'View coverage', tone: 'danger' },
    { id: 'DA-2003', title: 'Assignment DA-2003', status: 'Peak mode candidate', ownerSurface: 'area-capacity', blocker: 'Area pressure climbing', evidence: 'Coverage window tightening', primaryActionLabel: 'Assign captain', secondaryActionLabel: 'Reassign', evidenceActionLabel: 'View coverage', tone: 'best' },
  ] as const,
  captains: [
...
export const CAPTAIN_OPERATIONS_PREVIEW = {
  ...
  captains: [
    { id: 'CP-01', title: 'Captain CP-01', status: 'Online', ownerSurface: 'dispatch-assignment', blocker: 'Assigned to order LO-1099', evidence: 'Last check-in 2m ago', primaryActionLabel: 'View profile', secondaryActionLabel: 'Reassign', evidenceActionLabel: 'View route', tone: 'best' },
    { id: 'CP-02', title: 'Captain CP-02', status: 'Needs rest', ownerSurface: 'area-capacity', blocker: 'Coverage window is tight', evidence: 'Shift length 6h 30m', primaryActionLabel: 'View profile', secondaryActionLabel: 'Reassign', evidenceActionLabel: 'View route', tone: 'warning' },
    { id: 'CP-03', title: 'Captain CP-03', status: 'Ready', ownerSurface: 'dispatch-assignment', blocker: 'Waiting for the next manual assignment', evidence: 'Standby window open', primaryActionLabel: 'View profile', secondaryActionLabel: 'Reassign', evidenceActionLabel: 'View route', tone: 'brand' },
  ],
  actions: [
...
export const PARTNER_STORES_PREVIEW = {
  ...
  stores: [
    { id: 'ST-2401', title: 'Store ST-2401', status: 'Ready', ownerSurface: 'partner-stores', blocker: 'No blocker', evidence: 'Prep checklist signed', primaryActionLabel: 'Open store', secondaryActionLabel: 'Pause store', evidenceActionLabel: 'View evidence', tone: 'best' },
    { id: 'ST-2402', title: 'Store ST-2402', status: 'Prep pressure', ownerSurface: 'partner-stores', blocker: 'Stock update pending', evidence: 'Prep window ends in 12m', primaryActionLabel: 'Open store', secondaryActionLabel: 'Pause store', evidenceActionLabel: 'View evidence', tone: 'warning' },
    { id: 'ST-2403', title: 'Store ST-2403', status: 'Intake blocker', ownerSurface: 'partner-stores', blocker: 'Needs owner approval', evidence: 'Approval request open', primaryActionLabel: 'Open store', secondaryActionLabel: 'Pause store', evidenceActionLabel: 'View evidence', tone: 'danger' },
  ],
  actions: [
...
export const AREA_CAPACITY_PREVIEW = {
  ...
  areas: [
    { id: 'AR-01', title: 'Area AR-01', status: 'High pressure', ownerSurface: 'dispatch-assignment', blocker: 'Captain supply low', evidence: 'Reserved window 14:00-15:30', primaryActionLabel: 'Open area', secondaryActionLabel: 'Shift mode', evidenceActionLabel: 'View window', tone: 'danger' },
    { id: 'AR-02', title: 'Area AR-02', status: 'Tight but stable', ownerSurface: 'captain-operations', blocker: 'Coverage about to drop', evidence: 'Window reserved for surge', primaryActionLabel: 'Open area', secondaryActionLabel: 'Shift mode', evidenceActionLabel: 'View window', tone: 'warning' },
    { id: 'AR-03', title: 'Area AR-03', status: 'Healthy', ownerSurface: 'partner-stores', blocker: 'No current blocker', evidence: 'Delivery mode balanced', primaryActionLabel: 'Open area', secondaryActionLabel: 'Shift mode', evidenceActionLabel: 'View window', tone: 'best' },
  ],
  actions: [
...
export const EXCEPTIONS_ESCALATIONS_PREVIEW = {
  ...
  exceptions: [
    { id: 'EX-4101', title: 'Exception EX-4101', status: 'Owner missing', ownerSurface: 'audit-support-sla', blocker: 'No recovery owner assigned', evidence: 'SLA timer at 31m', primaryActionLabel: 'Assign owner', secondaryActionLabel: 'Escalate', evidenceActionLabel: 'View SLA', tone: 'danger' },
    { id: 'EX-4102', title: 'Exception EX-4102', status: 'Serviceability risk', ownerSurface: 'area-capacity', blocker: 'Area pressure still high', evidence: 'Coverage gap on map', primaryActionLabel: 'Assign owner', secondaryActionLabel: 'Escalate', evidenceActionLabel: 'View SLA', tone: 'warning' },
    { id: 'EX-4103', title: 'Exception EX-4103', status: 'Recoverable', ownerSurface: 'live-orders', blocker: 'Waiting on proof confirmation', evidence: 'Recovery action queued', primaryActionLabel: 'Assign owner', secondaryActionLabel: 'Escalate', evidenceActionLabel: 'View SLA', tone: 'best' },
  ],
  actions: [
...
export const AUDIT_SUPPORT_SLA_PREVIEW = {
  ...
  audits: [
    { id: 'AU-7001', title: 'Audit AU-7001', status: 'Needs proof', ownerSurface: 'audit-support-sla', blocker: 'Receipt image missing', evidence: 'Audit trail open', primaryActionLabel: 'Open audit', secondaryActionLabel: 'Escalate', evidenceActionLabel: 'View proof', tone: 'danger' },
    { id: 'AU-7002', title: 'Audit AU-7002', status: 'Support bridge', ownerSurface: 'audit-support-sla', blocker: 'Customer reply pending', evidence: 'Bridge request created', primaryActionLabel: 'Open audit', secondaryActionLabel: 'Escalate', evidenceActionLabel: 'View proof', tone: 'warning' },
    { id: 'AU-7003', title: 'Audit AU-7003', status: 'Ready to close', ownerSurface: 'audit-support-sla', blocker: 'No blocker', evidence: 'Evidence package complete', primaryActionLabel: 'Open audit', secondaryActionLabel: 'Escalate', evidenceActionLabel: 'View proof', tone: 'best' },
  ],
  supportTickets: [
