...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| DSH-FLOW-001 | Store discovery | Customer | app-client/webapp | mapped candidates: 8 | TBD | choose store | loading/empty/error/ready/offline | FRONTEND_PRESENT_NEEDS_ROUTE_STATE_VISUAL | NEEDS_VISUAL_EVIDENCE | NEEDS_FILE_REVIEW | RUNTIME_UNPROVEN | CHECK_DSH_UI_UX_FLOW_SCREEN_MAPPING_V2-20260505-175528 | NOT_CLOSED | classify home/store discovery screens |
