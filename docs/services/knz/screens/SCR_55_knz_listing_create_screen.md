# Screen Contract: knz_listing_create_screen

1. Screen Identity: knz_listing_create_screen
2. Purpose: execute primary user task for knz_listing_create_screen within knz.
3. Actor: ops|admin
...
16. Dependent Operations: knz_listing_create
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/knz/KnzListingCreateScreen.tsx
