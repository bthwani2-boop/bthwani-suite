# Screen Contract: dsh_subscription_pro_catalog

1. Screen Identity: dsh_subscription_pro_catalog
2. Purpose: execute primary user task for dsh_subscription_pro_catalog within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_subscription_pro_catalog
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_subscription_pro_catalog.tsx
