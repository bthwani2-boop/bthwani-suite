# Screen Contract: dsh_promo_apply

1. Screen Identity: dsh_promo_apply
2. Purpose: execute primary user task for dsh_promo_apply within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_promo_apply
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_promo_apply.tsx
