...
# 09 — الرحلة 07: الطلب عبر العميل والشريك ولوحة التحكم

## الهدف

من order creation إلى partner preparation وcontrol-panel operations، مع status history موحد في كل الأسطح.

## النطاق

app-client + app-partner + control-panel + DSH backend + PostgreSQL.
...
### Slice 07.1 Order Creation

**هدف الشريحة:** إنشاء order بعد payment confirmation.
...
- افحص/ارفض: order local-only.
- افحص/ارفض: client_id من body موثوق.
- افحص/ارفض: status history غائب.
...
### Slice 07.2 Client Order Tracking

**هدف الشريحة:** عرض الطلب للعميل.
...
- افحص/ارفض: tracking preview.
- افحص/ارفض: لا empty/error.
- افحص/ارفض: stale after partner action.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
- أضف polling/refresh أو push لاحق واضح.
...
### Slice 07.3 Partner Order Intake

**هدف الشريحة:** ظهور الطلب للشريك.
...
- افحص/ارفض: partner يرى كل الطلبات.
- افحص/ارفض: button بلا API.
- افحص/ارفض: no conflict with cancellation.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
### Slice 07.4 Control Panel Operations Queue

**هدف الشريحة:** ظهور الطلب في CP.
...
- افحص/ارفض: queue static.
- افحص/ارفض: no audit.
- افحص/ارفض: operator action بلا role.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
### Slice 07.5 Status Transition Matrix

**هدف الشريحة:** اختبار الانتقالات المسموحة والمرفوضة.
...
- افحص/ارفض: backend يقبل أي status.
- افحص/ارفض: UI يسمح transition غلط.
- افحص/ارفض: لا 409.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
...
### Slice 07.6 Design and Flow Compression

**هدف الشريحة:** مراجعة الشاشات لكل سطح.
...
- افحص/ارفض: تشظي tabs.
- افحص/ارفض: CTA غير واضح.
- افحص/ارفض: timeline مزدحم.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
### Slice 07.7 Order Code Hygiene

**هدف الشريحة:** فحص order models/adapters.
...
- افحص/ارفض: models متعددة للحالة.
- افحص/ارفض: mapper مكرر.
- افحص/ارفض: dead screens.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
