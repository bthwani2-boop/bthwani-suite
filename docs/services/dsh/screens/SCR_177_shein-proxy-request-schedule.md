# Screen Contract: shein-proxy-request-schedule

1. Screen Identity: shein-proxy-request-schedule
2. Purpose: execute primary user task for shein-proxy-request-schedule within dsh.
3. Actor: ops|admin
...
8. Primary CTA: execute_schedule
...
16. Dependent Operations: dsh_shein_proxy_request_schedule
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/shein-proxy/shein-proxy-request-schedule.tsx
