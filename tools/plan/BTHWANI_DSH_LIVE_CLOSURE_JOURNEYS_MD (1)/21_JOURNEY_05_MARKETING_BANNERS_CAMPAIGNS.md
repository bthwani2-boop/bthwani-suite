...
language: ar
title: رحلة 05 — Marketing/Banners/Campaigns
---

# رحلة 05 — التسويق والبنرات والحملات

## الهدف

مركزة عقل البنرات/الكاروسيل/الحملات داخل `dsh/frontend/shared/marketing`، وإبقاء الأسطح UI فقط.

## مرجع إلزامي

اقرأ `14_MARKETING_BANNERS_CAROUSEL_CANONICALIZATION.md` قبل التنفيذ.

## مخرجات الرحلة

- `shared/marketing` يملك model/policy/mapper.
- app-client/control-panel/partner تحتوي UI renderers فقط.
- لا duplicates للـ banner/carousel logic.
- لا demo/preview/fallback banner runtime.
