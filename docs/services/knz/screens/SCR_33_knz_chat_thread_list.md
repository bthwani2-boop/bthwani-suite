# Screen Contract: knz_chat_thread_list

1. Screen Identity: knz_chat_thread_list
2. Purpose: execute primary user task for knz_chat_thread_list within knz.
3. Actor: customer
...
16. Dependent Operations: knz_chat_thread_list
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_chat_thread_list.tsx
