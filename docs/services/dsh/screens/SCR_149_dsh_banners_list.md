# Screen Contract: dsh_banners_list

1. Screen Identity: dsh_banners_list
2. Purpose: execute primary user task for dsh_banners_list within dsh.
3. Actor: shared
4. Surface: shared
...
16. Dependent Operations: dsh_banners_list
...
22. Notes from donor extraction: packages/surfaces/src/dsh/DshBannersList.tsx
