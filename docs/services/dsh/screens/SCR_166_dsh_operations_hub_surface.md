# Screen Contract: dsh_operations_hub_surface

1. Screen Identity: dsh_operations_hub_surface
2. Purpose: execute primary user task for dsh_operations_hub_surface within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_operations_hub_surface
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/DshOperationsHubSurface.tsx
