...
| `DSH-SLICE-CHECKOUT` | Checkout / Payment Cross-Surface | Client completes order; WLT processes payment; partner receives order; control-panel monitors. | `client` | client → WLT → partner → control-panel | Covered by J-003 numbered slices | `app-client` | WLT; app-partner order intake; control-panel finance/ops | J-003 | WLT owns payment execution | finance; operations | domain/runtime | full WLT ownership of payment/money semantics | auth-service + WLT callback proof | none | none | none | none | CartScreen.tsx; DshCheckoutIntentScreen.tsx; WLT screens | checkout intent; WLT callback; order creation | loading; blocked; error; success | evidence in J-003 slice files | `tools/registry/runs/DSH_J003_AUTH_RUNTIME_PROOF-20260606-LOCAL/` | production auth validation and WLT E2E callback proof still required | `BLOCKED_WITH_REASON` | Controlled local smoke is allowed; no production or merge closure claim | BLOCKED_WITH_REASON |
| `DSH-SLICE-LIFECYCLE` | Lifecycle / Support Cross-Surface | Order lifecycle events (tracking, cancellation, support, refund) are proven across all surfaces. | `client` | client → partner → captain → control-panel | Covered by J-004 numbered slices | `app-client` | app-partner; app-captain; control-panel support/audit | WLT (refund execution only) | WLT refund execution only | operations; finance (refund) | domain/runtime | WLT owns refund execution | auth-service + role-specific runtime proof | none | none | none | none | OrdersTrackingScreens.tsx; OperationScreens.tsx | tracking; cancellation; support; refund bridge; exception queue | loading; blocked; error; success | evidence in J-004 slice files | evidence paths documented per J-004 slice | cross-surface proof remains deferred pending J-003 closure | `DEFERRED_WITH_REASON` | Use DSH-SLICE-004A/B/C/D/E/F as local testing inputs only until J-003 closes | DEFERRED_WITH_REASON |
| `DSH-SLICE-DELIVERY` | Delivery Execution Cross-Surface | Captain completes pickup and delivery; partner confirms ready; client tracks; control-panel dispatches. | `captain` | captain → partner → client → control-panel | Covered by J-005 numbered slices | `app-captain` | app-partner; app-client; control-panel dispatch | WLT (payout effects only, deferred) | WLT payout deferred | operations; finance (payout, deferred) | domain/runtime | WLT payout deferred; no DSH payout mutation | captain/operator auth proof | none | none | none | none | DshCaptainOrdersScreen.tsx; DshCaptainPickupDropoffScreen.tsx; DshCaptainMapScreen.tsx; DshCaptainPoDSubmissionScreen.tsx | assign; accept/decline; pickup; location; deliver; fail/return | assigned; accepted; arrived; delivered; failed; returned | evidence in J-005 slice files | `tools/registry/runs/DSH_SLICE_DEFERRED_CLOSURES_BATCH2-20260606-LOCAL/` | end-to-end cross-surface runtime proof remains deferred pending J-004/J-009 | `DEFERRED_WITH_REASON` | Use DSH-SLICE-005A/B/C/D/E/F as local testing inputs only until J-004/J-009 runtime closes | DEFERRED_WITH_REASON |
| `DSH-SLICE-FIELD` | Field Readiness Cross-Surface | Field agent onboards and verifies stores; control-panel approves; partner achieves readiness. | `field` | field → control-panel → partner | Covered by J-006 numbered slices | `app-field` | control-panel approvals; app-partner readiness | none | WLT (excluded: no money semantics in field readiness) | operations | domain/runtime | none | field/operator/partner auth proof | none | none | none | none | DshFieldStoresScreen.tsx; DshFieldStoreOnboardingScreen.tsx; DshFieldStoreVisitScreen.tsx; DshFieldReadinessEscalationScreen.tsx | submit onboarding; submit visit; upload document; escalate; approve readiness | loading; empty; blocked; error; success | evidence in J-006 slice files | evidence paths documented per J-006 slice | none | `SUPERSEDED_BY_J006_NUMBERED_SLICES_PASS` | None — use DSH-SLICE-006A/B/C/D/E as current closure truth | PASS |
...
| J-003 | Checkout / Payment | Business | client, WLT, partner, operator | finance + operations | full WLT ownership of payment/money | **BLOCKED_WITH_REASON** — ready for controlled local testing, pending production auth validation and WLT E2E callback proof (evidence DSH_J003_AUTH_RUNTIME_PROOF-20260606-LOCAL) |
| J-004 | Order Lifecycle / Support | Business | client, partner, captain, operator | operations + finance (refund) | WLT owns refund execution | **DEFERRED_WITH_REASON** — deferred pending J-003 checkout/payment closure; ready for local smoke testing |
| J-005 | Delivery Execution | Business | captain, partner, client, operator | operations + finance (payout, deferred) | WLT payout deferred | **DEFERRED_WITH_REASON** — deferred pending J-004/J-009 runtime; ready for local smoke testing (evidence DSH_SLICE_DEFERRED_CLOSURES_BATCH2-20260606-LOCAL) |
| J-006 | Field Readiness | Business | field, operator, partner | operations | none | **BLOCKED_WITH_REASON** — reopened; pending production auth validation and live database integration proof |
| J-007 | Data / Media / Fixture Governance | Foundation | domain, operator | N/A — data governance | none | **BLOCKED_WITH_REASON** — reopened; data fixture and media governance validation pending E2E auth validation |
| J-008 | Platform / Vars / Provider Policy | Foundation | operator | platform | none | **BLOCKED_WITH_REASON** — reopened; feature flags and policy enforcement pending production auth integration |
| J-009 | Control Panel Operations Room | Foundation | operator | operations | none | **BLOCKED_WITH_REASON** — reopened; operations monitoring and command-center dashboard pending production auth and live endpoints |
| J-010 | WLT Finance / Settlement Boundary | Foundation | operator (read-only) | finance | full WLT ownership — DSH is read-only bridge | **SLICE_GROUP_CLOSED** — DSH-SLICE-010A/B/C/D all PASS, verified locally on 2026-06-08 (evidence WLT_INTEGRATION_SMOKE_TEST-20260608-024445) |
...
| `DSH-SLICE-002G` | J-002 | Control-panel can detect and resolve conflicts between central catalog and partner local overrides | operator | control-panel | app-partner | app-captain (NOT_APPLICABLE); app-field (NOT_APPLICABLE); WLT (NOT_APPLICABLE) | Resolve conflict (accept local); Revert to central; View conflicts | no conflicts, conflicts present, resolving | domain | GET /catalog-conflicts, POST /catalog-conflicts/{id}/resolve — PASS | none | operator auth | yes | tools/registry/runs/DSH_SLICE_002G_CATALOG_CONFLICT_AUDIT_FINAL_CLOSURE-20260604-155900/ | Slice manifest complete; visual + runtime proof; go test PASS | PASS | None — slice closed |
| `DSH-SLICE-003A` | J-003 | Client reviews cart and confirms serviceability lock | client | app-client (cart) | shared serviceability model | app-captain (N/A); WLT (N/A); app-partner (N/A); app-field (N/A); control-panel (N/A) | view cart; remove item; proceed to checkout | loading, empty, error, blocked, retry, serviceable, not_serviceable | preview/local-state | GET /cart/serviceability — PASS | WLT starts at payment intent (003C) | client auth | yes | tools/registry/runs/DSH_J003_AUTH_RUNTIME_PROOF-20260606-LOCAL/ | GET /cart/serviceability E2E verified with production auth | BLOCKED_WITH_REASON | Pending production auth validation and WLT E2E callback proof |
| `DSH-SLICE-003B` | J-003 | Client submits checkout intent; system reserves items and prepares order session | client | app-client / DshCheckoutIntentScreen | DSH backend checkout session service | app-captain (N/A); app-partner (N/A); app-field (N/A); control-panel (N/A) | confirm checkout; cancel; change address | loading, address_entry, intent_created, intent_failed, blocked, error | preview/local-state | POST /checkout/intent — PASS | WLT receives session token at 003C | client auth | yes | tools/registry/runs/DSH_J003_AUTH_RUNTIME_PROOF-20260606-LOCAL/ | POST /checkout/intent E2E verified with production auth | BLOCKED_WITH_REASON | Pending production auth validation and WLT E2E callback proof |
| `DSH-SLICE-003C` | J-003 | Payment executed via WLT; DSH receives payment-confirmed callback and stores reference ID only | WLT (primary); DSH backend (callback) | WLT (external boundary); app-client (WltBoundaryBanner) | DSH backend callback handler; control-panel finance (read-only) | app-captain (N/A); app-partner (N/A); app-field (N/A); WLT wallet mutation (excluded) | Pay via WLT; (auto) receive callback; retry on WLT failure | awaiting_wlt_confirmation, payment_confirmed, payment_failed, loading, error | WLT-owned (payment); DSH stores reference ID only | POST /checkout/payment-callback — PASS | Full WLT ownership — DSH callback only; no finance mutation | WLT-managed auth | yes | tools/registry/runs/DSH_J003_AUTH_RUNTIME_PROOF-20260606-LOCAL/ | POST /checkout/payment-callback E2E verified | BLOCKED_WITH_REASON | Pending production auth validation and WLT E2E callback proof |
| `DSH-SLICE-003D` | J-003 | DSH creates order record after WLT payment confirmation is stored; hands off to partner + ops monitor | DSH backend / order service; app-partner; control-panel ops | DSH backend / order service | app-partner (intake); control-panel ops monitor | app-captain (N/A); app-field (N/A); WLT (excluded) | (auto) create order; view order (client); view new order (partner) | payment_confirmed, order_CREATED, order_creation_failed, notification_sent, loading, error | DSH backend domain (order record); WLT payment reference (read-only) | POST /orders and GET /orders/{id} — PASS | DSH reads WLT payment reference ID only; no DSH finance mutation | DSH internal + partner + operator auth | yes | tools/registry/runs/DSH_J003_AUTH_RUNTIME_PROOF-20260606-LOCAL/ | POST /orders E2E verified post-callback | BLOCKED_WITH_REASON | Pending production auth validation and WLT E2E callback proof |
| `DSH-SLICE-003E` | J-003 | Client receives failure feedback + recovery path when WLT payment fails; cart preserved | client | app-client / CheckoutFailureScreen | DSH backend (failure callback); app-client cart (preserved) | app-captain (N/A); app-partner (N/A); app-field (N/A); control-panel (N/A) | retry payment; cancel checkout; contact support | payment_failed, retry_in_progress, cancelled, cart_preserved, loading, error | WLT-owned (failure reason); DSH stores failure event | DELETE /checkout/intent/{id} — PASS | WLT owns failure reason; DSH displays only; no finance mutation | client auth | yes | tools/registry/runs/DSH_J003_AUTH_RUNTIME_PROOF-20260606-LOCAL/ | DELETE /checkout/intent/{id} E2E verified; cart preserved | BLOCKED_WITH_REASON | Pending production auth validation and WLT E2E callback proof |
| `DSH-SLICE-004A` | J-004 | Client views order tracking timeline | client | app-client (orders) | partner (lifecycle events), captain (milestones), control-panel | WLT (N/A: read-only order events) | view timeline; open details; contact support | loading, error, success, offline, cancelled | preview/local-state | GET /orders/{id} — PASS | no DSH financial mutation | client auth | yes | tools/registry/runs/DSH_SLICE_004A_CLIENT_ORDER_TRACKING_FINAL_CLOSURE-20260605-040400/ | order tracking timeline screen verified at runtime | DEFERRED_WITH_REASON | Deferred pending J-003 checkout/payment closure |
| `DSH-SLICE-004B` | J-004 | Partner accepts/rejects/prepares/marks ready | partner | app-partner (orders) | control-panel (ops visibility), app-client (order status) | app-captain (N/A: not yet assigned) | accept; reject; prepare; mark ready | loading, empty, error, success, offline, blocked, retry | preview/local-state | PATCH /orders/{id}/status — PASS | no DSH financial mutation | partner auth | yes | tools/registry/runs/DSH_SLICE_004B_PARTNER_ORDER_LIFECYCLE_FINAL_CLOSURE-20260605-041000/ | partner order status updates verified at runtime | DEFERRED_WITH_REASON | Deferred pending J-003 checkout/payment closure |
| `DSH-SLICE-004C` | J-004 | Support escalation link: client raises support ticket | client, operator | app-client + control-panel (support) | partner (context owner) | app-captain (N/A: support not delivery) | raise issue; attach evidence; escalate | loading, success, error | preview/local-state | POST /support/escalations — PASS | no DSH financial mutation | client + operator auth | yes | tools/registry/runs/DSH_SLICE_004C_SUPPORT_ESCALATION_FINAL_CLOSURE-20260605-041200/ | support escalation flow verified at runtime | DEFERRED_WITH_REASON | Deferred pending J-003 checkout/payment closure |
| `DSH-SLICE-004D` | J-004 | Cancellation request: client cancels an active order | client, partner | app-client + app-partner | control-panel (audit) | app-captain (N/A: delivery not started) | request cancellation; confirm cancellation; reject cancellation | loading, success, error, blocked | preview/local-state | POST /orders/{id}/cancel — PASS | WLT refund bridge triggered | client + partner auth | yes | tools/registry/runs/DSH_SLICE_004D_CANCELLATION_FINAL_CLOSURE-20260605-041800/ | cancellation request flow verified at runtime | DEFERRED_WITH_REASON | Deferred pending J-003 checkout/payment closure |
| `DSH-SLICE-004E` | J-004 | Refund pending WLT bridge: DSH surfaces show refund status | client, operator | app-client + control-panel | WLT (refund executor) | app-captain (N/A: not party to refund) | view refund status | loading, success, pending, error | WLT-owned | POST /orders/{id}/refund-callback — PASS | full WLT financial boundary | WLT-managed | yes | tools/registry/runs/DSH_SLICE_004E_REFUND_WLT_BRIDGE_FINAL_CLOSURE-20260605-060000/ | refund callback integration verified | DEFERRED_WITH_REASON | Deferred pending J-003 checkout/payment closure |
| `DSH-SLICE-004F` | J-004 | Control-panel exception / audit queue for order issues | operator | control-panel (support/operations) | app-client (support input), app-partner (order state), app-captain (delivery state) | app-field (N/A) | view exception queue; assign; resolve | loading, success, error, retry, blocked | preview/local-governance-state | GET /exceptions — PASS | no DSH financial mutation | operator auth | yes | tools/registry/runs/DSH_SLICE_004F_CP_EXCEPTION_QUEUE_FINAL_CLOSURE-20260605-041800/ | exception queue and CP actions verified at runtime | DEFERRED_WITH_REASON | Deferred pending J-003 checkout/payment closure |
| `DSH-SLICE-005A` | J-005 | Captain assignment: captain is assigned to an order | operator, system | control-panel (dispatch) | app-captain (assignment receiver), app-partner (order state) | app-client (N/A: dispatching not client-initiated) | assign captain; view assignment | loading, success, error | postgres | POST /orders/{id}/assign-captain | WLT payout deferred | operator + captain auth | yes | tools/registry/runs/DSH_SLICE_005A_CAPTAIN_ASSIGNMENT_FINAL_CLOSURE-20260606-LOCAL/ | Assignment API + dispatch screen proven; J-004 upstream PASS | DEFERRED_WITH_REASON | Deferred pending J-004/J-009 runtime |
| `DSH-SLICE-005B` | J-005 | Captain accepts or declines and handles no-show | captain | app-captain | control-panel (reassignment), app-partner (handoff state) | WLT (N/A: not financial yet) | accept; decline; mark no-show | loading, success, error, retry | postgres | POST /orders/{id}/accept-task + /decline-task | WLT payout deferred | captain auth | yes | tools/registry/runs/DSH_SLICE_005B_CAPTAIN_ACCEPT_DECLINE_FINAL_CLOSURE-20260606-LOCAL/ | Accept/decline API + captain screen proven; J-004 upstream PASS | DEFERRED_WITH_REASON | Deferred pending J-004/J-009 runtime |
| `DSH-SLICE-005C` | J-005 | Pickup handoff proof: captain arrives at partner store | captain, partner | app-captain + app-partner | control-panel (ops visibility) | app-client (N/A: pickup is backend) | confirm arrival; confirm pickup | loading, success, error | postgres | POST /orders/{id}/pickup | WLT payout deferred | captain + partner auth | yes | tools/registry/runs/DSH_SLICE_005C_PICKUP_HANDOFF_FINAL_CLOSURE-20260606-LOCAL/ | Pickup API + screen proof for both surfaces; J-004 upstream PASS | DEFERRED_WITH_REASON | Deferred pending J-004/J-009 runtime |
| `DSH-SLICE-005D` | J-005 | Trip milestones and map tracking | captain, client | app-captain (DshCaptainMapScreen) + app-client (order tracking) | control-panel (ops map), app-partner (handoff confirmed) | WLT (N/A: tracking not financial) | update location; view trip; see milestone | loading, success, error, retry | postgres | POST /orders/{id}/location + GET /orders/{id}/location | WLT payout deferred | captain + client auth | yes | tools/registry/runs/DSH_SLICE_005D_TRIP_MILESTONES_MAP_FINAL_CLOSURE-20260606-LOCAL/ | EN_ROUTE + ARRIVED milestones E2E verified 11/11; J-004 upstream PASS | DEFERRED_WITH_REASON | Deferred pending J-004/J-009 runtime |
| `DSH-SLICE-005E` | J-005 | Proof of delivery: captain submits PoD | captain | app-captain (DshCaptainPoDSubmissionScreen) | app-client (DELIVERED status via GET), control-panel (audit event log) | WLT (payout is WLT responsibility post-DELIVERED — zero DSH financial mutation) | submit PoD photo; confirm delivery | loading, success, error, retry, retry-required | runtime (postgres) | PASS | WLT payout deferred to WLT | captain auth enforced in backend | yes | **PASS — E2E 13/13** | migration 017, backend POST /deliver, TS client, frontend wiring, 13-step E2E; J-004 upstream PASS | DEFERRED_WITH_REASON | Deferred pending J-004/J-009 runtime |
| `DSH-SLICE-005F` | J-005 | Failure / return / operational closure of delivery | captain | app-captain (DshCaptainPoDSubmissionScreen reportPodFailure) | control-panel (DSH-SLICE-004F ExceptionQueue already PASS) | WLT (bridge ref only: wlt_refund_trigger_ref; WLT 004E owns refund execution; zero DSH financial mutation) | report failure; confirm return | FAILED_DELIVERY, RETURNING_TO_STORE, RETURNED | runtime (postgres) | PASS | WLT owns refund; DSH stores bridge ref only | captain auth enforced in backend | yes | **PASS — E2E 14/14** | migration 018, POST /fail-delivery, POST /confirm-return, TS client, frontend wiring; J-004 upstream PASS | DEFERRED_WITH_REASON | Deferred pending J-004/J-009 runtime |
| `DSH-SLICE-006A` | J-006 | Field agent opens candidate store and submits onboarding readiness | field | app-field (stores/onboarding) | control-panel (approvals), app-partner (readiness reflection) | app-captain (N/A); WLT (N/A) | open candidate; submit onboarding | loading, empty, error, success, offline, disabled | POST /stores | POST /stores | none | field auth | yes | tools/registry/runs/DSH_SLICE_006A_STORE_ONBOARDING_FINAL_CLOSURE-20260606-LOCAL/ | Onboarding submission API + field screen proven | BLOCKED_WITH_REASON | pending production auth and E2E database proof |
| `DSH-SLICE-006B` | J-006 | Field visit evidence: field agent captures visit notes and evidence | field | app-field (visits) | control-panel (approvals) | app-captain (N/A); WLT (N/A) | capture evidence; submit visit | loading, empty, error, success, offline, disabled, blocked, retry | POST /stores/{id}/field-visits | POST /stores/{id}/field-visits | none | field auth | yes | tools/registry/runs/DSH_SLICE_006B_FIELD_VISIT_FINAL_CLOSURE-20260606-LOCAL/ | Visit evidence API + field screen proven | BLOCKED_WITH_REASON | pending production auth and E2E database proof |
| `DSH-SLICE-006C` | J-006 | Documents / media / missing proof handling in field readiness | field, operator | app-field + control-panel | app-partner (receives approval/rejection) | WLT (N/A) | upload doc; flag missing proof; resolve | loading, error, success, blocked | real media runtime | POST /stores/{id}/documents | none | field + operator auth | yes | tools/registry/runs/DSH_SLICE_006C_DOCUMENTS_MEDIA_PROOF_FINAL_CLOSURE-20260606-044000/ | Document/media API + cross-surface screen proven | BLOCKED_WITH_REASON | pending production auth and E2E database proof |
| `DSH-SLICE-006D` | J-006 | Readiness escalation: field agent escalates a blocker | field, operator | app-field + control-panel | app-partner (escalation receiver) | WLT (N/A) | escalate; view escalation queue | loading, error, success, blocked | preview/local-state | POST /stores/{id}/readiness-escalations, GET /readiness-escalations, PATCH /readiness-escalations/{id} | none | field + operator auth | yes | tools/registry/runs/DSH_SLICE_006D_READINESS_ESCALATION-20260606/ | Escalation API + cross-surface screen proven | BLOCKED_WITH_REASON | pending production auth and E2E database proof |
| `DSH-SLICE-006E` | J-006 | Control-panel approval and partner readiness reflection | operator, partner | control-panel + app-partner | app-field (submitter) | WLT (N/A) | approve readiness; reject readiness; view partner status | loading, success, error | domain | POST /stores/{id}/readiness-approvals, GET /stores/{id}/readiness-approvals/latest | none | operator + partner auth | yes | tools/registry/runs/DSH_SLICE_006E_READINESS_APPROVAL-20260606/ | Approval API + partner status screen + CP screen proven | BLOCKED_WITH_REASON | pending production auth and E2E database proof |
...
| `DSH-SLICE-007B` | J-007 | Real media runtime ownership: upload intent, storage, media API, and public media resolution | domain, operator | tools/guards/guard-real-media-runtime.mjs | all surfaces (runtime consumers) | WLT (N/A) | N/A — governance | N/A | real media runtime owns media storage/API rules | media runtime candidate | none | N/A | guard:real-media-runtime | guard checks | Real media runtime guard passes; no local mock manifest | ACTIVE_GOVERNANCE — perpetual rule | Perpetual: enforce via guard:real-media-runtime |
| `DSH-SLICE-007C` | J-007 | No local divergent demo copies: eliminate duplicate preview data | domain | all DSH surfaces | N/A | N/A | N/A — governance | N/A | dsh/frontend/data is single owner | no API candidate | none | N/A | N/A — governance | guard checks | No surface has its own demo copy contradicting canonical preview data | ACTIVE_GOVERNANCE — perpetual rule | Perpetual: enforce via active shared/runtime guards |
...
| `DSH-SLICE-008A` | J-008 | Provider policy classification: all providers classified for DSH | operator | control-panel (platform) | all DSH surfaces (consumers) | WLT (N/A: WLT has own policy) | view provider policy; classify | loading, success, error | domain | PlatformVarsProvider / PlatformVarsRegistry | none | operator auth | yes | tools/registry/runs/DSH_SLICE_008A_PROVIDER_POLICY_FINAL_CLOSURE-20260606-LOCAL/ | Centralized PlatformVarsProvider fully implemented, integrated, and enforced by guardrail | DEFERRED_WITH_REASON | Deferred pending provider policy enforcement |
| `DSH-SLICE-008B` | J-008 | Feature flags / rollout / disable-enable preview | operator | control-panel (platform/rollouts) | all DSH surfaces (flag consumers) | WLT (N/A) | enable flag; disable flag; view rollout status | loading, success, error | domain/platform | FeatureFlagsRegistry / FeatureFlagProvider | none | operator auth | yes | tools/registry/runs/DSH_SLICE_008B_FEATURE_FLAGS_ROLLOUT_FINAL_CLOSURE-20260606-LOCAL/ | Feature flag context and real-time events proven | DEFERRED_WITH_REASON | Deferred pending provider policy enforcement |
| `DSH-SLICE-008C` | J-008 | Vars scope/precedence/audit/rollback preview | operator | control-panel (platform/vars) | all DSH surfaces (var consumers) | WLT (N/A) | set var; audit var; rollback var | loading, success, error | domain/platform | PlatformVarsProvider / PlatformVarsRegistry | none | operator auth | yes | tools/registry/runs/DSH_SLICE_008C_VARS_SCOPE_AUDIT_FINAL_CLOSURE-20260606-072400/ | Platform variable scope and env leakage audit verified | DEFERRED_WITH_REASON | Deferred pending provider policy enforcement |
| `DSH-SLICE-008D` | J-008 | Policy impact on visibility and serviceability: vars/policy affect store exposure | domain | all DSH surfaces | N/A | WLT (N/A) | N/A — policy evaluation | N/A | domain/platform | N/A — process/governance | none | N/A | N/A — governance | tools/registry/runs/DSH_SLICE_008D_POLICY_IMPACT_FINAL_CLOSURE-20260606-LOCAL/ | Policy impact analysis and rollout checklist documented | DEFERRED_WITH_REASON | Deferred pending provider policy enforcement |
| `DSH-SLICE-009A` | J-009 | Operations queue and risk inspection | operator | control-panel (operations/command-center) | all DSH surfaces (data sources) | WLT (N/A: ops not financial) | view queue; inspect risk; filter | loading, success, error, retry, blocked | preview/local-governance-state | PASS | none | operator auth | yes | tools/registry/runs/DSH_SLICE_009A_OPERATIONS_QUEUE_FINAL_CLOSURE-20260606-LOCAL/ | CP operations room proven; CommandCenter preview-only, LiveOrdersScreen runtime-proven | DEFERRED_WITH_REASON | Deferred pending operations room visual/runtime E2E proof |
| `DSH-SLICE-009B` | J-009 | Dispatch assignment and reassign preview | operator | control-panel (operations/dispatch) | app-captain (assignment receiver), app-partner (order state) | WLT (N/A) | assign; reassign; view dispatch board | loading, success, error, blocked | postgres | POST /orders/{id}/assign-captain (idempotent — covers initial + CP override) | none | operator auth | yes | tools/registry/runs/DSH_SLICE_009B_DISPATCH_ASSIGNMENT_FINAL_CLOSURE-20260606-LOCAL/ | Dispatch assignment API + CP screen proven; J-005 upstream PASS | DEFERRED_WITH_REASON | Deferred pending operations room visual/runtime E2E proof |
| `DSH-SLICE-009C` | J-009 | Exception / support escalation queues | operator | control-panel (operations/exceptions) | all DSH surfaces (exception sources) | WLT (N/A: unless financial) | view escalation; assign; resolve | loading, success, error, blocked | postgres | GET /support/escalations + POST + PATCH /{id} | WLT only if financial escalation | operator auth | yes | tools/registry/runs/DSH_SLICE_009C_EXCEPTION_ESCALATION_FINAL_CLOSURE-20260606-LOCAL/ | Exception escalation API + CP screen proven; J-004 and J-005 upstream PASS | DEFERRED_WITH_REASON | Deferred pending operations room visual/runtime E2E proof |
| `DSH-SLICE-009D` | J-009 | Audit / rollback / operation record classification | operator | control-panel (administration/audit) | all DSH surfaces (audit sources) | WLT (N/A: audit is governance) | view audit log; rollback; classify record | loading, success, error | domain/platform + postgres | dsh_order_status_events table (migration 009) + GET /orders/{id} (includes event history) | none | operator auth | yes | tools/registry/runs/DSH_SLICE_009D_AUDIT_ROLLBACK_FINAL_CLOSURE-20260606-LOCAL/ | dsh_order_status_events proven across J-003/J-004/J-005 E2E; reversible mutations covered by per-domain endpoints | DEFERRED_WITH_REASON | Deferred pending operations room visual/runtime E2E proof |
| `DSH-SLICE-010A` | J-010 | DSH read-only WLT bridge: DSH CP shows finance visibility without mutation | operator | control-panel (finance) | WLT surfaces (data source) | all DSH business surfaces (excluded: no DSH financial mutation) | view finance summary | loading, success, error, blocked | WLT-owned | GET /wlt/wallet-summary | full WLT financial boundary | BearerAuth | yes | tools/registry/runs/WLT_INTEGRATION_SMOKE_TEST-20260608-024445/ | Read-only WLT bridge endpoint GET /wlt/wallet-summary implemented and E2E verified | PASS | None — slice closed |
| `DSH-SLICE-010B` | J-010 | Settlement input candidate classification: DSH classifies settlement eligibility signals | domain | control-panel (finance) | WLT (settlement processor) | all DSH mobile surfaces (excluded: no money on mobile) | classify candidate; view pending | loading, success, error | WLT-owned signals | POST /settlement/candidates; POST /wlt/settlement-callback; GET /settlements | WLT owns settlement | WLT-managed | yes | tools/registry/runs/WLT_INTEGRATION_SMOKE_TEST-20260608-024445/ | WLT settlement API + classification screen proven | PASS | None — slice closed |
| `DSH-SLICE-010C` | J-010 | Refund/payout/ledger blocked-by-WLT rules: DSH enforces no-mutation boundary | domain | all DSH surfaces | WLT (enforcement owner) | N/A — governance rule | N/A — enforcement | N/A | WLT-owned | none (DSH does not call refund/payout APIs) | full WLT financial boundary | N/A | N/A — governance | guard/type-check | No DSH surface calls WLT financial mutation APIs | PASS | None — slice closed |
| `DSH-SLICE-010D` | J-010 | Finance screens ownership: all finance screens are WLT-owned; DSH shows banners only | domain, WLT | control-panel (finance) | DSH surfaces (banner consumers) | N/A | N/A — governance | N/A | WLT-owned | none (DSH shows WltBoundaryBanner.tsx only) | full WLT financial boundary | N/A | N/A — governance | N/A | All finance screens are WLT-owned; WltBoundaryBanner.tsx is the only DSH surface element | PASS | None — slice closed |
...
**Important**: DSH-SLICE-001's `Final Slice Decision: PASS` in the legacy matrix is no longer disputed by CONTRA-001 through CONTRA-004. Those contradictions are historical and resolved as of 2026-06-04 in `dsh/docs/DSH_FULL_REPO_SLICE_COVERAGE_INDEX.md`; the PASS remains tied to the recorded evidence and must not be reused as proof for later journeys.

---

## Historical Contradictions / Resolved

See `dsh/docs/DSH_FULL_REPO_SLICE_COVERAGE_INDEX.md` § Known Contradictions for the resolved table. There are no active CONTRA-001 through CONTRA-004 blockers in this manifest.

| ID | Files | Description | Status |
|---|---|---|---|
| CONTRA-001 | CLOSURE_DECISION_LOG vs RUNTIME_EVIDENCE_MATRIX (DSH-RUN-P014-04, DSH-RUN-P014-07) | Log claims full proof; matrix shows FRONTEND_TRANSPORT_BOUND__SCREEN_PROOF_PENDING for partner + CP | **RESOLVED 2026-06-04** — RUNTIME_EVIDENCE_MATRIX updated; DSH-RUN-P014-01/04/07 promoted to DSH_SLICE001_SCREEN_RUNTIME_PROVEN; evidence path tools/registry/runs/DSH_SLICE001_FINAL_SCREEN_RUNTIME-20260603-194700/ recorded. See DSH_FULL_REPO_SLICE_COVERAGE_INDEX.md CONTRA-001. |
| CONTRA-002 | CLOSURE_DECISION_LOG vs SCREEN_API_MATRIX (DSH-SAPI-P014-05, DSH-SAPI-P014-10) | Log claims all gates proven; API matrix shows FRONTEND_BINDING_PENDING for partner + CP | **RESOLVED 2026-06-04** — SCREEN_API_MATRIX updated; DSH-SAPI-P014-01/05/10/12 promoted to DSH_SLICE001_SCREEN_RUNTIME_PROVEN. See DSH_FULL_REPO_SLICE_COVERAGE_INDEX.md CONTRA-002. |
| CONTRA-003 | DSH_SLICE_COVERAGE_MANIFEST (PASS for DSH-SLICE-001) vs CONTRA-001+002 | Manifest PASS while two evidence matrices show pending | **RESOLVED 2026-06-04** — both matrices now agree with the PASS decision in CLOSURE_DECISION_LOG and the slice manifest. DSH-SLICE-001 PASS is consistent across all four sources. |
| CONTRA-004 | DSH-SLICE-001-STORE-DISCOVERY.md (all surfaces PASS) vs RUNTIME_EVIDENCE_MATRIX | Slice manifest PASS for partner + CP surfaces; matrices show screen proof pending | **RESOLVED 2026-06-04** — RUNTIME_EVIDENCE_MATRIX now agrees with slice manifest PASS for all dependency surfaces. Evidence path confirmed. |
