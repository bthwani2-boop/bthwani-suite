      ...
      content={
        <BthBox gap={3}>
          ...
          <BthSurface tone="raised" gap={2}>
            {[{ title: 'Zone selection', subtitle: 'Let the client confirm the service territory explicitly.', meta: 'Zone', badgeLabel: 'Area' }, { title: 'Discovery continuity', subtitle: 'Return to home or stores-list with the selected zone preserved.', meta: 'Flow', badgeLabel: 'Next' }].map((item) => (
