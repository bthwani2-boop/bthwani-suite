# Screen Contract: knz_promotion_sheet

1. Screen Identity: knz_promotion_sheet
2. Purpose: execute primary user task for knz_promotion_sheet within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/components/KnzPromotionSheet.tsx
