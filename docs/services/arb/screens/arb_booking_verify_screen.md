# Screen Contract - arb_booking_verify_screen

1. Screen Identity: SCR_10
2. Purpose: Operational ARB workflow surface.
3. Actor: partner
4. Surface: app-partner
5. Canonical Route: /partner/arb/booking/verify/screen
...
16. Dependent Operations: arb_booking_verify
...
19. Files To Create / Files To Touch: packages/surfaces/src/arb/arb_booking_verify_screen.tsx
20. Acceptance Gate: gate_a_b_c_passed
21. Deferred Items: W08 binding and W09 runtime proof-only closure.
22. Notes from donor extraction: services/arb/governance/operations/arb_booking_verify/OP_SCREENS_MAP.csv
