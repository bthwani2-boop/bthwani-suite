# Screen Contract: knz_chat_message_send

1. Screen Identity: knz_chat_message_send
2. Purpose: execute primary user task for knz_chat_message_send within knz.
3. Actor: customer
...
16. Dependent Operations: knz_chat_message_send
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_chat_message_send.tsx
