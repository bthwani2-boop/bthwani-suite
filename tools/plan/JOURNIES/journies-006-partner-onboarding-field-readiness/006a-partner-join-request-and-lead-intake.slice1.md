<!--
Canonical human-review path: dsh/docs/journies-006-partner-onboarding-field-readiness/006a-partner-join-request-and-lead-intake.slice1.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-006-partner-onboarding-and-field-readiness/DSH-SLICE-006A-partner-join-request-and-lead-intake.md
...
- Slice file: `dsh/docs/journies-006-partner-onboarding-field-readiness/006a-partner-join-request-and-lead-intake.slice1.md`
...
# DSH-SLICE-006A — Partner Join Request and Lead Intake
...
| Business Outcome | partner submits join/onboarding request |
| Primary Actor | `partner` |
| Primary Surface / Area | `app-partner/web/control-panel` |
...
1. يبدأ الممثل الأساسي `partner` من السطح `app-partner/web/control-panel`.
2. الهدف العملي: partner submits join/onboarding request.
...
|---|---|---|---|
| `app-partner/web/control-panel` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-006A-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-006 — Partner Onboarding and Field Readiness
- Slice: DSH-SLICE-006A — Partner Join Request and Lead Intake
- Primary actor: partner
- Primary surface/area: app-partner/web/control-panel
- Business outcome: partner submits join/onboarding request
- SESSION_ID: DSH-SLICE-006A_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-006A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-006A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-006A_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
