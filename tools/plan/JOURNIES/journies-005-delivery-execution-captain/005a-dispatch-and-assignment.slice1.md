<!--
Canonical human-review path: dsh/docs/journies-005-delivery-execution-captain/005a-dispatch-and-assignment.slice1.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-005-delivery-execution-and-captain-operations/DSH-SLICE-005A-dispatch-and-assignment.md
...
- Slice file: `dsh/docs/journies-005-delivery-execution-captain/005a-dispatch-and-assignment.slice1.md`
...
# DSH-SLICE-005A — Dispatch and Assignment
...
| Business Outcome | operator/system assigns captain |
| Primary Actor | `operator/captain` |
| Primary Surface / Area | `control-panel + app-captain + backend` |
...
1. يبدأ الممثل الأساسي `operator/captain` من السطح `control-panel + app-captain + backend`.
2. الهدف العملي: operator/system assigns captain.
...
|---|---|---|---|
| `control-panel + app-captain + backend` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-005A-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-005 — Delivery Execution and Captain Operations
- Slice: DSH-SLICE-005A — Dispatch and Assignment
- Primary actor: operator/captain
- Primary surface/area: control-panel + app-captain + backend
- Business outcome: operator/system assigns captain
- SESSION_ID: DSH-SLICE-005A_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-005A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-005A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-005A_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
