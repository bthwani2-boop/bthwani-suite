# Screen Contract: dsh_zone_set

1. Screen Identity: dsh_zone_set
2. Purpose: execute primary user task for dsh_zone_set within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_zone_set
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_zone_set.tsx
