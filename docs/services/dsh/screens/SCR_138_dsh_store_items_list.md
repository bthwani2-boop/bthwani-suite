# Screen Contract: dsh_store_items_list

1. Screen Identity: dsh_store_items_list
2. Purpose: execute primary user task for dsh_store_items_list within dsh.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_store_items_list.tsx
