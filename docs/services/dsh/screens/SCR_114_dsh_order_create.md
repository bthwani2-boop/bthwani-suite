# Screen Contract: dsh_order_create

1. Screen Identity: dsh_order_create
2. Purpose: execute primary user task for dsh_order_create within dsh.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_order_create.tsx
