# Screen Contract - wlt_captain_payout_request

1. Screen Identity: SCR_13
2. Purpose: execute captain payout request mutation.
3. Actor: captain
4. Surface: app-captain
5. Canonical Route: /captain/wlt/payout/request
6. Entry Points: captain hub and earnings view continuation.
7. Exit Points: request confirmation, retry flow, and earnings refresh.
8. Primary CTA: submit_payout_request
9. Secondary Actions: retry, back, support_action.
10. Required Data: payout amount, destination account, and payout window.
...
16. Dependent Operations: wlt_captain_payout_request
...
19. Files To Create / Files To Touch: packages/surfaces/src/wlt/wlt_captain_payout_request.tsx
