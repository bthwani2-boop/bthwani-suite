# Screen Contract: shein-proxy-request-offer

1. Screen Identity: shein-proxy-request-offer
2. Purpose: execute primary user task for shein-proxy-request-offer within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_shein_proxy_request_offer
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/shein-proxy/shein-proxy-request-offer.tsx
