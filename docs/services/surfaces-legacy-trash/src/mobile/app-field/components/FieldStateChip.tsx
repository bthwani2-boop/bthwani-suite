/**
 * FieldStateChip — Status + GPS Chips for Top Bar
...
export type FieldStatus = 'available' | 'on_task' | 'offline' | 'stopped';
...
export const FieldStateChip: React.FC<FieldStateChipProps> = ({
  status,
  gpsStatus,
  showGPS = true,
}) => {
