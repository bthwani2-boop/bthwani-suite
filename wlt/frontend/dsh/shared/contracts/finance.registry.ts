...
export function normalizeFinanceLocation(workspace?: string, panel?: string): FinanceNormalizationResult {
  ...
  // Normalization maps (Backward compatibility)
...
export function buildFinanceHref(group: CanonicalFinanceGroupId = 'financial-command-center', options?: { subGroup?: string; panel?: FinancePanelId }) {
