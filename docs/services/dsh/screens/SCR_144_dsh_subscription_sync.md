# Screen Contract: dsh_subscription_sync

1. Screen Identity: dsh_subscription_sync
2. Purpose: execute primary user task for dsh_subscription_sync within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_subscription_sync
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_subscription_sync.tsx
