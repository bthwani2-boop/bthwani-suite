...
# 16 — الرحلة 14: بوابات الإغلاق النهائي والاستعداد للـ PR

## الهدف

تجميع الأدلة وإثبات أن كل الرحلات مغلقة، ثم اتخاذ قرار READY_FOR_PR أو FIX_REQUIRED.

## النطاق

كل المشروع ضمن نطاق الفرع.
...
### Slice 14.1 Evidence Completeness Gate

**هدف الشريحة:** تأكد أن كل رحلة لديها Evidence Pack.

#### التجريب الحي المطلوب

- find tools/registry/runs
- SUMMARY/evidence/_HANDOFF.zip
- screenshots
...
- افحص/ارفض: رحلة بلا screenshot.
- افحص/ارفض: API بلا response.
- افحص/ارفض: DB بلا proof.
...
### Slice 14.2 Full Guard Suite

**هدف الشريحة:** تشغيل guards النهائية.
...
- افحص/ارفض: guard skipped بلا سبب.
- افحص/ارفض: warning غير مفهوم.
- افحص/ارفض: test flaky.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
- FIX_REQUIRED أو PASS_WITH_WARNINGS موثق.
...
### Slice 14.3 Manual Regression Sweep

**هدف الشريحة:** إعادة اختبار happy path كامل من الصفر.

#### التجريب الحي المطلوب

- new store -> delivered -> settlement
- screenshots all surfaces
...
- افحص/ارفض: تجربة مجزأة بلا actor continuity.
- افحص/ارفض: state stale.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
### Slice 14.4 Negative and Edge Cases

**هدف الشريحة:** اختبار الحالات السلبية.
...
- افحص/ارفض: لا 4xx صحيح.
- افحص/ارفض: UI crash.
- افحص/ارفض: security leak.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
### Slice 14.5 Patch Review Bundle

**هدف الشريحة:** تصدير patch للمراجعة.

#### التجريب الحي المطلوب

- LOCAL_CHANGE_REVIEW.patch
- status/diff/untracked/staged
...
- افحص/ارفض: untracked غير مرفوع.
- افحص/ارفض: staged hidden.
- افحص/ارفض: diff واسع بلا تفسير.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
- NEEDS_EVIDENCE أو REVERT_REQUIRED.
...
### Slice 14.6 PR Readiness Decision

**هدف الشريحة:** إصدار القرار النهائي.
...
- افحص/ارفض: أي BLOCKED.
- افحص/ارفض: أي preview runtime.
- افحص/ارفض: أي WLT boundary break.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
- READY_FOR_PR فقط إذا كل شيء مثبت.
