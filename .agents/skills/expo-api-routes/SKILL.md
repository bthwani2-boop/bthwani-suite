...
description: Read-only advisory review for Expo API route risks. Does not create API routes or modify runtime behavior.
---

# Expo Api Routes - BThwani Safe Advisory Skill
