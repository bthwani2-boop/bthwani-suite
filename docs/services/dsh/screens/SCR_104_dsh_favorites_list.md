# Screen Contract: dsh_favorites_list

1. Screen Identity: dsh_favorites_list
2. Purpose: execute primary user task for dsh_favorites_list within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_favorites_list
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_favorites_list.tsx
