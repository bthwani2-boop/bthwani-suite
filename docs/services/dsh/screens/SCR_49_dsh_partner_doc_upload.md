# Screen Contract: dsh_partner_doc_upload

1. Screen Identity: dsh_partner_doc_upload
2. Purpose: execute primary user task for dsh_partner_doc_upload within dsh.
3. Actor: partner
...
16. Dependent Operations: dsh_partner_doc_upload
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-partner/mobile/auto_dsh_partner_doc_upload.tsx
