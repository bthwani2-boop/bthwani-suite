# Screen Contract: admin_dsh_store_items_list_screen

1. Screen Identity: admin_dsh_store_items_list_screen
2. Purpose: execute primary user task for admin_dsh_store_items_list_screen within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_admin_dsh_store_items_list_screen
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/AdminDshStoreItemsListScreen.tsx
