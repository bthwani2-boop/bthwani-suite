---
name: bthwani-evidence-collector
description: Evidence collection skill for BThwani verification packs. Does not claim acceptance without artifacts.
---

# BThwani Evidence Collector - BThwani Safe Skill
...
- Collect command output, Git status, diff checks, logs, screenshots, and handoff ZIP paths.
- Separate observed facts from interpretation.
- Identify missing evidence before acceptance.
- Prepare concise evidence indexes.

## Forbidden Use

- Do not fabricate screenshots, logs, command output, or PASS status.
- Do not modify source files.
- Do not replace actual evidence with summaries.
- Do not close UI work without visual evidence when visuals are affected.
...
- before/after screenshots when UI is affected
