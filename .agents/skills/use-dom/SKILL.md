---
name: use-dom
description: BThwani-guarded Expo DOM advisory skill. Does not introduce WebViews or DOM components without explicit scope.
---

# Use Dom - BThwani Safe Advisory Skill
