# Screen Contract: knz_favorite_toggle

1. Screen Identity: knz_favorite_toggle
2. Purpose: execute primary user task for knz_favorite_toggle within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_favorite_toggle.tsx
