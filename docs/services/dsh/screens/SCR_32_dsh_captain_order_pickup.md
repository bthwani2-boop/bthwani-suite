# Screen Contract: dsh_captain_order_pickup

1. Screen Identity: dsh_captain_order_pickup
2. Purpose: execute primary user task for dsh_captain_order_pickup within dsh.
3. Actor: captain
...
16. Dependent Operations: dsh_captain_order_pickup
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-captain/mobile/auto_dsh_captain_order_pickup.tsx
