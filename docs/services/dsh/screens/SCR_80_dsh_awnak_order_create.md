# Screen Contract: dsh_awnak_order_create

1. Screen Identity: dsh_awnak_order_create
2. Purpose: execute primary user task for dsh_awnak_order_create within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_awnak_order_create|dsh_order_create
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_awnak_order_create.tsx
