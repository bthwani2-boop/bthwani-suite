# Screen Contract: dsh_proxy_request_review

1. Screen Identity: dsh_proxy_request_review
2. Purpose: execute primary user task for dsh_proxy_request_review within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_proxy_request_review
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_proxy_request_review.tsx
