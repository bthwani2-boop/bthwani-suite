---
name: bthwani-performance-2026-v3-additive
description: mobile/web/backend performance budgets and bottlenecks.
...
## Purpose
mobile/web/backend performance budgets and bottlenecks.
