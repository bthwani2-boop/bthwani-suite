<!--
Canonical human-review path: dsh/docs/journies-005-delivery-execution-captain/005b-captain-accept-decline-and-availability.slice2.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-005-delivery-execution-and-captain-operations/DSH-SLICE-005B-captain-accept-decline-and-availability.md
...
- Slice file: `dsh/docs/journies-005-delivery-execution-captain/005b-captain-accept-decline-and-availability.slice2.md`
...
# DSH-SLICE-005B — Captain Accept Decline and Availability
...
| Business Outcome | captain accepts/declines with availability guard |
| Primary Actor | `captain` |
| Primary Surface / Area | `app-captain + backend` |
...
1. يبدأ الممثل الأساسي `captain` من السطح `app-captain + backend`.
2. الهدف العملي: captain accepts/declines with availability guard.
...
|---|---|---|---|
| `app-captain + backend` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-005B-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-005 — Delivery Execution and Captain Operations
- Slice: DSH-SLICE-005B — Captain Accept Decline and Availability
- Primary actor: captain
- Primary surface/area: app-captain + backend
- Business outcome: captain accepts/declines with availability guard
- SESSION_ID: DSH-SLICE-005B_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-005B_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-005B_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-005B_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
