...
Status: TEMPLATE
Owner root: packages/surfaces/src/service-owned/amn
Purpose: Single canonical living control file for the AMN service.
...
|---|---|
| Service | AMN |
| Canonical owner root | packages/surfaces/src/service-owned/amn |
| Current truth file | packages/surfaces/src/service-owned/amn/SERVICE_BLUEPRINT.md |
...
| Guard | Requirement |
|---|---|
| Canonical file | packages/surfaces/src/service-owned/amn/SERVICE_BLUEPRINT.md |
