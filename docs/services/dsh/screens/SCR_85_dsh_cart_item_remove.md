# Screen Contract: dsh_cart_item_remove

1. Screen Identity: dsh_cart_item_remove
2. Purpose: execute primary user task for dsh_cart_item_remove within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_cart_item_remove
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_cart_item_remove.tsx
