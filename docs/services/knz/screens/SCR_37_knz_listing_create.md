# Screen Contract: knz_listing_create

1. Screen Identity: knz_listing_create
2. Purpose: execute primary user task for knz_listing_create within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_listing_create.tsx
