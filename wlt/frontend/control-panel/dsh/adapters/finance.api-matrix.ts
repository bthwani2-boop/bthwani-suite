 ...
 * Most entries remain CONTRACT_SCAFFOLD_PREVIEW_ONLY.
 * Only WLT_DSH_RUNTIME_CORE rows have an in-service WLT runtime handler.
...
export type DshFinanceApiBinding = {
  ...
  readonly contractState: 'CONTRACT_SCAFFOLD_PREVIEW_ONLY' | 'WLT_DSH_RUNTIME_CORE';
...
const CANONICAL_MATRIX: readonly DshFinanceApiBinding[] = [
  {
    ...
    wltEndpoint: '/wlt/dsh/control-panel/finance/command-center',
    operationId: 'getControlPanelFinanceCommandCenter',
    httpMethod: 'GET',
  ...
  },
  {
    ...
    dshRole: 'view_only',
    requiresIdempotency: false,
    contractState: 'WLT_DSH_RUNTIME_CORE',
    isImplemented: true,
    ownerService: 'wlt',
