# Screen Contract: dsh_partner_order_chat_read_ack_screen

1. Screen Identity: dsh_partner_order_chat_read_ack_screen
2. Purpose: execute primary user task for dsh_partner_order_chat_read_ack_screen within dsh.
3. Actor: shared
4. Surface: shared
5. Canonical Route: no_route_component
6. Entry Points: no_route_component entry
7. Exit Points: next route by CTA
8. Primary CTA: open_read_view
...
16. Dependent Operations: dsh_chat_read_ack|dsh_partner_order_chat_read_ack_screen
...
22. Notes from donor extraction: packages/surfaces/src/dsh/mobile/dsh/DshPartnerOrderChatReadAckScreen.tsx
