# Screen Contract: arrival_bell_settings_screen

1. Screen Identity: arrival_bell_settings_screen
2. Purpose: execute primary user task for arrival_bell_settings_screen within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: arrival_bell|dsh_control_panel_arrival_bell_settings_screen
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/control_panelArrivalBellSettingsScreen.tsx
