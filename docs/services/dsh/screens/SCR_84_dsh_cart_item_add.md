# Screen Contract: dsh_cart_item_add

1. Screen Identity: dsh_cart_item_add
2. Purpose: execute primary user task for dsh_cart_item_add within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_cart_item_add
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_cart_item_add.tsx
