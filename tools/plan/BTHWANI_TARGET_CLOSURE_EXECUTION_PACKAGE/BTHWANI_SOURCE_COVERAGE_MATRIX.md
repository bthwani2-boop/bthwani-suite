...
| No main/default branch as truth | Current branch gate |
| No PR/commit/push/merge | GitHub/write prohibition |
| No backend/API/DB/runtime mutation | Runtime/API Readiness Matrix |
| Web/open-source benchmark | Benchmark protocol + Benchmark Matrix |
| Gap Matrix | Matrices template |
| Target Execution Map | Matrices template + main protocol |
| Task 1 executable package | Task Execution Package |
...
| File Boundary Matrix | Matrices template |
| Demo Data / Media Centralization Matrix | Matrices template |
...
| Image/media optimization | Performance Playbook |
