# Screen Contract - arb_partner_bookings_list

1. Screen Identity: SCR_12
2. Purpose: Operational ARB workflow surface.
3. Actor: partner
4. Surface: app-partner
5. Canonical Route: /partner/arb/partner/bookings/list
...
19. Files To Create / Files To Touch: packages/surfaces/src/arb/arb_partner_bookings_list.tsx
