<!--
Canonical human-review path: dsh/docs/journies-010-wlt-finance-settlement-boundary/010d-payout-and-settlement-rules.slice4.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-010-wlt-finance-settlement-ledger-boundary/DSH-SLICE-010D-payout-and-settlement-rules.md
...
- Slice file: `dsh/docs/journies-010-wlt-finance-settlement-boundary/010d-payout-and-settlement-rules.slice4.md`
...
# DSH-SLICE-010D — Payout and Settlement Rules
...
| Business Outcome | payout/settlement controlled by WLT |
| Primary Actor | `partner/captain/operator/WLT` |
...
1. يبدأ الممثل الأساسي `partner/captain/operator/WLT` من السطح `WLT + control-panel`.
2. الهدف العملي: payout/settlement controlled by WLT.
...
|---|---|---|---|---|---|
| GAP-010D-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-010 — WLT Finance, Settlement, Ledger Boundary
- Slice: DSH-SLICE-010D — Payout and Settlement Rules
- Primary actor: partner/captain/operator/WLT
- Primary surface/area: WLT + control-panel
- Business outcome: payout/settlement controlled by WLT
- SESSION_ID: DSH-SLICE-010D_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-010D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-010D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-010D_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
