<!--
Canonical human-review path: dsh/docs/journies-003-checkout-payment-wlt-order/003b-checkout-intent-address-and-time-window.slice2.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-003-checkout-payment-wlt-bridge-order-creation/DSH-SLICE-003B-checkout-intent-address-and-time-window.md
...
- Slice file: `dsh/docs/journies-003-checkout-payment-wlt-order/003b-checkout-intent-address-and-time-window.slice2.md`
- Slice order inside journey: `2` of `7`
...
# DSH-SLICE-003B — Checkout Intent Address and Time Window
...
| Business Outcome | client selects address/time/options and receives valid checkout intent |
| Primary Actor | `client` |
| Primary Surface / Area | `app-client + backend/OpenAPI` |
...
1. يبدأ الممثل الأساسي `client` من السطح `app-client + backend/OpenAPI`.
2. الهدف العملي: client selects address/time/options and receives valid checkout intent.
...
|---|---|---|---|
| `app-client + backend/OpenAPI` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-003B-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-003 — Checkout, Payment, WLT Bridge, Order Creation
- Slice: DSH-SLICE-003B — Checkout Intent Address and Time Window
- Primary actor: client
- Primary surface/area: app-client + backend/OpenAPI
- Business outcome: client selects address/time/options and receives valid checkout intent
- SESSION_ID: DSH-SLICE-003B_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-003B_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-003B_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-003B_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
