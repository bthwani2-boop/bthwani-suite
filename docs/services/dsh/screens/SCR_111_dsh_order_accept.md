# Screen Contract: dsh_order_accept

1. Screen Identity: dsh_order_accept
2. Purpose: execute primary user task for dsh_order_accept within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_order_accept
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_order_accept.tsx
