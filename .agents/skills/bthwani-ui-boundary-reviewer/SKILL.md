---
name: bthwani-ui-boundary-reviewer
description: BThwani-specific UI boundary guard for ui-kit ownership, Tamagui containment, visual identity, and RTL correctness.
---

# BThwani UI Boundary Reviewer - BThwani Safe Skill
...
- Review UI/frontend/mobile changes for Screen / Surface / App -> @bthwani/ui-kit public exports -> Tamagui internally inside ui-kit only.
- Check RTL row direction, icon/text clustering, chevrons/actions, alignment, safe areas, clipping, overflow, and visual hierarchy.
- Check BThwani identity use: #0A2F5C, #FF500D, #FFFFFF.
- Request screenshots or NEEDS_VISUAL_EVIDENCE for visual acceptance.

## Forbidden Use

- Do not create local design systems.
- Do not permit direct Tamagui imports outside @bthwani/ui-kit.
- Do not accept random colors, noisy palettes, or visual drift.
- Do not approve Arabic UI with incorrect directionality.
