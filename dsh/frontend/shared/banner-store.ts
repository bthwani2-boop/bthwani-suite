...
const seededBanners: MarketingBannerRecord[] = [
  {
    ...
    imageUrl: createBannerDataUrl('#f97316', '#ea580c', 'وجبات عائلية', 'وفر 40% على منيو العائلة اليوم'),
    accentColor: '#f97316',
    audience: 'all',
    status: 'published',
    ...
    partnerLogoUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=R&backgroundColor=ffffff',
  ...
  },
  {
    ...
    subtitle: 'توصيل خلال 20 دقيقة من أقرب فرع',
    imageUrl: createBannerDataUrl('#16a34a', '#15803d', 'مقاضي بلمح البصر', 'توصيل خلال 20 دقيقة'),
    accentColor: '#16a34a',
    audience: 'all',
    status: 'published',
    ...
    offerBadgePosition: 'top-right',
    partnerLogoUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=G&backgroundColor=ffffff',
    partnerLogoPosition: 'top-left',
    titlePlacement: 'bottom',
    imageFit: 'cover',
  },
  {
    ...
    title: 'BThwani Pro',
    subtitle: 'توصيل مجاني غير محدود لجميع طلباتك',
    imageUrl: createBannerDataUrl('#6366f1', '#4f46e5', 'BThwani Pro', 'توصيل مجاني غير محدود'),
    accentColor: '#6366f1',
    audience: 'all',
    status: 'published',
    ...
    offerBadgePosition: 'top-right',
    partnerLogoUrl: 'https://api.dicebear.com/7.x/initials/svg?seed=P&backgroundColor=ffffff',
    partnerLogoPosition: 'top-left',
...
export function upsertMarketingBannerItem(item: Partial<MarketingBannerRecord>) {
  ...
  const nextEntry: MarketingBannerRecord = {
    ...
    imageUrl: item.imageUrl?.trim() || existing?.imageUrl || createBannerDataUrl(item.accentColor?.trim() || '#f97316', '#ea580c', item.title?.trim() || 'بنر جديد', item.subtitle?.trim() || 'أضف النص هنا'),
