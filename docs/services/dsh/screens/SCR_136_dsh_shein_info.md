# Screen Contract: dsh_shein_info

1. Screen Identity: dsh_shein_info
2. Purpose: execute primary user task for dsh_shein_info within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_shein_info
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_shein_info.tsx
