---
name: bthwani-security-privacy-2026-v3-additive
description: auth, RBAC/ABAC, step-up, PII, secrets, audit, retention.
...
## Purpose
auth, RBAC/ABAC, step-up, PII, secrets, audit, retention.
