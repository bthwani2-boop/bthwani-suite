# Screen Contract: knz_promoted_badge

1. Screen Identity: knz_promoted_badge
2. Purpose: execute primary user task for knz_promoted_badge within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/components/KnzPromotedBadge.tsx
