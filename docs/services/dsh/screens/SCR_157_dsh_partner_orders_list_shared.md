# Screen Contract: dsh_partner_orders_list_shared

1. Screen Identity: dsh_partner_orders_list_shared
2. Purpose: execute primary user task for dsh_partner_orders_list_shared within dsh.
3. Actor: shared
4. Surface: shared
...
22. Notes from donor extraction: packages/surfaces/src/dsh/DshPartnerOrdersList.tsx
