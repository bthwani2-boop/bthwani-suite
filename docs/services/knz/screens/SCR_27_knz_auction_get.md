# Screen Contract: knz_auction_get

1. Screen Identity: knz_auction_get
2. Purpose: execute primary user task for knz_auction_get within knz.
3. Actor: customer
...
16. Dependent Operations: knz_auction_get
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_auction_get.tsx
