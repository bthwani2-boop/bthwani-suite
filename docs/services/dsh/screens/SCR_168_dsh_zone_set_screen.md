# Screen Contract: dsh_zone_set_screen

1. Screen Identity: dsh_zone_set_screen
2. Purpose: execute primary user task for dsh_zone_set_screen within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_zone_set|dsh_zone_set_screen
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/DshZoneSetScreen.tsx
