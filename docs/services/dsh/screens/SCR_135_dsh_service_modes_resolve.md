# Screen Contract: dsh_service_modes_resolve

1. Screen Identity: dsh_service_modes_resolve
2. Purpose: execute primary user task for dsh_service_modes_resolve within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_service_modes_resolve
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_service_modes_resolve.tsx
