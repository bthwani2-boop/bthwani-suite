...
New canonical human-review folder: dsh/docs/journies-013-notifications-signal-layer/
...
# J-013 — Notifications and Signal Layer
...
|---|---|
| Journey ID | `J-013` |
| Name | Notifications and Signal Layer |
| Type | `foundation` |
| Primary Actors | client, partner, captain, field, operator |
| Control Panel / Domain Owner | notification/signal |
| WLT Boundary | finance notifications originate from WLT or approved bridge |
| Planning Status | `REQUIRED_AFTER_CORE_RUNTIME` |
| Business Outcome | State changes emit scoped notifications/signals to the right actor only, with retry/read/audit behavior and no duplicated event logic. |
...
|---|---|---|---|---|---|---|
| `DSH-SLICE-013A` | Order State Notifications | client/partner/captain | all mobile apps + backend | order transitions notify relevant actors | `slices/j-013-notifications-and-signal-layer/DSH-SLICE-013A-order-state-notifications.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-013B` | Support Exception Signals | operator/client | control-panel + app-client | support/exception signals are routed and auditable | `slices/j-013-notifications-and-signal-layer/DSH-SLICE-013B-support-exception-signals.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-013C` | Field and Partner Onboarding Notifications | field/partner/operator | app-field + app-partner + control-panel | onboarding steps notify responsible actor | `slices/j-013-notifications-and-signal-layer/DSH-SLICE-013C-field-and-partner-onboarding-notifications.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-013D` | Notification Preference and Read State | all actors | shared profile + apps | preferences/read status persist safely | `slices/j-013-notifications-and-signal-layer/DSH-SLICE-013D-notification-preference-and-read-state.md` | NOT_CLOSED_BY_THIS_FILE |
| `DSH-SLICE-013E` | Finance Notification Boundary | WLT/operator/client | WLT + bridge | financial notifications do not originate from DSH mutation | `slices/j-013-notifications-and-signal-layer/DSH-SLICE-013E-finance-notification-boundary.md` | NOT_CLOSED_BY_THIS_FILE |
