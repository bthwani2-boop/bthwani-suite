...
| control-panel | `dsh/frontend/control-panel/partners/ControlPanelDshPartnerApprovalsScreen.tsx` | 11437 | ACTIVE_ENTRY_CANDIDATE | `runtime/app/partners/page.tsx` direct section proof | Partner approvals root | control-panel partners primary; app-partner console and inventory mirrors | local queue/workflow data | queue/tabs/decision states | no partner backend closure | keep as section root |
