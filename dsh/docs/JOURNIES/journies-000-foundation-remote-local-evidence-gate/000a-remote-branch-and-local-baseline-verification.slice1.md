<!--
Canonical human-review path: dsh/docs/journies-000-foundation-remote-local-evidence-gate/000a-remote-branch-and-local-baseline-verification.slice1.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-000-foundation-remote-local-evidence-gate/DSH-SLICE-000A-remote-branch-and-local-baseline-verification.md
...
- Slice file: `dsh/docs/journies-000-foundation-remote-local-evidence-gate/000a-remote-branch-and-local-baseline-verification.slice1.md`
...
# DSH-SLICE-000A — Remote Branch and Local Baseline Verification
...
| Field | Value |
|---|---|
| Slice ID | `DSH-SLICE-000A` |
| Parent Journey | `J-000 — Foundation Remote / Local / Evidence Gate` |
| Journey Type | `foundation` |
| Business Outcome | prove branch/ref/current local state and no hidden drift |
| Primary Actor | `developer` |
| Primary Surface / Area | `repo/GitHub/local git` |
...
1. يبدأ الممثل الأساسي `developer` من السطح `repo/GitHub/local git`.
2. الهدف العملي: prove branch/ref/current local state and no hidden drift.
...
|---|---|---|---|
| `repo/GitHub/local git` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
- Parent Journey: J-000 — Foundation Remote / Local / Evidence Gate
- Slice: DSH-SLICE-000A — Remote Branch and Local Baseline Verification
- Primary actor: developer
- Primary surface/area: repo/GitHub/local git
- Business outcome: prove branch/ref/current local state and no hidden drift
- SESSION_ID: DSH-SLICE-000A_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-000A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-000A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-000A_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
