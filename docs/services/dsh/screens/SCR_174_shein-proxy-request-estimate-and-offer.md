# Screen Contract: shein-proxy-request-estimate-and-offer

1. Screen Identity: shein-proxy-request-estimate-and-offer
2. Purpose: execute primary user task for shein-proxy-request-estimate-and-offer within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_shein_proxy_request_estimate_and_offer
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/shein-proxy/shein-proxy-request-estimate-and-offer.tsx
