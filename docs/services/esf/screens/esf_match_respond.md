# Screen Contract - esf_match_respond

1. Screen Identity: SCR_6
2. Purpose: respond to ESF match.
3. Actor: client
4. Surface: app-client
5. Canonical Route: /esf/matches/respond
6. Entry Points: match detail.
7. Exit Points: confirmation and inbox.
8. Primary CTA: submit_respond
9. Secondary Actions: retry, back.
10. Required Data: decision payload.
11. Displayed Blocks: decision controls and feedback.
12. Section Order: header -> decision -> actions.
...
16. Dependent Operations: esf_match_respond
17. Required UI-Kit Pieces: controls, state shells.
18. Local vs Shared Ownership: shared ui-kit primitives.
19. Files To Create / Files To Touch: packages/surfaces/src/esf/esf_match_respond.tsx
