// Auto-generated screen for wlt_intent_create
...
interface auto_wlt_intent_createProps {
  onNavigate?: (screen: string) => void;
  navigation?: { navigate: (screen: string) => void };
}

export const auto_wlt_intent_create: React.FC<auto_wlt_intent_createProps> = () => {
      ...
      <ScreenWrapper state="content">
        <View style={styles.container}>
          <Text style={[styles.title, textAlignStart]}>
            {t('surfaces.إنشاء_نية_دفع')}
          </Text>
          <Text style={[styles.subtitle, textAlignStart]}>
            {t('surfaces.إنشاء_نية_دفع_جديدة')}
          </Text>
          <TouchableOpacity style={styles.primaryButton}>
            <Text style={styles.primaryButtonText}>{t('surfaces.إنشاء')}</Text>
          </TouchableOpacity>
        </View>
      </ScreenWrapper>
    );
  ...
  return (
    <ScreenWrapper
      ...
      screenName="auto_wlt_intent_create"
      operationName="wlt_intent_create"
    />
  );
};
...
export default auto_wlt_intent_create;
