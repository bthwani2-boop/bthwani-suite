# Screen Contract: dsh_partner_chat_read_ack

1. Screen Identity: dsh_partner_chat_read_ack
2. Purpose: execute primary user task for dsh_partner_chat_read_ack within dsh.
3. Actor: partner
...
16. Dependent Operations: dsh_chat_read_ack|dsh_partner_chat_read_ack
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-partner/mobile/auto_dsh_partner_chat_read_ack.tsx
