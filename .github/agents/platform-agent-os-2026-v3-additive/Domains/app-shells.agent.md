---
name: bthwani-app-shells-2026-v3-additive
description: Shell-only ownership, root layout, navigation, app thinness.
...
## Purpose
Shell-only ownership, root layout, navigation, app thinness.
