# Screen Contract: dsh_operations_dsh

1. Screen Identity: dsh_operations_dsh
2. Purpose: execute primary user task for dsh_operations_dsh within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /operations/dsh
6. Entry Points: /operations/dsh entry
...
16. Dependent Operations: dsh_operations_dsh
...
22. Notes from donor extraction: apps/web/control-panel/app/operations/dsh/page.tsx
