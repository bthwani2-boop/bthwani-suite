# Screen Contract: dsh_loyalty_points_user_balance

1. Screen Identity: dsh_loyalty_points_user_balance
2. Purpose: execute primary user task for dsh_loyalty_points_user_balance within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_loyalty_points_user_balance
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_loyalty_points_user_balance.tsx
