import type { WltDshFinanceSummaryRecord, WltDshFinanceEventKind } from '../boundary/dshFinance.types';
import { formatWltYer } from '../boundary/dshFinance.types';
import { getWltAccountByCode } from '../ledger/chartOfAccounts.types';
import { getWltPostingRuleForEvent } from '../ledger/postingRules.types';
import type {
  WltLedgerEntryKind,
  ...
  WltFinancialCenter,
} from '../control-panel/financialCenter.types';
...
function resolveEntryStatus(record: WltDshFinanceSummaryRecord): WltLedgerEntryStatus {
...
function resolvePartyLabel(record: WltDshFinanceSummaryRecord): string {
...
function resolveSourceRef(record: WltDshFinanceSummaryRecord): string {
...
export function buildWltFinancialCenter(
  businessDate: string,
  records: ReadonlyArray<WltDshFinanceSummaryRecord>,
): WltFinancialCenter {
