// Auto-generated screen for wlt_refund_create
...
interface auto_wlt_refund_createProps {
  onNavigate?: (screen: string) => void;
  navigation?: { navigate: (screen: string) => void };
}

export const auto_wlt_refund_create: React.FC<auto_wlt_refund_createProps> = () => {
    ...
    return (
      <ScreenWrapper state="content">
        <View style={styles.container}>
          <Text style={[styles.title, textAlignStart]}>{t('surfaces.طلب_استرداد')}</Text>
          <Text style={[styles.subtitle, textAlignStart]}>{t('surfaces.إنشاء_طلب_استرداد_مبلغ')}</Text>
          <TouchableOpacity style={styles.primaryButton}>
            <Text style={styles.primaryButtonText}>{t('surfaces.طلب_استرداد')}</Text>
          </TouchableOpacity>
        </View>
      </ScreenWrapper>
    );
  ...
  return (
    <ScreenWrapper
      ...
      screenName="auto_wlt_refund_create"
      operationName="wlt_refund_create"
    />
  );
};
...
export default auto_wlt_refund_create;
