# Screen Contract: dsh_favorite_toggle

1. Screen Identity: dsh_favorite_toggle
2. Purpose: execute primary user task for dsh_favorite_toggle within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_favorite_toggle
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_favorite_toggle.tsx
