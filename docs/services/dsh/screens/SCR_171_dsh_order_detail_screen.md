# Screen Contract: dsh_order_detail_screen

1. Screen Identity: dsh_order_detail_screen
2. Purpose: execute primary user task for dsh_order_detail_screen within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_control_panel_dsh_order_detail_screen
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/control_panelDshOrderDetailScreen.tsx
