# Screen Contract: knz_account_screen

1. Screen Identity: knz_account_screen
2. Purpose: execute primary user task for knz_account_screen within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/KnzAccountScreen.tsx
