...
export type DshPartnerInventoryScreenProps = {
  onBack?: () => void;
};

export type DshInventoryManagementScreenProps = DshPartnerInventoryScreenProps;

export function DshPartnerInventoryScreen({ onBack }: DshPartnerInventoryScreenProps) {
  return (
