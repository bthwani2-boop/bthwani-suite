# Screen Contract: knz_listing_report

1. Screen Identity: knz_listing_report
2. Purpose: execute primary user task for knz_listing_report within knz.
3. Actor: customer
...
16. Dependent Operations: knz_listing_report
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_listing_report.tsx
