# Screen Contract: knz_home_get

1. Screen Identity: knz_home_get
2. Purpose: execute primary user task for knz_home_get within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_home_get.tsx
