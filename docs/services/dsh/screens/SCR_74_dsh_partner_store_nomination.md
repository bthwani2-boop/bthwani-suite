# Screen Contract: dsh_partner_store_nomination

1. Screen Identity: dsh_partner_store_nomination
2. Purpose: execute primary user task for dsh_partner_store_nomination within dsh.
3. Actor: partner
...
16. Dependent Operations: dsh_partner_store_nomination
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-partner/mobile/auto_dsh_partner_store_nomination.tsx
