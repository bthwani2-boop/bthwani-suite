---
name: bthwani-observability-2026-v3-additive
description: logs, metrics, traces, alerts, dashboards, no raw PII logs.
...
## Purpose
logs, metrics, traces, alerts, dashboards, no raw PII logs.
