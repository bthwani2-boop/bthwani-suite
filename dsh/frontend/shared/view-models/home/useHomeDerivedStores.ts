...
import type { DshHomeCategory, DshHomeGetStore, DiscoveryFilter, StorePagerPage } from 'contracts/dsh-home-types';
...
import { getHomePromoVisibilityRecord, isMarketingRenderable } from 'contracts/marketing-visibility.contract';
