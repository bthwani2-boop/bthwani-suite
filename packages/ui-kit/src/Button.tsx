/**
 * Lean UI Kit final family file: Button.tsx
...
export type BthButton = any;
export const BthButton: any = createLeanExport('BthButton');
export type BthButtonTone = any;
export type BthButtonProps = any;
export type Button = any;
export const Button: any = createLeanExport('Button');
