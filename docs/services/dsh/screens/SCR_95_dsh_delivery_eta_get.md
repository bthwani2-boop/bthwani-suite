# Screen Contract: dsh_delivery_eta_get

1. Screen Identity: dsh_delivery_eta_get
2. Purpose: execute primary user task for dsh_delivery_eta_get within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_delivery_eta_get
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_delivery_eta_get.tsx
