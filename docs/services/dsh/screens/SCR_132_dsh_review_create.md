# Screen Contract: dsh_review_create

1. Screen Identity: dsh_review_create
2. Purpose: execute primary user task for dsh_review_create within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_review_create
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_review_create.tsx
