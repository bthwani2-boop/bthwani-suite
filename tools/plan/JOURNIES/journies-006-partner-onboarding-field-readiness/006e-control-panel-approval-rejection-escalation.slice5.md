<!--
Canonical human-review path: dsh/docs/journies-006-partner-onboarding-field-readiness/006e-control-panel-approval-rejection-escalation.slice5.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-006-partner-onboarding-and-field-readiness/DSH-SLICE-006E-control-panel-approval-rejection-escalation.md
...
- Slice file: `dsh/docs/journies-006-partner-onboarding-field-readiness/006e-control-panel-approval-rejection-escalation.slice5.md`
...
# DSH-SLICE-006E — Control Panel Approval Rejection Escalation
...
| Business Outcome | approve/reject/escalate readiness with audit |
| Primary Actor | `operator` |
| Primary Surface / Area | `control-panel + backend` |
...
1. يبدأ الممثل الأساسي `operator` من السطح `control-panel + backend`.
2. الهدف العملي: approve/reject/escalate readiness with audit.
...
|---|---|---|---|
| `control-panel + backend` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-006E-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-006 — Partner Onboarding and Field Readiness
- Slice: DSH-SLICE-006E — Control Panel Approval Rejection Escalation
- Primary actor: operator
- Primary surface/area: control-panel + backend
- Business outcome: approve/reject/escalate readiness with audit
- SESSION_ID: DSH-SLICE-006E_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-006E_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-006E_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-006E_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
