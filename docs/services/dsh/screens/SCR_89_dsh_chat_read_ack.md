# Screen Contract: dsh_chat_read_ack

1. Screen Identity: dsh_chat_read_ack
2. Purpose: execute primary user task for dsh_chat_read_ack within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_captain_chat_read_ack|dsh_chat_read_ack|dsh_partner_chat_read_ack
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_chat_read_ack.tsx
