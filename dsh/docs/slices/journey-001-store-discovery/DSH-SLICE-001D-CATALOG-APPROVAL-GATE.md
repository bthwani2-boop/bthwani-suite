...
|---|---|---|---|
| CM-001D-01 | control-panel | PartnerStoresScreen | FIX_REQUIRED |
| CM-001D-02 | transport | dsh-store-visibility-transport.ts | FIX_REQUIRED |

## CTA Matrix
| CTA | Surface | Screen | Target | Status |
|---|---|---|---|---|
| Approve catalog | control-panel | PartnerStoresScreen | PATCH /stores/{id}/catalog-approval | FIX_REQUIRED |
| Revoke catalog approval | control-panel | PartnerStoresScreen | PATCH /stores/{id}/catalog-approval | FIX_REQUIRED |

## State Matrix
| State | Required | Status |
|---|---|---|
| approved | yes | screen proof captured |
| not-approved | yes | screen proof captured |
...
| **Next Action** | Complete RUNTIME_EVIDENCE_MATRIX verification; close manifest alongside 001C and 001E |
