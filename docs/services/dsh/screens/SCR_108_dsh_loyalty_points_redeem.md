# Screen Contract: dsh_loyalty_points_redeem

1. Screen Identity: dsh_loyalty_points_redeem
2. Purpose: execute primary user task for dsh_loyalty_points_redeem within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_loyalty_points_redeem
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_loyalty_points_redeem.tsx
