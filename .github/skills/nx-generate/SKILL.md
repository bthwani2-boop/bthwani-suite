---
name: nx-generate
description: Generate code using nx generators; use when the user asks for scaffolding, setup, structure, creating apps/libs, or adding a new project. Trigger words - scaffold, setup, create a ... app, create a ... lib, project structure, generate, add a new project. ALWAYS use this BEFORE calling nx_docs or exploring - this skill handles discovery internally.
---
