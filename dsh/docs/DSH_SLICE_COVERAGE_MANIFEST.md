...
| J-010 | WLT Finance / Settlement Boundary | Foundation | operator (read-only) | finance | full WLT ownership — DSH is read-only bridge | **BLOCKED_WITH_REASON** — full WLT finance ownership; DSH reads only; pending WLT E2E integration proof |
