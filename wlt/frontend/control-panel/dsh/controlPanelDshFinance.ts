/**
 * WLT-owned DSH control-panel finance preview contracts.
 *
 * CONTRACT_SCAFFOLD_PREVIEW_ONLY.
 * These records are staff-facing read models only. They are not backend data,
 * not ledger runtime, and not a source for money mutation.
 */
