...
const report = createReport('EVIDENCE-CLOSURE', 'governance/00_GOVERNANCE_INDEX.md');
...
const mdFiles = walkFiles(root, { startDirs: ['governance', '.github', 'tools'], extensions: new Set(['.md']) });
