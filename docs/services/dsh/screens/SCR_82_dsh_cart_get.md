# Screen Contract: dsh_cart_get

1. Screen Identity: dsh_cart_get
2. Purpose: execute primary user task for dsh_cart_get within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_cart_get
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_cart_get.tsx
