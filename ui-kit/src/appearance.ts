...
export const lightThemeColors = {
  pageBackground: appearancePaletteByMode.lightPremium.offWhite,
  surfacePrimary: appearancePaletteByMode.lightPremium.white,
  surfaceSecondary: appearancePaletteByMode.lightPremium.warmSurfaceElevated,
  surfaceRaised: appearancePaletteByMode.lightPremium.warmWhite,
  surfaceInset: appearancePaletteByMode.lightPremium.warmSurface,
  ...
  borderSubtle: withAlpha(appearancePaletteByMode.lightPremium.deepBlue, 0.1),
  ...
  accentOrange: appearancePaletteByMode.lightPremium.orange,
  ctaPrimary: appearancePaletteByMode.lightPremium.deepBlue,
  ctaSecondary: appearancePaletteByMode.lightPremium.white,
  success: appearancePaletteByMode.lightPremium.success,
  warning: appearancePaletteByMode.lightPremium.warning,
  danger: appearancePaletteByMode.lightPremium.danger,
  info: appearancePaletteByMode.lightPremium.info,
  overlay: withAlpha(appearancePaletteByMode.lightPremium.deepBlue, 0.22),
  overlaySoft: withAlpha(appearancePaletteByMode.lightPremium.deepBlue, 0.1),
  focusRing: withAlpha(appearancePaletteByMode.lightPremium.orange, 0.3),
...
export const darkThemeColors = {
  pageBackground: appearancePaletteByMode.darkGlass.navyNight,
  surfacePrimary: '#101B2C',
  ...
  textMuted: withAlpha(appearancePaletteByMode.darkGlass.offWhite, 0.62),
  borderSubtle: withAlpha(appearancePaletteByMode.darkGlass.white, 0.1),
  borderStrong: withAlpha(appearancePaletteByMode.darkGlass.white, 0.2),
  accentBlue: appearancePaletteByMode.darkGlass.deepBlueElevated,
  accentOrange: appearancePaletteByMode.darkGlass.orange,
  ...
  success: appearancePaletteByMode.darkGlass.success,
  warning: appearancePaletteByMode.darkGlass.warning,
  danger: appearancePaletteByMode.darkGlass.danger,
  info: appearancePaletteByMode.darkGlass.info,
  overlay: withAlpha(appearancePaletteByMode.darkGlass.navyNight, 0.68),
  overlaySoft: withAlpha(appearancePaletteByMode.darkGlass.navyNight, 0.42),
  focusRing: withAlpha(appearancePaletteByMode.darkGlass.orange, 0.36),
  disabledSurface: withAlpha(appearancePaletteByMode.darkGlass.white, 0.08),
  disabledInk: withAlpha(appearancePaletteByMode.darkGlass.offWhite, 0.36),
  ...
  shadowSoftColor: '#040A12',
  shadowPremiumColor: '#000000',
} as const satisfies BThwaniAppearanceThemeColors;
...
function createComponentTokens(mode: BThwaniAppearanceMode, colors: BThwaniAppearanceThemeColors, palette: BThwaniAppearancePalette): BThwaniAppearanceComponentTokens {
  ...
  return {
    ...
    commerce: {
      ...
      productCard: {
        backgroundColor: mode === 'darkGlass' ? '#111F32' : colors.surfacePrimary,
    ...
    dataViz: {
      series: mode === 'darkGlass'
        ? [colors.accentOrange, '#6F9BD0', '#6CC7A0', '#DAB36E']
        : [colors.accentBlue, colors.accentOrange, colors.success, '#B58B57'],
