<!--
Canonical human-review path: dsh/docs/journies-002-catalog-management/002d-catalog-override-and-conflict-resolution.slice4.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-002-deep-catalog-management/DSH-SLICE-002D-catalog-override-and-conflict-resolution.md
...
- Slice file: `dsh/docs/journies-002-catalog-management/002d-catalog-override-and-conflict-resolution.slice4.md`
...
# DSH-SLICE-002D — Catalog Override and Conflict Resolution
...
| Business Outcome | resolve central-vs-local conflicts safely |
| Primary Actor | `operator/partner` |
| Primary Surface / Area | `control-panel + app-partner + backend` |
...
1. يبدأ الممثل الأساسي `operator/partner` من السطح `control-panel + app-partner + backend`.
2. الهدف العملي: resolve central-vs-local conflicts safely.
...
|---|---|---|---|
| `control-panel + app-partner + backend` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
- Parent Journey: J-002 — Deep Catalog Management
- Slice: DSH-SLICE-002D — Catalog Override and Conflict Resolution
- Primary actor: operator/partner
- Primary surface/area: control-panel + app-partner + backend
- Business outcome: resolve central-vs-local conflicts safely
- SESSION_ID: DSH-SLICE-002D_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-002D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-002D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-002D_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
