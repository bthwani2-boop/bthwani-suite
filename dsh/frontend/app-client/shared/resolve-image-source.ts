...
const seedMediaSources: Record<string, ImageSourcePropType> = {
	...
	'dsh.store.hadda.logo.v1': require('../../../media-fixtures/assets/seed/dsh/stores/dsh-store-hadda-logo-v1.png') as ImageSourcePropType,
	'dsh.store.hittin.logo.v1': require('../../../media-fixtures/assets/seed/dsh/stores/dsh-store-hittin-logo-v1.png') as ImageSourcePropType,
	'dsh.store.malqa.logo.v1': require('../../../media-fixtures/assets/seed/dsh/stores/dsh-store-malqa-logo-v1.png') as ImageSourcePropType,
