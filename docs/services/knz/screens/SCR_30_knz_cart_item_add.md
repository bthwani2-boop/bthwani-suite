# Screen Contract: knz_cart_item_add

1. Screen Identity: knz_cart_item_add
2. Purpose: execute primary user task for knz_cart_item_add within knz.
3. Actor: customer
...
16. Dependent Operations: knz_cart_item_add
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/auto_knz_cart_item_add.tsx
