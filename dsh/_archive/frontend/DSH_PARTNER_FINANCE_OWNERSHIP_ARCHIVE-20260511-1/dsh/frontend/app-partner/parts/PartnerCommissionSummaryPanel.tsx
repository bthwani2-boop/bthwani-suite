...
import type { DshPartnerCommissionSummary } from '../data/partnerFinancePreviewData';
...
export function PartnerCommissionSummaryPanel({ items = defaultCommissionItems }: DshPartnerCommissionSummaryPanelProps) {
  return (
...
export { PartnerCommissionSummaryPanel as DshPartnerCommissionSummaryPanel };

export default PartnerCommissionSummaryPanel;
