# Screen Contract: dsh_partner_chat_send

1. Screen Identity: dsh_partner_chat_send
2. Purpose: execute primary user task for dsh_partner_chat_send within dsh.
3. Actor: partner
...
16. Dependent Operations: dsh_chat_send|dsh_partner_chat_send
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-partner/mobile/auto_dsh_partner_chat_send.tsx
