# Screen Contract: dsh_partner_orders_list

1. Screen Identity: dsh_partner_orders_list
2. Purpose: execute primary user task for dsh_partner_orders_list within dsh.
3. Actor: partner
...
16. Dependent Operations: dsh_orders_list|dsh_partner_orders_list
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-partner/mobile/auto_dsh_partner_orders_list.tsx
