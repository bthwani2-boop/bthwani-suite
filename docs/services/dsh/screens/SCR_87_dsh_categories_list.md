# Screen Contract: dsh_categories_list

1. Screen Identity: dsh_categories_list
2. Purpose: execute primary user task for dsh_categories_list within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_categories_list
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_categories_list.tsx
