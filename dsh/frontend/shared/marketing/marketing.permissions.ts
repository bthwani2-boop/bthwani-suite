// Canonical location: dsh/frontend/shared/marketing/marketing.permissions.ts
// Authority: dsh/frontend/shared/marketing — moved from control-panel/marketing/marketing-permissions.contract.ts
