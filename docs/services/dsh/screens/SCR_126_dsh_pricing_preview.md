# Screen Contract: dsh_pricing_preview

1. Screen Identity: dsh_pricing_preview
2. Purpose: execute primary user task for dsh_pricing_preview within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_pricing_preview
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_pricing_preview.tsx
