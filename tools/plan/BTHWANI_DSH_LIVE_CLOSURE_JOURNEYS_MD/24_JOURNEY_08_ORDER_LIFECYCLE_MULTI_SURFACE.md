...
language: ar
title: رحلة 08 — Order lifecycle متعدد الأسطح
---

# رحلة 08 — دورة حياة الطلب متعددة الأسطح

## الهدف

طلب واحد يتحرك بين العميل، الشريك، Control Panel، والكابتن بعقل واحد.

## مالك المنطق

- order lifecycle: `dsh/frontend/shared/orders`.
- partner order views: shared read model + UI root.
- captain task linkage: `dsh/frontend/shared/captain` أو `delivery`.

## ممنوع

- status transitions منفصلة لكل app.
- next-action maps داخل app roots.
- control-panel يملك truth لحالة الطلب.
