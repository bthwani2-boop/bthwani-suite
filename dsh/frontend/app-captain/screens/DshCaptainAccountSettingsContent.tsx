    ...
    <Box gap={4}>
      <Box padding={0} gap={0}>
        ...
        <View style={{ flexDirection: rowDirection, alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: spacing[4], paddingVertical: 14, backgroundColor: theme.surface }}>
          ...
          <View style={{ flexDirection: rowDirection, backgroundColor: theme.surfaceInset, borderRadius: radius.sm2, padding: 3, borderWidth: borders.hairline, borderColor: theme.line, gap: spacing[1] }}>
