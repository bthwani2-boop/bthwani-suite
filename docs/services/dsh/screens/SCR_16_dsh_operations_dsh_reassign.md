# Screen Contract: dsh_operations_dsh_reassign

1. Screen Identity: dsh_operations_dsh_reassign
2. Purpose: execute primary user task for dsh_operations_dsh_reassign within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /operations/dsh/reassign
6. Entry Points: /operations/dsh/reassign entry
...
16. Dependent Operations: dsh_operations_dsh_reassign
...
22. Notes from donor extraction: apps/web/control-panel/app/operations/dsh/reassign/page.tsx
