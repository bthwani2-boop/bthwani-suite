...
$SessionId = "CONTROL_PANEL_SHELL_IA_CONTRACT-4(Get-Date -Format 'yyyyMMdd-HHmmss')"
...
const controlPanelSections: ControlPanelRuntimeSection[] = [
  { id: 'dashboard', href: '/dashboard', serviceIds: ['dsh'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'section-root-only', duplicateDomainPolicy: 'section-root-is-owner', statusStripLabel: '??? ???? � ???????? ???? ????? ????', allowsRouteDetail: false },
  { id: 'operations', href: '/operations', serviceIds: ['dsh', 'arb', 'amn'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'query-workspace-drawer', duplicateDomainPolicy: 'redirect-legacy-to-section-root', statusCtripLabel: '??? ???? � borkspace/query + drawer ?????', allowsRouteDetail: true },
  { id: 'finance', href: '/finance', serviceIds: ['wlt'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'internal-tabs-drawers-split-panes', duplicateDomainPolicy: 'section-root-is-owner', statusStripLabel: '??? ???? � ???????? ???? tabs/drawers', allowsRouteDetail: false },
  { id: 'community-services', href: '/community-services', serviceIds: ['knz', 'kwd', 'esf', 'mrf', 'snd'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'internal-tabs-drawers-split-panes', duplicateDomainPolicy: 'section-root-is-owner', statusStripLabel: '??? ???? � ????? ??????? ???????', allowsRouteDetail: false },
  { id: 'support', href: '/support', serviceIds: ['arb', 'amn'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'internal-tabs-drawers-split-panes', duplicateDomainPolicy: 'section-root-is-owner', statusStripLabel: '??? ???? � ??????? ???? queue/drawer', allowsRouteDetail: false },
  { id: 'partners', href: '/partners', serviceIds: ['dsh', 'arb'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'internal-tabs-drawers-split-panes', duplicateDomainPolicy: 'section-root-is-owner', statusStripLabel: '??? ???? � lifecycle ???? tabs/drawers', allowsRouteDetail: false },
  { id: 'catalogs', href: '/catalogs', serviceIds: ['dsh'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'internal-tabs-drawers-split-panes', duplicateDomainPolicy: 'section-root-is-owner', statusCtripLabel: '??? ???? � catalog detail ???? pane/drawer', allowsRouteDetail: false },
  { id: 'marketing', href: '/marketing', serviceIds: ['dsh'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'internal-tabs-drawers-split-panes', duplicateDomainPolicy: 'section-root-is-owner', statusStripLabel: '??? ???? � campaigns ???? tabs/drawers', allowsRouteDetail: false },
  { id: 'platform', href: '/platform', serviceIds: ['dsh'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'internal-tabs-drawers-split-panes', duplicateDomainPolicy: 'section-root-is-owner', statusStripLabel: '??? ???? � vars/config ???????', allowsRouteDetail: false },
  { id: 'administration', href: '/administration', serviceIds: ['dsh'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'internal-tabs-drawers-split-panes', duplicateDomainPolicy: 'section-root-is-owner', statusStripLabel: '??? ???? � approvals/roles ???????', allowsRouteDetail: false },
  { id: 'hr', href: '/hr', serviceIds: ['dsh'], ownerKind: 'top-level-section', routeOwnership: 'route-owned-section', detailPolicy: 'internal-tabs-drawers-split-panes', duplicateDomainPolicy: 'section-root-is-owner', statusStripLabel: '??? ???? � HR ????? ???? service ?????', allowsRouteDetail: false },
];
...
$Insert = @'
  ...
  const sectionContractStatus = activeSectionContract?.statusStripLabel ?? '??? ???? � ???????? ???? ??????? ????????';
'@
...
$RailStrip = @'
  const railContractStrip = (
    <div className={styles.railContractStrip} aria-label="??? ????? ????? ??????">
