<!--
Canonical human-review path: dsh/docs/journies-006-partner-onboarding-field-readiness/006d-document-capture-and-media-reference.slice4.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-006-partner-onboarding-and-field-readiness/DSH-SLICE-006D-document-capture-and-media-reference.md
...
- Journey folder: `dsh/docs/journies-006-partner-onboarding-field-readiness/`
- Slice file: `dsh/docs/journies-006-partner-onboarding-field-readiness/006d-document-capture-and-media-reference.slice4.md`
- Slice order inside journey: `4` of `7`
...
# DSH-SLICE-006D — Document Capture and Media Reference
...
| Parent Journey | `J-006 — Partner Onboarding and Field Readiness` |
| Journey Type | `business` |
| Business Outcome | documents use mediaKey references and central media owner |
| Primary Actor | `field/partner` |
| Primary Surface / Area | `app-field + central media/data` |
| Control Panel Owner | `operations` |
| WLT Boundary | `none` |
...
1. يبدأ الممثل الأساسي `field/partner` من السطح `app-field + central media/data`.
2. الهدف العملي: documents use mediaKey references and central media owner.
...
9. في رحلة انضمام الشريك: يجب أن تكون الدائرة كاملة: طلب انضمام → مراجعة لوحة التحكم → تعيين زيارة ميدانية → تنفيذ الزيارة → رفع الوثائق → قرار قبول/رفض/تصعيد → ظهور الحالة في تطبيق الشريك.
10. لا يكفي أن تظهر شاشة واحدة. يجب إثبات ماذا يرى الشريك، ماذا يرى الميداني، ماذا يرى المشغل، وما هو السجل/الأثر النهائي.
...
|---|---|---|---|
| `app-field + central media/data` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-006D-01 | [fill during execution] | REQUIRED_ADDITION / BLOCKED_WITH_REASON / DEFERRED_WITH_REASON | [owner] | [action] | [decision] |
...
- Parent Journey: J-006 — Partner Onboarding and Field Readiness
- Slice: DSH-SLICE-006D — Document Capture and Media Reference
- Primary actor: field/partner
- Primary surface/area: app-field + central media/data
- Business outcome: documents use mediaKey references and central media owner
- SESSION_ID: DSH-SLICE-006D_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-006D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-006D_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-006D_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
