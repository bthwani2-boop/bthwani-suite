# Screen Contract: dsh_entitlements_get

1. Screen Identity: dsh_entitlements_get
2. Purpose: execute primary user task for dsh_entitlements_get within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_entitlements_get
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_entitlements_get.tsx
