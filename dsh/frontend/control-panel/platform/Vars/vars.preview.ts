...
export const DSH_PLATFORM_OPERATIONAL_VARS: readonly DshPlatformVarRecord[] = [
  {
    ...
    precedenceNote: 'ينطبق عالميًا. يمكن تخصيص قيمة مختلفة على مستوى المدينة أو المنطقة لاحقًا.',
  },
  {
...
export const DSH_PLATFORM_WLT_FINANCIAL_BRIDGE_VARS: readonly DshPlatformVarRecord[] = [
  ...
  },
  {
    ...
    precedenceNote: 'Region floor يصل كجسر مرئي؛ DSH لا يملك كسره.',
  },
  {
    ...
    precedenceNote: 'Global financial guard من WLT يهيمن على أي عرض تشغيلي داخل DSH.',
  },
  {
    ...
    precedenceNote: 'Service settlement cycle يُقرأ من WLT فقط ويُستخدم داخل DSH كإشارة قرار.',
  },
] as const;
...
export const DSH_PLATFORM_PROVIDER_CONTROL_VARS: readonly DshPlatformProviderControlRecord[] = [
  {
    ...
    precedenceNote: 'City provider policy تظهر للعرض فقط ولا تتحول إلى switch فعلي.',
  ...
  },
  {
    ...
    precedenceNote: 'Provider behavior يبقى حالة مرجعية حتى تثبت مسار الاختبار.',
...
export const DSH_PLATFORM_SCOPE_PRECEDENCE: readonly DshPlatformScopeLayer[] = [
  ...
  },
  {
    ...
    note: 'Store هو آخر كلمة تشغيلية ضمن حدود DSH.',
  },
] as const;
