...
export const DSH_CUSTOMER_360_PREVIEW: readonly DshCustomer360Record[] = [
  {
    ...
    wltReadOnlyVisibility: {
      ...
      refundVisibility: 'Refund execution allowed directly.',
      settlementVisibility: 'Settlement mutation allowed directly.',
      readOnly: false,
  ...
  },
  {
    ...
    wltReadOnlyVisibility: {
      paymentVisibility: 'Payment visibility controllable after verification completes.',
      refundVisibility: 'Refund visibility and execution allowed.',
      settlementVisibility: 'Settlement mutation allowed directly.',
      readOnly: false,
      mutationForbidden: false,
      calculationTruthOwner: 'DSH & WLT',
