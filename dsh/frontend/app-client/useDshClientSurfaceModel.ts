// Canonical location: dsh/frontend/app-client/useDshClientSurfaceModel.ts
// Authority: dsh/frontend/app-client — surface state model for DshClientSurface.
// Consolidates all client surface state and hooks into a single hook.

import React from 'react';
import { useDshClientRuntimeStores } from '../shared/checkout/useDshClientRuntimeStores';
import { useDshClientHomeCategories } from '../shared/discovery/useDshClientHomeCategories';
import { useDshNavigation } from './useDshNavigation';
import { useDshClientStoreState, mapStoreDetailToScreenStore, buildStoreCategories, buildStoreDeliveryModes, buildStoreTags } from '../shared/stores';
import { useDshClientCartState } from '../shared/cart';
import { useDshOrderTracking } from '../shared/orders';
import { useWltDshWalletSession } from '../../../wlt/frontend/dsh/shared';
import { useDshClientOrderExecution } from '../shared/checkout';
import { useDshClientMarketingState } from '../shared/marketing/useDshClientMarketingState';
...
import { initialOrders, commandTargetToRoute, hostClientStates } from './dsh-client.navigation-bridge';
