...
# 10 — الرحلة 08: تنفيذ التوصيل بواسطة الكابتن

## الهدف

إغلاق تسليم الطلب: dispatch → captain accept → pickup → en route → arrived → proof of delivery.

## النطاق

app-captain + control-panel dispatch + app-client tracking + app-partner order status + DSH backend.
...
### Slice 08.1 Dispatch Assignment

**هدف الشريحة:** تعيين الكابتن من CP.
...
- افحص/ارفض: CP success بلا DB.
- افحص/ارفض: captain يرى طلبات غيره.
- افحص/ارفض: لا reassignment.
...
### Slice 08.2 Captain Accept/Decline

**هدف الشريحة:** قبول أو رفض المهمة.
...
- افحص/ارفض: reason غير محفوظ.
- افحص/ارفض: decline لا يعيد queue.
- افحص/ارفض: button local.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
### Slice 08.3 Pickup Handoff

**هدف الشريحة:** تأكيد الاستلام من المتجر.
...
- افحص/ارفض: pickup قبل ready.
- افحص/ارفض: لا 409.
- افحص/ارفض: لا timestamp.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
### Slice 08.4 Location and Map

**هدف الشريحة:** تحديث الموقع والحالة.
...
- افحص/ارفض: GPS preview بلا label.
- افحص/ارفض: إحداثيات وهمية في live.
- افحص/ارفض: map لا يعرض error.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
### Slice 08.5 Proof of Delivery

**هدف الشريحة:** إثبات التسليم.
...
- افحص/ارفض: payout داخل DSH.
- افحص/ارفض: pod key وهمي.
- افحص/ارفض: لا media proof.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
...
- اربط media runtime وWLT settlement trigger reference فقط.
...
### Slice 08.6 Captain UX Review

**هدف الشريحة:** مراجعة home/orders/map/proof/profile/finance.
...
- افحص/ارفض: DshCaptainSurface تضخم جديد.
- افحص/ارفض: routes مشتتة.
...
- split sections أو centralize components.
...
### Slice 08.7 Captain Code Hygiene

**هدف الشريحة:** فحص refactor الكبير للكابتن.
...
- افحص/ارفض: component family مكررة.
- افحص/ارفض: old route dead.
- افحص/ارفض: support screen duplication.
- صنف كل ملف متأثر: `KEEP_ACTIVE / REFACTOR_SPLIT / MERGE_DUPLICATE / RETIRE_DEAD / MOVE_TO_OWNER / FIX_REQUIRED / BLOCKED_NEEDS_EVIDENCE`.
- لا تحذف أو تنقل قبل فحص imports/exports/routes/navigation/runtime/tests.
- أي preview/demo/mock/fallback في runtime يجب عزله أو حذفه أو ربطه بمصدر حقيقي.
- أي تكرار UI يجب أن يعود إلى `@bthwani/ui-kit` أو مكون service-owned واضح.
