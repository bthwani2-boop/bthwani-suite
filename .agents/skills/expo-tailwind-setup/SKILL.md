...
description: Read-only advisory review for Expo styling setup. Does not add Tailwind, NativeWind, dependencies, or styling systems.
---

# Expo Tailwind Setup - BThwani Safe Advisory Skill
