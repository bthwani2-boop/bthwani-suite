// Canonical location: dsh/frontend/shared/view-models/client/useDshClientSurfaceModel.ts
// Authority: dsh/frontend/shared — surface state model for DshClientSurface.
// Consolidates all client surface state and hooks into a single hook.

import React from 'react';
import { useDshClientRuntimeStores } from './useDshClientRuntimeStores';
import { useDshClientHomeCategories } from '../home/useDshClientHomeCategories';
import { useDshNavigation } from '../../../app-client/hooks/useDshNavigation';
import { useDshClientStoreState } from '../store/useDshClientStoreState';
import { useDshClientCartState } from '../cart/useDshClientCartState';
import { useDshOrderTracking } from '../tracking/useDshOrderTracking';
import { useWltDshWalletSession } from '../../../../wlt/frontend/dsh/app-client';
import { useDshClientOrderExecution } from '../checkout/useDshClientOrderExecution';
import { useDshClientMarketingState } from '../marketing/useDshClientMarketingState';
import { useDshClientBellState } from '../notifications/useDshClientBellState';
import { useDshClientHomeActions } from '../home/useDshClientHomeActions';
import { mapStoreDetailToScreenStore } from '../../adapters/client/dshClientStoreAdapters';
import { buildStoreCategories, buildStoreDeliveryModes, buildStoreTags } from '../../../shared';
import type { DshClientSurfaceProps } from '../../../app-client/dsh-client.types';
import type { DshFulfillmentDeliveryMode } from '../../../app-client/contracts/dsh-client-binding.contracts';
import { initialOrders, commandTargetToRoute, hostClientStates } from '../../../app-client/dsh-client.navigation-bridge';
