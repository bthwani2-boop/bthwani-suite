# Screen Contract - amn_captain_status_update

1. Screen Identity: SCR_3
2. Purpose: Operational AMN workflow surface.
3. Actor: captain
4. Surface: app-captain
5. Canonical Route: /captain/amn/captain/status/update
...
16. Dependent Operations: amn_captain_status_update|amn_trip_status_update
...
19. Files To Create / Files To Touch: packages/surfaces/src/amn/amn_captain_status_update.tsx
20. Acceptance Gate: gate_a_b_c_passed
21. Deferred Items: W08 binding and W09 runtime proof-only closure.
22. Notes from donor extraction: services/amn/governance/operations/amn_captain_status_update/OP_SCREENS_MAP.csv|services/amn/governance/operations/amn_trip_status_update/OP_SCREENS_MAP.csv
