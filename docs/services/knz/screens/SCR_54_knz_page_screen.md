# Screen Contract: knz_page_screen

1. Screen Identity: knz_page_screen
2. Purpose: execute primary user task for knz_page_screen within knz.
3. Actor: customer
...
22. Notes from donor extraction: packages/surfaces/src/knz/app-client/mobile/KnzPageScreen.tsx
