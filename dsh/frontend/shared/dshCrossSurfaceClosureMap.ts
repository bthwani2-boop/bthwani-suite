...
export const DSH_CROSS_SURFACE_CLOSURE_MAP: readonly DshCrossSurfaceClosureItem[] = [
  ...
  },
  {
    ...
    title: 'السلة والدفع',
    description: 'السلة وcheckout intent يستهلكان lifecycle state model الموحّد مع إبقاء الدفع read-only عند WLT. المنطق حاضر، والإثبات البصري والتشغيلي مكتمل.',
  ...
  },
  {
    ...
    runtimeBindingStatus: 'API_CLIENT_BOUND__RUNTIME_EVIDENCE_PRESENT',
    title: 'التتبع والدعم',
    description: 'سطح التتبع ومساحة المشاكل يستهلكان journey/signal/support models الموحدة.',
    ...
    crossSurfaceProof: 'DshOrdersListScreen, DshTrackingScreen, and OperationScreens تشاركان dsh-order-journey.model مع control-panel/support وfinance bridge، بينما refund_pending_wlt يظل read-only وsupport_exception/audit_required يذهبان إلى escalationOwner = control-panel عبر signal layer.',
  },
  {
    ...
    description: 'صندوق الطلبات ومسارات الرفض والمشاكل مربوطة بحالات journey والدعم والhandoff.',
  ...
  },
  {
    ...
    runtimeBindingStatus: 'API_CLIENT_BOUND__RUNTIME_EVIDENCE_PRESENT',
    title: 'استلام المهمة',
    description: 'مسارات الاستلام والخريطة مربوطة بعقد dispatch/lifecycle الموحّد مع إبقاء queue الكباتن محصورة في bthwani_delivery.',
  ...
  },
  {
    ...
    description: 'إثبات التسليم ومسار الفشل يستهلكان shared lifecycle/support models مع PoD gate واضح.',
  ...
  },
  {
    ...
    description: 'شاشات عمليات لوحة التحكم صارت مربوطة بمسار lifecycle الموحد، وصف الاستثناءات/الدعم، وحدود الخريطة control-panel only.',
