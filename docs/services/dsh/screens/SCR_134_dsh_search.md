# Screen Contract: dsh_search

1. Screen Identity: dsh_search
2. Purpose: execute primary user task for dsh_search within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_search
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_search.tsx
