...
The pack is based on the current target actor and operation locks plus reviewed donor DSH service-scope, coverage, RBAC, and CONTROL_PANEL route evidence.
