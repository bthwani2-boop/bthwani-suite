# Screen Contract: dsh_checkout_gate

1. Screen Identity: dsh_checkout_gate
2. Purpose: execute primary user task for dsh_checkout_gate within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_checkout_gate
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_checkout_gate.tsx
