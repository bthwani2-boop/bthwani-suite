# Screen Contract: dsh_finance_dsh

1. Screen Identity: dsh_finance_dsh
2. Purpose: execute primary user task for dsh_finance_dsh within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /finance/dsh
6. Entry Points: /finance/dsh entry
...
16. Dependent Operations: dsh_finance_dsh
...
22. Notes from donor extraction: apps/web/control-panel/app/finance/dsh/page.tsx
