<!--
Canonical human-review path: dsh/docs/journies-000-foundation-remote-local-evidence-gate/000b-local-runtime-stack-baseline.slice2.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-000-foundation-remote-local-evidence-gate/DSH-SLICE-000B-local-runtime-stack-baseline.md
...
- Slice file: `dsh/docs/journies-000-foundation-remote-local-evidence-gate/000b-local-runtime-stack-baseline.slice2.md`
...
# DSH-SLICE-000B — Local Runtime Stack Baseline
...
| Field | Value |
|---|---|
| Slice ID | `DSH-SLICE-000B` |
| Parent Journey | `J-000 — Foundation Remote / Local / Evidence Gate` |
| Journey Type | `foundation` |
| Business Outcome | prove the approved local runtime starts with known ports and environment |
| Primary Actor | `developer` |
| Primary Surface / Area | `Docker/Postgres/Go API/Next/Expo/ADB` |
...
1. يبدأ الممثل الأساسي `developer` من السطح `Docker/Postgres/Go API/Next/Expo/ADB`.
2. الهدف العملي: prove the approved local runtime starts with known ports and environment.
...
|---|---|---|---|
| `Docker/Postgres/Go API/Next/Expo/ADB` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
- Parent Journey: J-000 — Foundation Remote / Local / Evidence Gate
- Slice: DSH-SLICE-000B — Local Runtime Stack Baseline
- Primary actor: developer
- Primary surface/area: Docker/Postgres/Go API/Next/Expo/ADB
- Business outcome: prove the approved local runtime starts with known ports and environment
- SESSION_ID: DSH-SLICE-000B_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-000B_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-000B_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-000B_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
