...
description: Light advisory guidance for React and Next.js performance in BThwani. Does not modify code by default.
---

# Vercel React Best Practices - BThwani Safe Advisory Skill
