...
import { useWltDshFieldFinanceSummary } from '../shared/commissions/field-finance-summary.model';
...
export type WltDshFieldFinanceSummaryProps = {
  storeIds?: string[];
  onBack?: () => void;
};

export function WltDshFieldFinanceSummary({
  storeIds,
  onBack,
}: WltDshFieldFinanceSummaryProps) {
  const {
    snapshot,
    commissionRecords,
    pendingRecords,
    rejectedRecords,
    payoutRecords,
  } = useWltDshFieldFinanceSummary(storeIds);
...
export default WltDshFieldFinanceSummary;
