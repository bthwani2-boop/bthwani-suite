<!--
Canonical human-review path: dsh/docs/journies-001-store-discovery/001a-client-store-list-from-live-api.slice1.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-001-store-discovery-and-visibility/DSH-SLICE-001A-client-store-list-from-live-api.md
...
- Slice file: `dsh/docs/journies-001-store-discovery/001a-client-store-list-from-live-api.slice1.md`
...
# DSH-SLICE-001A — Client Store List from Live API
...
| Business Outcome | GET /stores displays live eligible stores |
...
1. يبدأ الممثل الأساسي `client` من السطح `app-client + DSH backend`.
2. الهدف العملي: GET /stores displays live eligible stores.
...
|---|---|---|---|
| `app-client + DSH backend` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
- Parent Journey: J-001 — Store Discovery and Visibility
- Slice: DSH-SLICE-001A — Client Store List from Live API
- Primary actor: client
- Primary surface/area: app-client + DSH backend
- Business outcome: GET /stores displays live eligible stores
- SESSION_ID: DSH-SLICE-001A_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-001A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-001A_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-001A_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
