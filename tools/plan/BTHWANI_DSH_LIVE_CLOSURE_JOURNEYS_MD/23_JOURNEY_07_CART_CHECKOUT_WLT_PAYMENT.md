...
language: ar
title: رحلة 07 — Cart/Checkout/WLT Payment
---

# رحلة 07 — السلة والدفع وWLT

## الهدف

إغلاق مسار العميل من cart إلى checkout intent ثم WLT payment session/callback.

## مالك المنطق

- cart/checkout DSH: `dsh/frontend/shared/cart`, `checkout`.
- payment/wallet/ledger: `wlt/frontend/dsh/shared/payments`, `wallet`, `ledger`.
- DSH finance boundary only: `dsh/frontend/shared/wlt` أو boundary folder بدون حسابات مالية.

## ممنوع

- payment amount truth داخل DSH UI.
- WLT callback simulation كنجاح صامت.
- local checkout fallback.
- cart calculations منفصلة داخل app-client.
