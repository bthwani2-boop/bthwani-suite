# Screen Contract - amn_captain_offers_list

1. Screen Identity: SCR_2
2. Purpose: Operational AMN workflow surface.
3. Actor: captain
4. Surface: app-captain
5. Canonical Route: /captain/amn/captain/offers/list
...
19. Files To Create / Files To Touch: packages/surfaces/src/amn/amn_captain_offers_list.tsx
