...
let _globalStore: ApprovalRecord[] = [
  ...
  },
  {
    ...
    metadata: {
      mediaKey: 'category.main.restaurants.v1',
      mediaPolicy: 'catalog-owned-media',
      nextOwner: 'control-panel-catalog',
  ...
  },
  {
    ...
    metadata: {
      mediaKey: 'store.hittin.cover.v1',
