# Screen Contract: dsh_operations_dsh_orders_[id]

1. Screen Identity: dsh_operations_dsh_orders_[id]
2. Purpose: execute primary user task for dsh_operations_dsh_orders_[id] within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /operations/dsh/orders/[id]
6. Entry Points: /operations/dsh/orders/[id] entry
...
16. Dependent Operations: arrival_bell|dsh_operations_dsh_orders_id|dsh_order_get
...
22. Notes from donor extraction: apps/web/control-panel/app/operations/dsh/orders/[id]/page.tsx
