# Screen Contract: dsh_cart_price

1. Screen Identity: dsh_cart_price
2. Purpose: execute primary user task for dsh_cart_price within dsh.
3. Actor: shared
4. Surface: shared
...
16. Dependent Operations: dsh_cart_price
...
22. Notes from donor extraction: packages/surfaces/src/dsh/DshCartPrice.tsx
