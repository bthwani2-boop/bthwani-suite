# Screen Contract: dsh_operations_dsh_sheinproxy_[id]_schedule

1. Screen Identity: dsh_operations_dsh_sheinproxy_[id]_schedule
2. Purpose: execute primary user task for dsh_operations_dsh_sheinproxy_[id]_schedule within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /operations/dsh/sheinproxy/[id]/schedule
6. Entry Points: /operations/dsh/sheinproxy/[id]/schedule entry
...
16. Dependent Operations: dsh_operations_dsh_sheinproxy_id_schedule
...
22. Notes from donor extraction: apps/web/control-panel/app/operations/dsh/sheinproxy/[id]/schedule/page.tsx
