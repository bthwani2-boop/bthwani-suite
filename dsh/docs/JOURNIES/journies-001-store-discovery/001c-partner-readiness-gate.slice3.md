<!--
Canonical human-review path: dsh/docs/journies-001-store-discovery/001c-partner-readiness-gate.slice3.md
Original generated path: dsh/docs/slices/human-sequential-closure-v3/slices/J-001-store-discovery-and-visibility/DSH-SLICE-001C-partner-readiness-gate.md
...
- Journey folder: `dsh/docs/journies-001-store-discovery/`
- Slice file: `dsh/docs/journies-001-store-discovery/001c-partner-readiness-gate.slice3.md`
- Slice order inside journey: `3` of `6`
...
| Parent Journey | `J-001 — Store Discovery and Visibility` |
| Journey Type | `business` |
| Business Outcome | partner ready/paused changes client visibility |
| Primary Actor | `partner` |
| Primary Surface / Area | `app-partner + app-client dependency` |
...
1. يبدأ الممثل الأساسي `partner` من السطح `app-partner + app-client dependency`.
2. الهدف العملي: partner ready/paused changes client visibility.
...
|---|---|---|---|
| `app-partner + app-client dependency` | primary | ينفذ الهدف الأساسي للشريحة | screenshot/log/test |
...
|---|---|---|---|---|---|
| GAP-001C-01 | app-partner StoreProfileScreen عرض read-only لـ visibility checklist؛ control-panel هو سلطة التفعيل | KEEP_WITH_REASON | app-partner | لا شيء | CLOSED |
| GAP-001C-02 | PATCH /stores/{id}/partner-readiness موجود في stores_handler.go | KEEP_WITH_REASON | backend | لا شيء | CLOSED |
| GAP-001C-03 | ListStores يفلتر partner_readiness_status='ready'؛ TestStoresHandlerVisibilityGates Step 2-3 يثبت | KEEP_WITH_REASON | backend | لا شيء | CLOSED |
| GAP-001C-04 | PartnerStoresScreen يوصل PATCH partner-readiness عبر typed transport | KEEP_WITH_REASON | control-panel | لا شيء | CLOSED |

**Evidence Session:** `tools/registry/runs/J-001-001c-20260612-120000/`
...
| Reason | الكود مكتمل — backend filter مختبر، CP toggle حي، app-partner checklist موجود. يحتاج device/browser screenshots. |
| TSC | PASS |
| Go Test | PASS — TestStoresHandlerVisibilityGates Step 2-3 |
| Code Changes | NONE |
| Evidence | tools/registry/runs/J-001-001c-20260612-120000/ |
...
- Parent Journey: J-001 — Store Discovery and Visibility
- Slice: DSH-SLICE-001C — Partner Readiness Gate
- Primary actor: partner
- Primary surface/area: app-partner + app-client dependency
- Business outcome: partner ready/paused changes client visibility
- SESSION_ID: DSH-SLICE-001C_FINAL_CLOSURE-YYYYMMDD-HHMMSS
...
- evidence folder: tools/registry/runs/DSH-SLICE-001C_FINAL_CLOSURE-YYYYMMDD-HHMMSS/
- evidence zip: tools/registry/runs/DSH-SLICE-001C_FINAL_CLOSURE-YYYYMMDD-HHMMSS/DSH-SLICE-001C_FINAL_CLOSURE-YYYYMMDD-HHMMSS.zip
