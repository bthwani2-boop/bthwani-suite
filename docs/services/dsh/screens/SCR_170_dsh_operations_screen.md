# Screen Contract: dsh_operations_screen

1. Screen Identity: dsh_operations_screen
2. Purpose: execute primary user task for dsh_operations_screen within dsh.
3. Actor: ops|admin
...
16. Dependent Operations: dsh_control_panel_dsh_operations_screen
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/dsh/control_panelDshOperationsScreen.tsx
