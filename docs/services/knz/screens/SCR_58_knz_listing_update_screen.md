# Screen Contract: knz_listing_update_screen

1. Screen Identity: knz_listing_update_screen
2. Purpose: execute primary user task for knz_listing_update_screen within knz.
3. Actor: ops|admin
...
22. Notes from donor extraction: packages/surfaces/src/web/control-panel/operations/knz/KnzListingUpdateScreen.tsx
