...
export type { CanonicalOperationsGroupId } from '../operations/dsh-operational.contract';
...
export type AnyOperationsWorkspaceId = import('../operations/dsh-operational.contract').CanonicalOperationsGroupId | LegacyOperationsWorkspaceId | LegacySectionRedirectId | 'orders' | 'overview';
...
export type OperationsGroupMeta = {
  id: import('../operations/dsh-operational.contract').CanonicalOperationsGroupId;
  label: string;
  description: string;
  badge: string;
...
export type OperationsNormalizationResult =
  | {
      kind: 'group';
      group: import('../operations/dsh-operational.contract').CanonicalOperationsGroupId;
