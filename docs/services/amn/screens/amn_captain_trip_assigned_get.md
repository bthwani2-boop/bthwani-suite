# Screen Contract - amn_captain_trip_assigned_get

1. Screen Identity: SCR_6
2. Purpose: Operational AMN workflow surface.
3. Actor: captain
4. Surface: app-captain
5. Canonical Route: /captain/amn/captain/trip/assigned/get
...
16. Dependent Operations: amn_trip_activate|amn_trip_complete|amn_trip_verify
...
19. Files To Create / Files To Touch: packages/surfaces/src/amn/amn_captain_trip_assigned_get.tsx
20. Acceptance Gate: gate_a_b_c_passed
21. Deferred Items: W08 binding and W09 runtime proof-only closure.
22. Notes from donor extraction: services/amn/governance/operations/amn_trip_activate/OP_SCREENS_MAP.csv|services/amn/governance/operations/amn_trip_complete/OP_SCREENS_MAP.csv|services/amn/governance/operations/amn_trip_verify/OP_SCREENS_MAP.csv
