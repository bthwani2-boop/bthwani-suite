...
| source checked | target pattern observed | adopted? | rejected? | reason | BThwani adaptation | risk | affected task |
|---|---|---|---|---|---|---|---|
...
## Demo Data / Media Centralization Matrix
