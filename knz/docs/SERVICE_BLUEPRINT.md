...
- `knz/knz.openapi.yaml` contract truth.
...
- `knz/knz.openapi.yaml` for this service contract.
...
| --- | --- | --- | --- | --- |
| `app-client` | Seller/Buyer: بيع وشراء وتصفح وإدارة الإعلانات. | runtime / shell / composition only | TBD | N/A |
| `webapp` | Web Seller/Buyer: سوق مفتوح على الويب عند النضج. | runtime / shell / composition only | TBD | N/A |
| `control-panel` | Admin/Moderation: مراجعة الإعلانات، الإشراف، التصنيفات، البلاغات، والسياسات. | runtime / shell / composition only | TBD | N/A |
...
|---|---|---|---|---|
| `app-client` | app owns shell/composition only | Seller/Buyer: بيع وشراء وتصفح وإدارة الإعلانات. | TBD | N/A |
| `webapp` | app owns shell/composition only | Web Seller/Buyer: سوق مفتوح على الويب عند النضج. | TBD | N/A |
| `control-panel` | app owns shell/composition only | Admin/Moderation: مراجعة الإعلانات، الإشراف، التصنيفات، البلاغات، والسياسات. | TBD | N/A |

### App/Shell Rule

Apps may own entry, bootstrap, routing mount, providers, platform config, metadata, and minimal environment wiring.

Apps must not own real `knz` service screens, business/domain logic, reusable UI families, local design tokens, mock service content, independent i18n/direction ownership, direct backend/API ownership, or deep/private imports.
...
| --- | --- | --- | --- | --- | --- | --- |
| `KNZ-OP-01` | Listing creation | TBD | TBD | TBD | TBD | N/A |
| `KNZ-OP-02` | Listing browsing | TBD | TBD | TBD | TBD | N/A |
| `KNZ-OP-03` | Listing detail | TBD | TBD | TBD | TBD | N/A |
| `KNZ-OP-04` | Search and filters | TBD | TBD | TBD | TBD | N/A |
| `KNZ-OP-05` | Safe contact | TBD | TBD | TBD | TBD | N/A |
| `KNZ-OP-06` | Listing management | TBD | TBD | TBD | TBD | N/A |
| `KNZ-OP-07` | Reports/moderation | TBD | TBD | TBD | TBD | N/A |
| `KNZ-OP-08` | Category governance | TBD | TBD | TBD | TBD | N/A |
...
```text
Seller creates listing → listing review/moderation if required → buyer discovers listing → buyer views details → safe contact/action → listing update/close/report → control-panel moderation.
```
...
|---|---|---|---|---|---|---|---|---|
| `KNZ-INV-TBD` | TBD | TBD | TBD | TBD | loading / empty / error / success / offline / disabled / pending / retry / blocked | TBD | TBD | N/A |
...
|---|---|---|---|---|---|---|---|
| `KNZ-MATRIX-TBD` | TBD | TBD | TBD | `knz/knz.openapi.yaml` | TBD | TBD | N/A |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `KNZ-GAP-TBD` | TBD | TBD | TBD | TBD | TBD | TBD | TBD | TBD | `knz/` | TBD | TBD | N/A |
...
|---|---|---|---|---|
| OpenAPI | `CONTRACT_TBD` | `knz/knz.openapi.yaml` | N/A | Do not add fake endpoints. |
...
KNZ does not allow platform C2C payment for item price by default and does not provide platform delivery. Any future financial effect must pass through WLT after explicit gap and contract decision.
...
Classify KNZ flows and prove no DSH-like delivery/captain semantics are introduced.
...
|---|---|---|---|
| notifications | notification_chain | N/A_WITH_REASON | knz is a backend/operational service; direct push/SMS/email notification delivery is owned by the notification service layer (knz for the notification domain). This service emits events consumed by the notification layer rather than owning the notification_chain surface directly. Owner: notification-service boundary. Expiry: re-evaluate when direct notification ownership is assigned. |
