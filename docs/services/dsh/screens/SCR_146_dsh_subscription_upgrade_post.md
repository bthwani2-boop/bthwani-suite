# Screen Contract: dsh_subscription_upgrade_post

1. Screen Identity: dsh_subscription_upgrade_post
2. Purpose: execute primary user task for dsh_subscription_upgrade_post within dsh.
3. Actor: customer
...
16. Dependent Operations: dsh_partner_subscription_upgrade_post|dsh_subscription_upgrade_post
...
22. Notes from donor extraction: packages/surfaces/src/dsh/app-client/mobile/auto_dsh_subscription_upgrade_post.tsx
