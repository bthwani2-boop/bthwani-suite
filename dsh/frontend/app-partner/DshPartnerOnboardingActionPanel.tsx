...
type OnboardingFlowId = 'doc-upload' | 'intake-start' | 'store-nomination';

const ONBOARDING_ITEMS: Array<{ id: OnboardingFlowId; title: string; subtitle: string }> = [
