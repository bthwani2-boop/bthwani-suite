# Screen Contract: dsh_operations_dsh_arrival-bell

1. Screen Identity: dsh_operations_dsh_arrival-bell
2. Purpose: execute primary user task for dsh_operations_dsh_arrival-bell within dsh.
3. Actor: ops|admin
4. Surface: control-panel
5. Canonical Route: /operations/dsh/arrival-bell
6. Entry Points: /operations/dsh/arrival-bell entry
...
16. Dependent Operations: arrival_bell|dsh_operations_dsh_arrival_bell
...
22. Notes from donor extraction: apps/web/control-panel/app/operations/dsh/arrival-bell/page.tsx
